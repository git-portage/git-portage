...
# $Header: /var/cvsroot/gentoo-x86/app-accessibility/dasher/Attic/dasher-4.0.3.ebuild,v 1.1 2006/07/31 08:38:43 leonardop Exp $
...
src_unpack() {
	...
	# Fix i18n handling when USE=-gnome is used
	epatch "${FILESDIR}"/${P}-intl_fix.patch

	# fix configure flags
	epatch "${FILESDIR}"/${PN}-4.0.2-fix_enable_flags.patch
