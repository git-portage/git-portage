...
# $Header: /var/cvsroot/gentoo-x86/app-admin/apache-tools/Attic/apache-tools-2.2.4-r1.ebuild,v 1.1 2007/05/09 12:54:18 kloeri Exp $
...
src_install () {
	...
	for i in ab htdigest htpasswd; do
