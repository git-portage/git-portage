...
# $Header: /var/cvsroot/gentoo-x86/app-admin/fam-oss/Attic/fam-oss-2.6.9.ebuild,v 1.16 2003/09/20 19:56:29 aliz Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${DISTDIR}/dnotify.patch
	epatch ${FILESDIR}/${PF}-gcc3.patch
