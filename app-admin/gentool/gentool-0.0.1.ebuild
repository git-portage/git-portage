...
# $Header: /var/cvsroot/gentoo-x86/app-admin/gentool/Attic/gentool-0.0.1.ebuild,v 1.4 2001/04/27 02:17:18 achim Exp $
...
pkg_postrm() {
  rm -rf ${ROOT}/var/lib/supervise/services/gentool
}