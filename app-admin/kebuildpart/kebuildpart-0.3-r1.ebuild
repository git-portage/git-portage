...
# $Header: /var/cvsroot/gentoo-x86/app-admin/kebuildpart/Attic/kebuildpart-0.3-r1.ebuild,v 1.6 2002/08/13 20:47:30 pvdabeel Exp $
...
LICENSE="GPL-2"
KEYWORDS="x86" #does not compile on ppc with qt version 3.0.4 - see Changelog
