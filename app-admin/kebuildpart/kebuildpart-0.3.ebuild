...
# $Header: /var/cvsroot/gentoo-x86/app-admin/kebuildpart/Attic/kebuildpart-0.3.ebuild,v 1.7 2002/08/16 02:21:27 murphy Exp $
...
LICENSE="GPL-2"
KEYWORDS="x86 sparc sparc64" #does not build on ppc with qt version 3.0.4 - see Changelog
