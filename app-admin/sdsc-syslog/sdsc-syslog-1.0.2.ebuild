...
# $Header: /var/cvsroot/gentoo-x86/app-admin/sdsc-syslog/Attic/sdsc-syslog-1.0.2.ebuild,v 1.12 2007/07/13 06:07:38 mr_bones_ Exp $
...
pkg_postinst() {
	...
	elog "/etc/syslogd.conf.sample-loghost for server configuration"
}
