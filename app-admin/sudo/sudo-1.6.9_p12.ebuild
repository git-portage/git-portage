...
# $Header: /var/cvsroot/gentoo-x86/app-admin/sudo/Attic/sudo-1.6.9_p12.ebuild,v 1.4 2008/02/20 00:35:52 flameeyes Exp $
...
src_install() {
	einstall || die
	dodoc BUGS CHANGES HISTORY PORTING README \
