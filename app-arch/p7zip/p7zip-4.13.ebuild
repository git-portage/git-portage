...
# $Header: /var/cvsroot/gentoo-x86/app-arch/p7zip/Attic/p7zip-4.13.ebuild,v 1.2 2005/01/01 11:50:22 eradicator Exp $
...
src_unpack() {
	...
	if useq static ; then
		...
		epatch ${FILESDIR}/p7zip-4.13_x86_static.patch
	else
