...
# $Header: /var/cvsroot/gentoo-x86/app-arch/star/Attic/star-1.5.1-r2.ebuild,v 1.1 2013/02/04 11:45:39 jlec Exp ${FILESDIR}"/${P}-r1.ebuild,v 1.7 2012/02/02 15:20:43 ssuominen Exp $
