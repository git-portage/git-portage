...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdrtools-dvdr/Attic/cdrtools-dvdr-1.11.37.ebuild,v 1.1 2003/03/05 01:42:18 agenkin Exp $
...
SRC_URI="ftp://ftp.berlios.de/pub/cdrecord/alpha/OLD/2.0aX/${MY_P}.tar.gz
	http://people.mandrakesoft.com/~warly/files/cdrtools/${MY_P}-dvd.patch.bz2"

src_unpack() {
	unpack ${MY_P}.tar.gz || die
	unpack ${MY_P}-dvd.patch.bz2 || die
	patch -p0 < ${MY_P}-dvd.patch || die
