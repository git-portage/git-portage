...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdrtools/Attic/cdrtools-1.11.21.ebuild,v 1.2 2002/07/06 20:51:34 drobbins Exp $

S=${WORKDIR}/${PN}-1.11
DESCRIPTION="cdrtools - A set of tools for CDR drives, including cdrecord"
SRC_URI="ftp://ftp.fokus.gmd.de:21/pub/unix/cdrecord/alpha/${PN}-1.11a21.tar.gz"
