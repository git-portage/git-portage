...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdrtools/Attic/cdrtools-1.11.25.ebuild,v 1.1 2002/07/07 03:00:34 seemant Exp $

S=${WORKDIR}/${PN}-1.11
DESCRIPTION="cdrtools - A set of tools for CDR drives, including cdrecord"
HOMEPAGE="http://www.fokus.gmd.de/research/cc/glone/employees/joerg.schilling/private/cdrecord.html"
SRC_URI="ftp://ftp.fokus.gmd.de:21/pub/unix/cdrecord/alpha/${PN}-1.11a25.tar.bz2"
