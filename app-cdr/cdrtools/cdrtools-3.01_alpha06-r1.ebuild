...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdrtools/Attic/cdrtools-3.01_alpha06-r1.ebuild,v 1.1 2012/01/28 01:51:23 ssuominen Exp $
...
src_install() {
	...
	# Change from -rws--x--x to -rwx--s--x for udev users
