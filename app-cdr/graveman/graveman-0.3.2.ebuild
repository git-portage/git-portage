...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/graveman/Attic/graveman-0.3.2.ebuild,v 1.1 2005/01/25 00:45:36 pylon Exp $

inherit gnome2

DESCRIPTION="Graphical frontend for cdrecord, mkisofs, readcd and sox using GTK+2"
HOMEPAGE="http://www.nongnu.org/graveman/"
SRC_URI="http://savannah.nongnu.org/download/${PN}/${PN}_${PV}.tar.bz2"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~x86 ~ppc ~amd64"
IUSE="debug doc mad nls oggvorbis sox"
