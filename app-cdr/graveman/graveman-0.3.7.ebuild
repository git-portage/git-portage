...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/graveman/Attic/graveman-0.3.7.ebuild,v 1.2 2005/03/30 00:13:43 pylon Exp $

inherit gnome2

DESCRIPTION="Graphical frontend for cdrecord, mkisofs, readcd and sox using GTK+2"
HOMEPAGE="http://www.nongnu.org/graveman/"
SRC_URI="http://www.nongnu.org/${PN}/${PN}-${PV}.tar.bz2"
