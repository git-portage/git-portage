...
# $Header: /var/cvsroot/gentoo-x86/app-crypt/gpgme/Attic/gpgme-1.3.1.ebuild,v 1.1 2011/07/04 20:42:06 robbat2 Exp $
...
src_prepare() {
	...
	#epatch "${FILESDIR}/${PN}-1.3.0-gnupg-2.0.17.patch"
	epatch "${FILESDIR}/${PN}-1.3.0-gold.patch"
