...
# $Header: /var/cvsroot/gentoo-x86/app-crypt/mit-krb5/Attic/mit-krb5-1.2.6-r3.ebuild,v 1.8 2004/03/13 21:50:28 mr_bones_ Exp $
...
src_unpack() {
	...
	# This is a security patch, remove when 1.2.7 comes to http://www.crypto-publish.org/
	cd ${S}/kadmin/v4server/
	epatch ${FILESDIR}/krb5-${PV}-gentoo.diff

	#cd ${S}
	#epatch ${FILESDIR}/krb5-1.2.2-gentoo.diff
}
