...
# $Header: /var/cvsroot/gentoo-x86/app-crypt/mit-krb5/Attic/mit-krb5-1.4.ebuild,v 1.3 2005/04/08 13:22:02 seemant Exp $
...
src_install() {
	...
	mv ${D}/usr/bin/{,mit-}krb5-config
	mv ${D}/usr/sbin/{,mit-}kadmin
	mv ${D}/usr/sbin/{,mit-}kadmind
	mv ${D}/usr/sbin/{,mit-}ktutil
