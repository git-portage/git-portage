...
# $Header: /var/cvsroot/gentoo-x86/app-dicts/canna-cannadic/Attic/canna-cannadic-0.95.ebuild,v 1.2 2003/07/16 15:02:02 pvdabeel Exp $
...
src_install() {
	...
	install -o bin -g bin -m 0664 gcanna.c[bl]d gcannaf.ctd \
		${D}/var/lib/canna/dic/canna/
	insinto /var/lib/canna/dic/dics.d/
	doins ${FILESDIR}/05cannadic.dics.dir
