...
# $Header: /var/cvsroot/gentoo-x86/app-doc/gentoo-web/Attic/gentoo-web-1.0.ebuild,v 1.6 2001/04/19 22:25:10 drobbins Exp $
...
src_install() {
	...
	local x
	for x in install xml-guide portage-user gentoo-howto
	do
