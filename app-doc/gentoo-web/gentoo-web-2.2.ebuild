...
# $Header: /var/cvsroot/gentoo-x86/app-doc/gentoo-web/Attic/gentoo-web-2.2.ebuild,v 1.49 2002/04/24 18:50:29 drobbins Exp $
...
src_install() {
	...
	cd ${S}
	local x
	for x in gentooppc-quickstart use-howto gentoo-security rc-scripts java eclass-howto build desktop xml-guide portage-manual portage-user gentoo-howto faq nvidia_tsg openafs cvs-tutorial shots ebuild-submit altinstall uml
	do
