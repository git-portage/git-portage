...
# $Header: /var/cvsroot/gentoo-x86/app-doc/gentoo-web/Attic/gentoo-web-2.2.ebuild,v 1.46 2002/04/15 20:41:25 drobbins Exp $
...
src_install() {
	...
	cd ${S}
	local x
	for x in build desktop xml-guide portage-manual portage-user gentoo-howto faq nvidia_tsg openafs cvs-tutorial shots ebuild-submit altinstall uml
	do
