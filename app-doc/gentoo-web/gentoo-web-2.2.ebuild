...
# $Header: /var/cvsroot/gentoo-x86/app-doc/gentoo-web/Attic/gentoo-web-2.2.ebuild,v 1.41 2002/03/07 16:46:11 drobbins Exp $
...
src_install() {
	...
	cd ${S}
	local x
	for x in build desktop xml-guide portage-user gentoo-howto faq nvidia_tsg openafs cvs-tutorial shots ebuild-submit altinstall uml
	do
