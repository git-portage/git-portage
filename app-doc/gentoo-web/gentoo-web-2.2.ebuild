...
# $Header: /var/cvsroot/gentoo-x86/app-doc/gentoo-web/Attic/gentoo-web-2.2.ebuild,v 1.48 2002/04/23 20:12:15 drobbins Exp $
...
src_install() {
	...
	cd ${S}
	local x
	for x in java eclass-howto build desktop xml-guide portage-manual portage-user gentoo-howto faq nvidia_tsg openafs cvs-tutorial shots ebuild-submit altinstall uml
	do
