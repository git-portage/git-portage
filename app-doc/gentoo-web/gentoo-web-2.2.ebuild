...
# $Header: /var/cvsroot/gentoo-x86/app-doc/gentoo-web/Attic/gentoo-web-2.2.ebuild,v 1.10 2001/08/08 19:01:20 drobbins Exp $
...
src_install() {
	...
	cd ${FILESDIR}/images
	doins gtop-s.jpg gbot-s.gif gridtest.gif gentoo-new.gif install*.gif
