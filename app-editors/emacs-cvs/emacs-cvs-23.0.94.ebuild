...
# $Header: /var/cvsroot/gentoo-x86/app-editors/emacs-cvs/Attic/emacs-cvs-23.0.94.ebuild,v 1.3 2009/05/28 13:57:37 fauli Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/emacs-${PV}-handle-xz-suffix.patch"
