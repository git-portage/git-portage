...
# $Header: /var/cvsroot/gentoo-x86/app-editors/gedit/Attic/gedit-2.22.3-r2.ebuild,v 1.2 2009/03/31 16:28:25 jer Exp $
...
src_unpack() {
	...
	# fix for CVE-2009-0314, bug #257004
	epatch "${FILESDIR}/${P}-CVE-2009-0314.patch"
