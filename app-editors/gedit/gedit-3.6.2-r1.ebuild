...
# $Header: /var/cvsroot/gentoo-x86/app-editors/gedit/Attic/gedit-3.6.2-r1.ebuild,v 1.3 2012/12/31 14:15:32 ago Exp $
...
KEYWORDS="~amd64 ~mips ~ppc ~sh ~x86 ~x86-fbsd ~x86-freebsd ~x86-interix ~amd64-linux ~ia64-linux ~x86-linux"
