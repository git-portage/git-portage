...
# $Header: /var/cvsroot/gentoo-x86/app-editors/jedit/Attic/jedit-4.3_pre7.ebuild,v 1.1 2006/11/15 06:01:34 nichoj Exp $
...
src_compile() {
	eant build $(use_doc javadoc docs-html) \
		-Dgentoo.classpath=$(java-pkg_getjars gnu-regexp-1)
}
...
#		${PN}.jar jars doc macros modes properties startup

	java-pkg_dolauncher ${PN} --pwd ${JEDIT_HOME} --jar ${JEDIT_HOME}/${PN}.jar
