...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/emul-linux-x86-xlibs/Attic/emul-linux-x86-xlibs-1.2-r3.ebuild,v 1.1 2005/01/18 03:03:20 eradicator Exp $
...
src_install() {
	...
	dodir /emul/linux/x86/usr/X11R6/lib32/X11/locale/C
