...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/ganeti/Attic/ganeti-2.4.3.ebuild,v 1.1 2011/08/09 06:57:04 ramereth Exp $
...
src_prepare () {
	epatch "${FILESDIR}/${P}-fix-start-stop.patch"
}
