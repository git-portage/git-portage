...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/virtualbox/Attic/virtualbox-3.1.8.ebuild,v 1.1 2011/01/07 15:11:45 polynomial-c Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-ose-3.0.0-mesa-check.patch"

	# fix with newer iasl (bug #319127)
	epatch "${FILESDIR}/${PN}-ose-3.1.8-iasl-length-calculation-fix.patch"
}
