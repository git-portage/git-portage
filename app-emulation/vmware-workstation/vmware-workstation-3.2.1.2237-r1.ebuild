...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/vmware-workstation/Attic/vmware-workstation-3.2.1.2237-r1.ebuild,v 1.1 2003/07/26 00:46:11 vapier Exp $
...
src_compile() {
	if [ ${GLIBC_232} -eq 1 ] ; then
		$(gcc-getCC) -W -Wall -shared -o vmware-glibc-2.3.2-compat.so \
			${FILESDIR}/${PVR}/vmware-glibc-2.3.2-compat.c \
...
src_install() {
	...
	epatch ${FILESDIR}/${PVR}/vmware-config.pl-gcc-generalized.patch
