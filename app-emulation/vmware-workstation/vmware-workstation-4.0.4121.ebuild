...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/vmware-workstation/Attic/vmware-workstation-4.0.4121.ebuild,v 1.2 2003/03/11 21:11:44 seemant Exp $
...
NP="VMware-workstation-e.x.p-4121"
...
pkg_nofetch() {
	einfo "You must goto ${HOMEPAGE}."
	einfo "Once there, you must sign up and then download the package."
}
