...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/vmware-workstation/Attic/vmware-workstation-4.0.4320.ebuild,v 1.1 2003/03/22 23:57:15 malverian Exp $
...
NP="VMware-workstation-e.x.p-4320"
...
#	patch -p0 < ${FILESDIR}/${PVR}/vmware-config.pl-gcc-generalized.patch
	...
	chmod u+s ${D}/opt/vmware/lib/bin/vmware-vmx
