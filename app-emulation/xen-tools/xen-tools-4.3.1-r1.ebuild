...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/xen-tools/Attic/xen-tools-4.3.1-r1.ebuild,v 1.1 2013/12/01 04:21:54 idella4 Exp $
...
pkg_postinst() {
	...
	elog "To utilise the xencommons script, add with rc-update"
