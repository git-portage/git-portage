...
# $Header: /var/cvsroot/gentoo-x86/app-i18n/atokx3/Attic/atokx3-2.0.0.ebuild,v 1.1 2008/03/21 16:11:29 matsuu Exp $
...
SRC_URI="http://www3.justsystem.co.jp/download/atok/up/lin/${PN}up1.tar.gz"
...
src_unpack() {
	...
	# atokx3up1
	unpack ${A}
	tar xzf "${S}"/atokx3up1/bin/IIIMF/iiimf-server-trunk_r3104-js2.i386.tar.gz || die
	tar xzf "${S}"/atokx3up1/bin/ATOK/atokxup-20.0-2.0.0.i386.tar.gz || die
	rm -rf "${S}"/atokx3up1
