...
# $Header: /var/cvsroot/gentoo-x86/app-i18n/scim/Attic/scim-1.4.6.ebuild,v 1.1 2007/04/22 09:28:05 matsuu Exp $
...
PDEPEND="!hppa? ( kde? ( app-i18n/skim ) )
	!alpha? ( qt3? ( || ( app-i18n/scim-qtimm app-i18n/scim-bridge ) ) )"
