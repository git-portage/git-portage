...
# $Header: /var/cvsroot/gentoo-x86/app-misc/gpsdrive/Attic/gpsdrive-1.31.ebuild,v 1.2 2003/02/13 09:00:22 vapier Exp $
...
src_compile() {
	econf `use_enable mysql` `use_enable nls` || die
	emake || die
