...
# $Header: /var/cvsroot/gentoo-x86/app-misc/livecd-tools/Attic/livecd-tools-1.0.33-r2.ebuild,v 1.3 2007/03/14 18:14:10 wolf31o2 Exp $
...
RDEPEND="dev-util/dialog
	...
	alpha? ( X? ( >=x11-misc/mkxf86config-0.9.2 ) )
