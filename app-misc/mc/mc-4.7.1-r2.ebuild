...
# $Header: /var/cvsroot/gentoo-x86/app-misc/mc/Attic/mc-4.7.1-r2.ebuild,v 1.1 2010/04/09 16:25:02 reavertm Exp $
...
PATCHES=(
	"${FILESDIR}/${PN}-4.7_mcedit_fix.patch"
	"${FILESDIR}/${PN}-4.7.1_find-results-panelization-crash.patch"
)
