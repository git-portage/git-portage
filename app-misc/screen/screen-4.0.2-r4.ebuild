...
# $Header: /var/cvsroot/gentoo-x86/app-misc/screen/Attic/screen-4.0.2-r4.ebuild,v 1.2 2005/07/06 18:07:56 swegener Exp $
...
src_unpack() {
	...
	# Patch that makes %u work for windowlist formats
