...
# $Header: /var/cvsroot/gentoo-x86/app-misc/tinyca/Attic/tinyca-0.3.4.ebuild,v 1.1 2002/06/24 17:48:47 lamer Exp $
...
src_unpack() {
	...
	cat tinyca | sed -e "s:\./lib:/usr/share/tinyca/lib:" > tinyca
}
