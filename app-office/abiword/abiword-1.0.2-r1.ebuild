...
# $Header: /var/cvsroot/gentoo-x86/app-office/abiword/Attic/abiword-1.0.2-r1.ebuild,v 1.1 2002/08/23 15:45:02 seemant Exp $
...
src_compile() {
	...
	use spell && CFLAGS="${CFLAGS} -L/usr/lib/pspell -laspell"
