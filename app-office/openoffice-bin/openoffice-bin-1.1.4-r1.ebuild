...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-bin/Attic/openoffice-bin-1.1.4-r1.ebuild,v 1.4 2005/06/09 13:23:20 swegener Exp $
...
src_install() {
	...
	# Security fix (#88863)
	rm -f ${D}${INSTDIR}/program/libsot645li.so || die
	cp -f ${DISTDIR}/libsot645li.so ${D}${INSTDIR}/program/ || die
}
