...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-bin/Attic/openoffice-bin-1.1_rc3.ebuild,v 1.1 2003/08/17 12:47:53 tad Exp $
...
src_install() {
	...
	sed -e "s|<pv>|${PV//_rc3}|g" ${T}/rsfile-local > ${T}/autoresponse-${PV}.conf
