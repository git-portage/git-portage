...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-bin/Attic/openoffice-bin-2.0.0_rc3.ebuild,v 1.1 2005/10/15 22:20:57 suka Exp $
...
LANGSUFFIX="${MY_PV3}-3.i586.tar.gz"

SRC_URI="mirror://openoffice/contrib/rc/2.0.0rc3/OOo_2.0.0rc3_051015_LinuxIntel_install.tar.gz
...
src_unpack() {
	...
	for i in base calc core01 core02 core03 core03u core04 core04u core05 core05u core06 core07 core08 core09 core10 draw impress math writer graphicfilter pyuno spellcheck testtool xsltfilter ; do
		rpm_unpack ${S}/openoffice.org-${i}-${MY_PV3}-3.i586.rpm
	done

	rpm_unpack ${S}/desktop-integration/openoffice.org-freedesktop-menus-${MY_PV3}-3.noarch.rpm
	use kde && rpm_unpack ${S}/desktop-integration/openoffice.org-suse-menus-${MY_PV3}-3.noarch.rpm

	use gnome && rpm_unpack ${S}/openoffice.org-gnome-integration-${MY_PV3}-3.i586.rpm
	use java && rpm_unpack ${S}/openoffice.org-javafilter-${MY_PV3}-3.i586.rpm
