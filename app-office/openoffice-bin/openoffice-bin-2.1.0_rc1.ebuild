...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-bin/Attic/openoffice-bin-2.1.0_rc1.ebuild,v 1.2 2006/12/04 01:48:24 solar Exp $
...
MY_PV="${PV/_/}"
MY_PV2="${MY_PV}_20061122"
MY_PV3="${PV/_rc1/}-5"
PACKED="OOE680_m5_native_packed-1"
BUILDID="9093"
...
src_unpack() {
	...
	rpm_unpack ${S}/desktop-integration/openoffice.org-freedesktop-menus-2.1-4.noarch.rpm
