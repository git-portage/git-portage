...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-ximian/Attic/openoffice-ximian-1.1.61.ebuild,v 1.7 2004/09/29 03:07:55 gustavoz Exp $
...
src_unpack() {
	...
	#bin non-existant patch
	epatch ${FILESDIR}/${OO_VER}/rm-nonexistant.diff
