...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice/Attic/openoffice-2.0.1.ebuild,v 1.4 2005/12/23 21:12:29 suka Exp $
...
src_unpack() {
	...
	cd ${S}
	use kde && use !gnome && use !gtk && epatch ${FILESDIR}/2.0.1/noquickstarter.diff
