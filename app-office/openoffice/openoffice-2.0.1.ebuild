...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice/Attic/openoffice-2.0.1.ebuild,v 1.3 2005/12/23 17:44:49 suka Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/2.0.1/noquickstarter.diff
