...
# $Header: /var/cvsroot/gentoo-x86/app-office/qbankmanager/Attic/qbankmanager-0.9.35.ebuild,v 1.1 2006/01/27 23:09:43 hanno Exp $
...
DEPEND=">=net-libs/aqbanking-1.9.4_beta
	=x11-libs/qt-3*"
S=${WORKDIR}/${P}
