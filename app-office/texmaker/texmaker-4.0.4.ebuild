...
# $Header: /var/cvsroot/gentoo-x86/app-office/texmaker/Attic/texmaker-4.0.4.ebuild,v 1.1 2013/09/17 16:19:06 jlec Exp $
...
PATCHES=( "${FILESDIR}"/${PN}-4.0.3-hunspell.patch )
