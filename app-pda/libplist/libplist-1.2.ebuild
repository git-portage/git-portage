...
# $Header: /var/cvsroot/gentoo-x86/app-pda/libplist/Attic/libplist-1.2.ebuild,v 1.1 2010/01/21 22:37:39 chainsaw Exp $
...
src_configure() {
	...
	mycmakeargs="-DCMAKE_SKIP_RPATH=ON
		...
		-DPYTHON_VERSION=${PYVER} VERBOSE=1
	"
...
pkg_postinst() {
	python_version
	python_mod_optimize /usr/$(get_libdir)/python${PYVER}/site-packages/plist
}
