...
# $Header: /var/cvsroot/gentoo-x86/app-portage/basc/Attic/basc-1.5.0.ebuild,v 1.2 2004/12/29 12:39:20 pvdabeel Exp $

# ebuild contributed by Alexander Mieland and Daniel Herzog

inherit eutils gcc

DESCRIPTION="Python client for Buildtime And Statistics Client for http://www.gentoo-stats.org"
...
src_compile() {
	...
	$(gcc-getCC) ${CFLAGS} -o client/smt-detect client/smt-detect.c >/dev/null 2>&1
}

src_install() {
	exeinto /usr/bin
	doexe client/basc client/hgenlop client/smt-detect client/urandom.sh
