...
# $Header: /var/cvsroot/gentoo-x86/app-portage/eix/Attic/eix-0.2.0-r1.ebuild,v 1.2 2005/02/15 13:29:34 gustavoz Exp $
...
src_compile() {
	epatch ${FILESDIR}/${PV}-bugfixes.patch || die "bugfix patch failed"
