...
# $Header: /var/cvsroot/gentoo-x86/app-portage/gentoolkit/Attic/gentoolkit-0.2.0-r1.ebuild,v 1.1 2005/10/11 23:43:44 vapier Exp $
...
src_install() {
	...
	mv "${D}"/usr/bin/qpkg "${D}"/usr/share/man/man1/qpkg.1 \
		"${D}"/usr/share/doc/${PN}-*/qpkg/ || die
}
