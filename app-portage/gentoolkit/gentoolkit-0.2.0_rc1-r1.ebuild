...
# $Header: /var/cvsroot/gentoo-x86/app-portage/gentoolkit/Attic/gentoolkit-0.2.0_rc1-r1.ebuild,v 1.2 2005/01/01 15:52:50 eradicator Exp $
...
src_install() {
	epatch ${FILESDIR}/glsa.py-revmatch.diff
