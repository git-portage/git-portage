...
# $Header: /var/cvsroot/gentoo-x86/app-portage/gentoolkit/Attic/gentoolkit-0.3.0.4.ebuild,v 1.8 2011/07/09 11:25:18 xarthisius Exp $
...
KEYWORDS="alpha amd64 arm hppa ia64 m68k ~mips ppc ppc64 s390 sh sparc x86 ~ppc-aix ~x64-freebsd ~hppa-hpux ~ia64-hpux ~x86-interix ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~m68k-mint ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-solaris"
