...
# $Header: /var/cvsroot/gentoo-x86/app-portage/herdstat/Attic/herdstat-1.1.0_rc2.ebuild,v 1.2 2005/04/30 16:35:50 ka0ttic Exp $
...
RDEPEND=">=dev-cpp/libxmlpp-2.8.0-r1
	net-misc/wget"
DEPEND=">=dev-cpp/libxmlpp-2.8.0-r1
	>=sys-apps/sed-4"
