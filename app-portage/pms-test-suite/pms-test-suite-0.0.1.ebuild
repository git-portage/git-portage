...
# $Header: /var/cvsroot/gentoo-x86/app-portage/pms-test-suite/Attic/pms-test-suite-0.0.1.ebuild,v 1.1 2011/06/27 21:44:50 mgorny Exp $
...
PACKAGE_MANAGERS=">=sys-apps/portage-2.1.8.3
	sys-apps/pkgcore
	sys-apps/paludis"

RDEPEND="|| ( ${PACKAGE_MANAGERS} )
	dev-python/dbus-python
	dev-python/pygobject"
DEPEND="test? ( ${PACKAGE_MANAGERS} )"
