...
# $Header: /var/cvsroot/gentoo-x86/app-portage/portage-prefpane/Attic/portage-prefpane-0.1-r1.ebuild,v 1.3 2004/10/23 06:33:42 mr_bones_ Exp $
...
src_compile() {
	...
	cd "${S}" && sed -e 's/-lObjC//' Makefile > tmp.$$ && mv tmp.$$ Makefile
