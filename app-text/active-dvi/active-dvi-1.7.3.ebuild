...
# $Header: /var/cvsroot/gentoo-x86/app-text/active-dvi/Attic/active-dvi-1.7.3.ebuild,v 1.4 2008/08/17 20:35:22 aballier Exp $
...
DEPEND="${RDEPEND}
	|| ( dev-texlive/texlive-pstricks app-text/tetex app-text/ptex )
