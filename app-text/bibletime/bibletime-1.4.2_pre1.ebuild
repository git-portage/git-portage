...
# $Header: /var/cvsroot/gentoo-x86/app-text/bibletime/Attic/bibletime-1.4.2_pre1.ebuild,v 1.5 2004/07/06 12:19:01 carlo Exp $
...
DEPEND=">=app-text/sword-1.5.8_pre1
	>=net-misc/curl-7.10"
DEPEND=${RDEPEND}
need-kde 3
