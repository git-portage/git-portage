...
# $Header: /var/cvsroot/gentoo-x86/app-text/calibre/Attic/calibre-0.7.24-r1.ebuild,v 1.1 2010/10/26 19:03:31 zmedico Exp $
...
SRC_URI="http://calibre-ebook.com/downloads/$P.tar.gz http://bazaar.launchpad.net/~kovid/calibre/trunk/diff/6690 -> $P-bug-342751.patch"
...
src_prepare() {
	epatch "$DISTDIR/$P-bug-342751.patch"
