...
# $Header: /var/cvsroot/gentoo-x86/app-text/crm114/Attic/crm114-20040924.ebuild,v 1.2 2005/01/01 16:07:04 eradicator Exp $

inherit eutils

IUSE="nls static normalizemime mew mimencode"

MY_P="${P}.BlameResidentWeasel.src"
S=${WORKDIR}/${MY_P}
...
src_unpack() {
	...
	if use mew ; then
		...
		sed -i 's%#:mime_decoder /normalizemime/%:mime_decoder: /normalizemime/%' \
			mailfilter.cf
	fi
