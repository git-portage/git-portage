...
# $Header: /var/cvsroot/gentoo-x86/app-text/docbook-xml-dtd/Attic/docbook-xml-dtd-4.2.ebuild,v 1.11 2003/09/24 22:02:41 drobbins Exp $
...
KEYWORDS="ia64 ia64 ~x86 ppc ~sparc alpha ~hppa ~amd64"
src_unpack() {
	mkdir ${S}
	cd ${S}
	unpack ${A}
