...
# $Header: /var/cvsroot/gentoo-x86/app-text/docbook-xsl-stylesheets/Attic/docbook-xsl-stylesheets-1.68.1.ebuild,v 1.1 2005/05/29 09:54:35 leonardop Exp $
...
src_install() {
	...
	local sheets="common extensions fo html htmlhelp images \
