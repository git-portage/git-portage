...
# $Header: /var/cvsroot/gentoo-x86/app-text/sgmltools-lite/Attic/sgmltools-lite-3.0.3.ebuild,v 1.3 2001/08/17 16:47:54 drobbins Exp $

S=${WORKDIR}/${P}
SRC_URI="prdownloads.sourceforge.net/sgmltools-lite/${P}.tar.gz
	 prdownloads.sourceforge.net/sgmltools-lite/nw-eps-icons-0.0.1.tar.gz"
