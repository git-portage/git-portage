...
# $Header: /var/cvsroot/gentoo-x86/app-text/xpdf/Attic/xpdf-1.00-r1.ebuild,v 1.1 2002/04/30 07:17:42 kain Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	patch -p1 < ${FILESDIR}/FTFont-freetype2.1-fix.patch
}
