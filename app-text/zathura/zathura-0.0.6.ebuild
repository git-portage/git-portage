...
# $Header: /var/cvsroot/gentoo-x86/app-text/zathura/Attic/zathura-0.0.6.ebuild,v 1.1 2010/06/09 12:24:43 ssuominen Exp $
...
SRC_URI="http://dev.gentoo.org/~ssuominen/${P}.tar.gz" # upstream https problems
