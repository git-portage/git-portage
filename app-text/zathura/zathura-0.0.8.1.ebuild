...
# $Header: /var/cvsroot/gentoo-x86/app-text/zathura/Attic/zathura-0.0.8.1.ebuild,v 1.2 2010/10/20 08:33:24 hwoarang Exp $
...
SRC_URI="http://zathura.pwmt.org/attachments/download/10/${P}.tar.gz"
