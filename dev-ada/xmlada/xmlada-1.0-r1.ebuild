...
# $Header: /var/cvsroot/gentoo-x86/dev-ada/xmlada/Attic/xmlada-1.0-r1.ebuild,v 1.1 2006/05/15 10:11:02 george Exp $
...
lib_compile()
{
	...
	sed -i -e "s:BUILD_SHARED=FALSE:BUILD_SHARED=TRUE:" \
		-e "s:libxmlada_\${@\:%_install=%}-\${MAJOR}.\${MINOR}.so:libxmlada_\${@\:%_install=%}.so.${MAJOR}.${MINOR}:" \
