...
# $Header: /var/cvsroot/gentoo-x86/dev-db/framerd/Attic/framerd-2.4.3.ebuild,v 1.1 2002/12/05 11:50:10 lordvan Exp $
...
src_compile() {
    ...
    MY_OPTS="--host=${CHOST} --prefix=/usr --infodir=/usr/share/info --mandir=/usr/share/man --enable-shared"
