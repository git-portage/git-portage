...
# $Header: /var/cvsroot/gentoo-x86/dev-db/jxtray/Attic/jxtray-0.5.ebuild,v 1.4 2005/03/04 11:37:19 luckyduck Exp $
...
src_install() {
	local cp="java-config -p jxtray,jdom-1.0_beta9,xerces-2,sax,poi,kunststoff-2.0"
