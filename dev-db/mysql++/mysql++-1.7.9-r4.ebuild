...
# $Header: /var/cvsroot/gentoo-x86/dev-db/mysql++/Attic/mysql++-1.7.9-r4.ebuild,v 1.6 2005/01/01 17:37:25 eradicator Exp $
	...
	if [ `gcc-major-version` -eq 3 ] ; then
		...
		#EPATCH_SINGLE_MSG="Patch for const char* error" \
			...
			if [ `gcc-micro-version` -eq 3 ]; then
				...
				epatch ${FILESDIR}/mysql++-1.7.9_gcc333.patch
			fi
		fi
