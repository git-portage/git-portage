...
# $Header: /var/cvsroot/gentoo-x86/dev-db/mysql-administrator/Attic/mysql-administrator-1.0.19-r1.ebuild,v 1.1 2005/01/11 19:29:48 swegener Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PV}-crontab.patch
}
