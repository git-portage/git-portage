...
# $Header: /var/cvsroot/gentoo-x86/dev-db/mysql/Attic/mysql-4.0.20.ebuild,v 1.5 2004/05/27 05:54:16 vapier Exp $
...
KEYWORDS="~ia64 ~x86 ~sparc ppc ~amd64 ~hppa ~alpha ~mips ~s390 arm"
LICENSE="GPL-2"
SLOT="0"
