...
# $Header: /var/cvsroot/gentoo-x86/dev-db/phpmyadmin/Attic/phpmyadmin-2.5.5.ebuild,v 1.1 2003/12/29 01:29:51 twp Exp $
...
src_install() {
	...
	local docs="CREDITS Documentation.txt RELEASE-DATE-${PV} TODO"
