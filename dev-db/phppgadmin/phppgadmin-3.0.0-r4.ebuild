...
# $Header: /var/cvsroot/gentoo-x86/dev-db/phppgadmin/Attic/phppgadmin-3.0.0-r4.ebuild,v 1.1 2003/07/22 03:17:10 nakano Exp $

IUSE=""
MY_PN="phpPgAdmin"
S="${WORKDIR}/${MY_PN}"
DESCRIPTION="Web-based administration for Postgres database in php"
SRC_URI="mirror://sourceforge/${PN}/${MY_PN}-3.0.tar.bz2"
