...
# $Header: /var/cvsroot/gentoo-x86/dev-db/postgresql/Attic/postgresql-7.3.3.ebuild,v 1.5 2003/09/10 01:45:05 msterret Exp $
...
src_install() {
	...
	exeinto /etc/init.d/
	newexe ${FILESDIR}/postgresql.init postgresql || die
