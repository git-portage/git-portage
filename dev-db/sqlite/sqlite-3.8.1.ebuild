...
# $Header: /var/cvsroot/gentoo-x86/dev-db/sqlite/Attic/sqlite-3.8.1.ebuild,v 1.1 2013/10/17 20:20:55 floppym Exp $
...
src_prepare() {
	if amalgamation; then
		epatch "${FILESDIR}/${P}-autoconf-dlopen_check.patch"
	else
		epatch "${FILESDIR}/${P}-src-dlopen_check.patch"
		epatch "${FILESDIR}/${P}-tests-icu-52.patch"
	fi
