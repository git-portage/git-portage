...
# $Header: /var/cvsroot/gentoo-x86/dev-haskell/wxhaskell/Attic/wxhaskell-0.6-r1.ebuild,v 1.5 2005/01/01 18:06:13 eradicator Exp $
...
src_install() {
	...
	mv ${D}/usr/lib/${ghc_version}/libwxc-${PV}.so ${D}/usr/lib
	if use doc; then
