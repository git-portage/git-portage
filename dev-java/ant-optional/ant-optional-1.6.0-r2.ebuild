...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ant-optional/Attic/ant-optional-1.6.0-r2.ebuild,v 1.15 2004/07/31 21:21:10 karltk Exp $
...
DEPEND="=dev-java/ant-1.6.0-r2
	...
	jython? ( || ( >=dev-java/jython-2.1 >=dev-java/jython-bin-2.1 ) )
