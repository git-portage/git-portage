...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ant-optional/Attic/ant-optional-1.6.1-r1.ebuild,v 1.15 2004/07/31 21:21:10 karltk Exp $
...
src_compile() {
	...
	for i in "ant,antlr,bcel,bsh,commons-beanutils,commons-net,commons-logging,sun-javamail-bin,sun-jaf-bin,jdepend,jsch,junit,jython-bin,log4j,oro,regexp-bin,rhino,xalan,xerces"; do
