...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ant/Attic/ant-1.5.3-r2.ebuild,v 1.1 2003/04/23 11:09:08 absinthe Exp $

S="${WORKDIR}/apache-ant-${PV}-1"
DESCRIPTION="Java-based build tool similar to 'make' that uses XML configuration files."
SRC_URI="http://apache.ttlhost.com/${PN}/source/apache-${PN}-${PV}-1-src.tar.bz2"
