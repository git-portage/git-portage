...
# $Header: /var/cvsroot/gentoo-x86/dev-java/antlr/Attic/antlr-3.1.3-r2.ebuild,v 1.7 2011/08/18 19:21:40 grobian Exp $
...
LICENSE="BSD"
SLOT="3"
KEYWORDS="amd64 ppc ppc64 x86 ~x64-freebsd ~x86-freebsd ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-solaris"
IUSE="gunit"
