...
# $Header: /var/cvsroot/gentoo-x86/dev-java/commons-httpclient/Attic/commons-httpclient-3.0.1.ebuild,v 1.5 2007/04/27 12:33:34 caster Exp $
...
src_compile() {
	eant dist $(use_doc doc) $(use test && echo "-Dtest.entry=true")
}
