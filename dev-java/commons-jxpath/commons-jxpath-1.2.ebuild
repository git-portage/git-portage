...
# $Header: /var/cvsroot/gentoo-x86/dev-java/commons-jxpath/Attic/commons-jxpath-1.2.ebuild,v 1.1 2007/01/21 01:01:45 fordfrog Exp $
...
RDEPEND=">=virtual/jre-1.4
	${COMMON_DEPEND}"
# Limited to jdk-1.4 because javadoc fails with other jdks
