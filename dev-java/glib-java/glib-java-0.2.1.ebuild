...
# $Header: /var/cvsroot/gentoo-x86/dev-java/glib-java/Attic/glib-java-0.2.1.ebuild,v 1.1 2005/11/12 23:28:39 compnerd Exp $
...
pkg_setup() {
	if use gcj ; then
		if ! built_with_use sys-devel/gcc gcc ; then
			ewarn
