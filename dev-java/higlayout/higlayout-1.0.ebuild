...
# $Header: /var/cvsroot/gentoo-x86/dev-java/higlayout/Attic/higlayout-1.0.ebuild,v 1.1 2007/01/07 22:46:29 caster Exp $
...
src_compile() {
	...
	jar cf higlayout.jar classes/cz || die "failed to create .jar"
	if use doc; then
