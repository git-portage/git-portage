...
# $Header: /var/cvsroot/gentoo-x86/dev-java/kissme/Attic/kissme-0.18-r1.ebuild,v 1.3 2002/07/11 06:30:19 drobbins Exp $

S=${WORKDIR}/${P}
DESCRIPTION="Tiny, JITless JVM"
SRC_URI="mirror://sourceforge/kissme/kissme-0.18.tar.gz"
