...
# $Header: /var/cvsroot/gentoo-x86/dev-java/sun-jdk/Attic/sun-jdk-1.4.2.13-r2.ebuild,v 1.1 2007/04/19 18:54:25 betelgeuse Exp $
...
src_install() {
	...
	dosym "/opt/${P}/src.zip" /opt/${P}/share
...
pkg_postinst() {
	...
	elog ""
	elog "Starting with 1.4.2-r2 the src.zip is installed to the standard"
