...
# $Header: /var/cvsroot/gentoo-x86/dev-java/sun-jdk/Attic/sun-jdk-1.4_pre1.ebuild,v 1.1 2002/02/10 22:30:10 karltk Exp $
...
src_install () {
	...
	cp -a demo src.zip ${D}/opt/${P}/share/
		...
		dosym /opt/${P}/jre/plugin/i386/ns600/libjavaplugin_oji140.so /usr/lib/mozilla/plugins/
	fi                            
