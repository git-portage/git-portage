...
# $Header: /var/cvsroot/gentoo-x86/dev-java/sun-jdk/Attic/sun-jdk-1.5.0.11-r1.ebuild,v 1.1 2007/04/19 19:25:16 betelgeuse Exp $
...
src_install() {
	...
	dosym "/opt/${P}/src.zip" /opt/${P}/share || die
...
pkg_postinst() {
	...
	elog ""
	elog "Starting with 1.5.0.11-r1 the src.zip is installed to the standard"
	elog "location. It is still symlinked to the old location (/opt/${P}/share)"
	elog "but it will be removed if there will be 1.5.0.12."
