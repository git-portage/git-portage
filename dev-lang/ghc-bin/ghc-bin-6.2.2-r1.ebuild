...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/ghc-bin/Attic/ghc-bin-6.2.2-r1.ebuild,v 1.1 2005/05/20 13:40:00 dcoutts Exp $

IUSE="" # use the non-binary version if you want to have more choice

DESCRIPTION="Glasgow Haskell Compiler"
# list all arches for proper digest building:
SRC_URI="sparc? ( mirror://gentoo/${P}-sparc.tbz2 )"
