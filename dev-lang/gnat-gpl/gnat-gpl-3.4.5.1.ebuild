...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/gnat-gpl/Attic/gnat-gpl-3.4.5.1.ebuild,v 1.2 2006/03/19 22:20:51 halcy0n Exp $
...
SRC_URI="ftp://gcc.gnu.org/pub/gcc/releases/gcc-${GCCVER}/gcc-core-${GCCVER}.tar.bz2
	...
	x86?   ( http://dev.gentoo.org/~george/src/gnatboot-3.4-i686.tar.bz2 )
	amd64? ( http://dev.gentoo.org/~george/src/gnatboot-3.4-amd64.tar.bz2 )"
