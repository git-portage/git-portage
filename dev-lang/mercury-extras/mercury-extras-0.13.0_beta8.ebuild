...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/mercury-extras/Attic/mercury-extras-0.13.0_beta8.ebuild,v 1.1 2006/05/02 07:56:19 keri Exp $

inherit eutils versionator

BETA_V=$(get_version_component_range 4 $PV)
MY_PV=$(get_version_component_range 1-3 $PV)-beta
MY_P=${PN}-${MY_PV}-2006-04-29
