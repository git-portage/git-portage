...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/mercury/Attic/mercury-0.13.0_beta4.ebuild,v 1.1 2006/04/22 21:36:40 keri Exp $

inherit eutils versionator

MY_PV=$(get_version_component_range 1-3 $PV)-beta
MY_P=${PN}-compiler-${MY_PV}-2006-04-21
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P/beta4/beta}-portage.patch
	epatch "${FILESDIR}"/${P/beta4/beta}-CFLAGS.patch
	epatch "${FILESDIR}"/${P/beta4/beta}-docs.patch
}
