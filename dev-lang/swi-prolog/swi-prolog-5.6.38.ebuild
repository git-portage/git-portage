...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/swi-prolog/Attic/swi-prolog-5.6.38.ebuild,v 1.8 2008/01/10 23:07:04 caster Exp $
...
src_unpack() {
	...
	epatch "${WORKDIR}"/${PV}/2101-gmp-ar-even.patch
