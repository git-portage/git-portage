...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/swi-prolog/Attic/swi-prolog-5.6.38.ebuild,v 1.3 2007/08/11 21:56:19 keri Exp $
...
src_unpack() {
	...
	epatch "${WORKDIR}"/${PV}/2101-pl-profile-va-debug.patch
