...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/glib/Attic/glib-2.10.1-r1.ebuild,v 1.1 2006/03/27 21:15:39 compnerd Exp $
...
src_compile() {
	...
	econf $(use_enable doc gtk-doc) ${myconf} --with-threads=posix || die "configure failed"
