...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/liblzw/Attic/liblzw-0.1.1-r1.ebuild,v 1.2 2008/02/03 14:38:26 armin76 Exp $
...
src_install() {
	...
	sed -i 's:@@requirements@::' "${D}"/usr/lib*/pkgconfig/liblzw.pc || die
}
