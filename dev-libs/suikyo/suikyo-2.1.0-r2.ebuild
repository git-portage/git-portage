...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/suikyo/Attic/suikyo-2.1.0-r2.ebuild,v 1.1 2010/03/20 16:52:52 matsuu Exp $
...
src_configure() {
	econf \
		...
		--with-rubydir="/usr/$(get_libdir)/ruby/site_ruby" || die
}
