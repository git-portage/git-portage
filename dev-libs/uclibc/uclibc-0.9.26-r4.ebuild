...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/uclibc/Attic/uclibc-0.9.26-r4.ebuild,v 1.6 2004/09/06 19:07:39 ciaranm Exp $

inherit eutils flag-o-matic gcc

# To make a new CVS_VER we do.
# wget -O - http://uclibc.org/downloads/snapshots/uClibc-20040730.tar.bz2 | tar jxf -
# tar jxf /usr/portage/distfiles/uClibc-0.9.26.tar.bz2
# diff -urN --exclude .cvsignore --exclude CVS uClibc-0.9.26 uClibc | bzip2 - > uClibc-0.9.26-cvs-update-20040730.patch.bz2
# rm -rf uClibc-0.9.26-cvs-update-20040730.patch.bz2  uClibc uClibc-0.9.26
