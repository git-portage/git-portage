...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/xmlrpc-c/Attic/xmlrpc-c-1.16.06-r1.ebuild,v 1.2 2009/01/03 05:12:41 loki_val Exp $
...
src_compile() {
	...
	econf	--disable-wininet-client \
		...
		|| die "econf failed"
	#We need to "emake all" or we'll run into bug 251415
	#Per suggestion from upstream
