...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/yaz++/Attic/yaz++-1.1.4.ebuild,v 1.1 2009/11/08 13:41:46 patrick Exp $
...
SRC_URI="http://ftp.indexdata.dk/pub/${MY_PN}/${MY_PN}-${PV}.tar.gz"
