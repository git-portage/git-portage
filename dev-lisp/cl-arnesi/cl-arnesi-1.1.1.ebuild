...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/cl-arnesi/Attic/cl-arnesi-1.1.1.ebuild,v 1.1 2004/02/12 09:13:13 mkennedy Exp $
...
src_unpack() {
	...
	find ${S}/src -type d -name .arch-ids -exec rm -rf '{}' \;
}
