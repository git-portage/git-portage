...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/cl-htmlgen/Attic/cl-htmlgen-1.2.12c.ebuild,v 1.4 2004/05/08 23:15:49 mkennedy Exp $
...
S=${WORKDIR}/cl-portable-aserve-${PV}+cvs${CVS_PV}
