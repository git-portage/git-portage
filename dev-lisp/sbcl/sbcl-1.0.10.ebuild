...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/sbcl/Attic/sbcl-1.0.10.ebuild,v 1.4 2008/11/16 16:31:39 flameeyes Exp $
...
EOF
	...
	echo "SBCL_HOME=/usr/$(get_libdir)/sbcl" >> "${T}/50sbcl"; doenvd "${T}/50sbcl"
