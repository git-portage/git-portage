...
# $Header: /var/cvsroot/gentoo-x86/dev-perl/Mail-SpamAssassin/Attic/Mail-SpamAssassin-2.55-r2.ebuild,v 1.1 2003/09/25 06:13:13 rac Exp $
...
myconf="INST_PREFIX=/usr SITEPREFIX=\$(PREFIX) INST_SYSCONFDIR=/etc SYSCONFDIR=${D}/etc PKG_DEF_RULES_DIR=${D}/usr/share/spamassassin RUN_RAZOR1_TESTS=n RUN_RAZOR2_TESTS=n"
