...
# $Header: /var/cvsroot/gentoo-x86/dev-php/php/Attic/php-4.3.0-r4.ebuild,v 1.1 2003/02/13 19:03:29 rphillips Exp $
...
src_install() {
	...
	make INSTALL_ROOT=${D} install-cli install-pear install-headers install-modules || die
