...
# $Header: /var/cvsroot/gentoo-x86/dev-php5/ezc-eZcomponents/Attic/ezc-eZcomponents-2007.2.ebuild,v 1.1 2008/01/13 16:12:24 jokey Exp $
...
RDEPEND="
	...
	>=dev-php5/ezc-Base-1.4
	>=dev-php5/ezc-Cache-1.3
	>=dev-php5/ezc-Configuration-1.2
	>=dev-php5/ezc-ConsoleTools-1.3.1
	>=dev-php5/ezc-Database-1.3.3
	>=dev-php5/ezc-DatabaseSchema-1.3
	...
	>=dev-php5/ezc-Mail-1.4
	>=dev-php5/ezc-PersistentObject-1.3.3
	...
	# these are commented out until keyworded on hppa and sparc
