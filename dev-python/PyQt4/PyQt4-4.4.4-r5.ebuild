...
# $Header: /var/cvsroot/gentoo-x86/dev-python/PyQt4/Attic/PyQt4-4.4.4-r5.ebuild,v 1.3 2009/06/03 22:53:24 yngwin Exp $
...
DEPEND=">=dev-python/sip-4.7.8
	...
	phonon? (
		|| ( >=x11-libs/qt-phonon-${QTVER}:4 media-sound/phonon )
