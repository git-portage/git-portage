...
# $Header: /var/cvsroot/gentoo-x86/dev-python/bsddb3/Attic/bsddb3-5.1.1.ebuild,v 1.2 2010/12/20 09:15:45 phajdan.jr Exp $
...
src_prepare() {
	...
	# Don't require bsddb module with Python 2.7.
	sed -e "/finally :/i\        except ImportError: pass" -i setup2.py
}
