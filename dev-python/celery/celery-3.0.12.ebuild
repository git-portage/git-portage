...
# $Header: /var/cvsroot/gentoo-x86/dev-python/celery/Attic/celery-3.0.12.ebuild,v 1.1 2012/11/13 08:24:32 patrick Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${PN}-3.0.11-require-python-dateutil-2.1.patch"
}
