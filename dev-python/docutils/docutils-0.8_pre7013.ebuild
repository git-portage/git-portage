...
# $Header: /var/cvsroot/gentoo-x86/dev-python/docutils/Attic/docutils-0.8_pre7013.ebuild,v 1.1 2011/04/22 00:56:21 arfrever Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-0.7-python-3.2-configparser.patch"
