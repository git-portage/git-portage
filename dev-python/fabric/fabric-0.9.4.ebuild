...
# $Header: /var/cvsroot/gentoo-x86/dev-python/fabric/Attic/fabric-0.9.4.ebuild,v 1.1 2011/02/19 17:45:35 arfrever Exp $
...
src_prepare() {
	...
	sed -e "/install_requires=/s/'pycrypto %s' % PYCRYPTO, //" -i setup.py
}
