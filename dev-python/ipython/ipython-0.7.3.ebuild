...
# $Header: /var/cvsroot/gentoo-x86/dev-python/ipython/Attic/ipython-0.7.3.ebuild,v 1.1 2007/02/03 10:44:59 dev-zero Exp $
...
src_test() {
	cd test
	"${python}" test_irunner.py || die "irunner test failed"
	"${python}" test_wildcard.py || die "wildcard test failed"
}
