...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pygobject/Attic/pygobject-2.18.0-r2.ebuild,v 1.2 2009/10/11 10:37:08 grobian Exp $
...
src_install() {
	...
	installation() {
		gnome2_src_install
		mv "${ED}$(python_get_sitedir)/pygtk.py" "${D}$(python_get_sitedir)/pygtk.py-2.0"
		mv "${ED}$(python_get_sitedir)/pygtk.pth" "${D}$(python_get_sitedir)/pygtk.pth-2.0"
	}
