...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pyro/Attic/pyro-4.14.ebuild,v 1.3 2013/02/02 15:22:00 aidecoe Exp $
...
pkg_postinst() {
	ewarn "A temporary workaround for a thread pool scaling problem (lock-up)"
	ewarn "is in effect: the thread pool is fixed at THREADPOOL_MINTHREADS"
	ewarn "threads.  THREADPOOL_MAXTHREADS can still be set but has no effect"
	ewarn "at the moment, until the thread pool implementation has been fixed."
}
