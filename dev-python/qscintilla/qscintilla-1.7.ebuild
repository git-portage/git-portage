...
# $Header: /var/cvsroot/gentoo-x86/dev-python/qscintilla/Attic/qscintilla-1.7.ebuild,v 1.1 2006/11/14 13:48:15 caleb Exp $

inherit eutils toolchain-funcs

QSCINTILLA_MAJOR_VER="1"
SCINTILLA_VER="1.71"
MY_P="${PN/qs/QS}1-${SCINTILLA_VER}-gpl-${PV}"
