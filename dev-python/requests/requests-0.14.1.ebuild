...
# $Header: /var/cvsroot/gentoo-x86/dev-python/requests/Attic/requests-0.14.1.ebuild,v 1.1 2012/10/05 00:10:25 radhermit Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-system-cacerts.patch
