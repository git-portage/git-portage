...
# $Header: /var/cvsroot/gentoo-x86/dev-python/virtualenv/Attic/virtualenv-1.9.1.ebuild,v 1.1 2013/03/17 05:40:31 patrick Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-1.8.2-no-versioned-script.patch
}
