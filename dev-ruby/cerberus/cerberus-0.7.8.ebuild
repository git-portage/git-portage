...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/cerberus/Attic/cerberus-0.7.8.ebuild,v 1.2 2010/06/05 06:11:09 graaff Exp $
...
DEPEND="${DEPEND} test? ( dev-util/subversion )"
