...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/i18n/Attic/i18n-0.6.0.ebuild,v 1.4 2012/05/01 18:24:12 armin76 Exp $
...
KEYWORDS="~amd64 ~hppa ~ppc64 ~x86 ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
IUSE=""
