...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/omniauth/Attic/omniauth-1.1.4-r1.ebuild,v 1.2 2013/11/22 05:21:53 patrick Exp $
...
all_ruby_prepare() {
	...
	sed -i -e '/simplecov/,+7d' spec/helper.rb || die "sed failed"
