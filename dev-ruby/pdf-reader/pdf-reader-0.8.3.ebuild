...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/pdf-reader/Attic/pdf-reader-0.8.3.ebuild,v 1.1 2010/02/14 22:45:12 flameeyes Exp $
...
S="${WORKDIR}/${GITHUB_USER}-${PN}-8544bbc"
