...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/ruby-debug/Attic/ruby-debug-0.10.3-r4.ebuild,v 1.1 2010/08/08 09:21:04 graaff Exp $
...
all_ruby_install() {
	...
	if use emacs; then
		DESTDIR="${D}" emake -C"${EXTRA_S}/emacs" install || die
	fi
