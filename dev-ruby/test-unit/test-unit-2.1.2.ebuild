...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/test-unit/Attic/test-unit-2.1.2.ebuild,v 1.3 2010/12/27 20:23:09 grobian Exp $
...
LICENSE="MIT"
SLOT="2"
KEYWORDS="~amd64 ~ia64 ~ppc ~sparc ~x86 ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~x64-solaris ~x86-solaris"
IUSE=""
