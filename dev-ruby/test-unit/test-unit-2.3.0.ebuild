...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/test-unit/Attic/test-unit-2.3.0.ebuild,v 1.1 2011/07/22 07:36:16 graaff Exp $
...
ruby_add_bdepend "doc? ( dev-ruby/rdoc dev-ruby/hoe )"
...
RUBY_PATCHES=( "${P}-ree18-tests.patch" "${P}-jruby-tests.patch" )
