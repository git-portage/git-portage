...
# $Header: /var/cvsroot/gentoo-x86/dev-util/buildbot/Attic/buildbot-0.8.2.ebuild,v 1.2 2010/12/20 09:37:53 phajdan.jr Exp $
...
src_install() {
	...
	doman docs/buildbot.1 docs/buildslave.1 || die "doman failed"
...
pkg_postinst() {
	...
	elog "Build slave functionality has been moved to dev-util/buildbot-slave."
}
