...
# $Header: /var/cvsroot/gentoo-x86/dev-util/eric/Attic/eric-5.0.2.ebuild,v 1.1 2010/09/17 19:58:49 arfrever Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${P}-remove_coverage.patch"

	# Avoid file collisions between different slots of Eric.
	sed -e "s/^Icon=eric$/&${SLOT}/" eric/${MY_PN}.desktop || die "sed failed"
