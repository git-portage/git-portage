...
# $Header: /var/cvsroot/gentoo-x86/dev-util/gambas/Attic/gambas-1.0_rc4.ebuild,v 1.1 2004/12/08 07:57:57 genone Exp $
...
src_compile() {
	...
	myconf="${myconf} --enable-kde --enable-qt  --enable-net --enable-vb --enable-bzlib2"
