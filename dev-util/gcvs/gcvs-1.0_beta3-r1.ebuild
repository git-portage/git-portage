...
# $Header: /var/cvsroot/gentoo-x86/dev-util/gcvs/Attic/gcvs-1.0_beta3-r1.ebuild,v 1.11 2004/07/14 23:28:46 agriffis Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	patch -p1 <${FILESDIR}/gcvs-1.0b3-gcc3-gentoo.patch || die
}
