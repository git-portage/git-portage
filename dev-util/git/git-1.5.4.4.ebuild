...
# $Header: /var/cvsroot/gentoo-x86/dev-util/git/Attic/git-1.5.4.4.ebuild,v 1.1 2008/03/17 09:14:45 robbat2 Exp $
...
RDEPEND="${DEPEND}
	...
	perl?   ( dev-perl/Error dev-perl/Authen-SASL dev-perl/Net-SMTP-SSL )
