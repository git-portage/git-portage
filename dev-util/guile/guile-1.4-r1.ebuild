...
# $Header: /var/cvsroot/gentoo-x86/dev-util/guile/Attic/guile-1.4-r1.ebuild,v 1.2 2000/08/16 04:38:00 drobbins Exp $
...
src_compile() {                           
  cd ${S}
  ./configure --host=${CHOST} --prefix=/usr --with-threads --with-modules
  make
}
