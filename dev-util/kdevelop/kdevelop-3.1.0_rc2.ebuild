...
# $Header: /var/cvsroot/gentoo-x86/dev-util/kdevelop/Attic/kdevelop-3.1.0_rc2.ebuild,v 1.1 2004/08/10 20:46:24 carlo Exp $
...
src_unpack() {
	...
	if use amd64; then
		epatch ${FILESDIR}/${P/rc?/beta1}-bdb-fPIC.patch
	fi
}
