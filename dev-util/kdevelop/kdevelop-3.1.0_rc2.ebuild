...
# $Header: /var/cvsroot/gentoo-x86/dev-util/kdevelop/Attic/kdevelop-3.1.0_rc2.ebuild,v 1.3 2004/08/22 20:30:35 kugelfang Exp $
...
SRC_URI="mirror://kde/unstable/3.3.0rc2/src/${MY_P}.tar.bz2"
...
src_unpack() {
	...
	if use amd64; then
		epatch ${FILESDIR}/${P/.0_rc?/_beta1}-bdb-fPIC.patch
	fi
}
