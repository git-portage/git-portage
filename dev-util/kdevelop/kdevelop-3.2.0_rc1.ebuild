...
# $Header: /var/cvsroot/gentoo-x86/dev-util/kdevelop/Attic/kdevelop-3.2.0_rc1.ebuild,v 1.2 2005/02/28 22:17:15 greg_g Exp $
...
SRC_URI="mirror://kde/unstable/${MY_PV/#3.2/3.4}/src/${PN}-${MY_PV}.tar.bz2"
