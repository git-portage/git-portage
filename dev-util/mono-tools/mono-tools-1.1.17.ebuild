...
# $Header: /var/cvsroot/gentoo-x86/dev-util/mono-tools/Attic/mono-tools-1.1.17.ebuild,v 1.4 2007/12/30 06:23:08 compnerd Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-1.1.17-optional-browser.patch"
