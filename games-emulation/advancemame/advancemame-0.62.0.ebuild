...
# $Header: /var/cvsroot/gentoo-x86/games-emulation/advancemame/Attic/advancemame-0.62.0.ebuild,v 1.1 2003/09/09 16:26:49 vapier Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${P}-sdl-configure.patch
