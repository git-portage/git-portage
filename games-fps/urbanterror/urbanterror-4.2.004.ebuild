...
# $Header: /var/cvsroot/gentoo-x86/games-fps/urbanterror/Attic/urbanterror-4.2.004.ebuild,v 1.1 2012/11/01 21:43:39 hasufell Exp $
...
SRC_URI="http://178.63.102.135/svens_stuff/UrbanTerror42.tar.xz -> ${PN}-4.2.003.tar.xz
	...
	mirror://gentoo/urbanterror-4.2.003-to-4.2.004-update.tar"
...
S_UPDATE=${WORKDIR}/urbanterror-4.2.003-to-4.2.004-update
