...
# $Header: /var/cvsroot/gentoo-x86/games-fps/ut2003/Attic/ut2003-2225-r1.ebuild,v 1.4 2004/03/16 19:26:41 wolf31o2 Exp $
...
src_install() {
	...
	sed -e -i "s:GENTOO_DIR:${dir}:" ${FILESDIR}/ut2003
