...
# $Header: /var/cvsroot/gentoo-x86/games-fps/warsow/Attic/warsow-1.01.ebuild,v 1.1 2012/10/11 15:39:24 hasufell Exp $
...
SRC_URI="http://funpark.warsow-esport.net/~${PN}/1.0/${PN}_1.0_unified.tar.gz
	...
	http://funpark.warsow-esport.net/~${PN}/${PV}/${MY_P}_update.tar.gz
