...
# $Header: /var/cvsroot/gentoo-x86/games-roguelike/scourge/Attic/scourge-0.14.ebuild,v 1.1 2006/06/13 16:32:25 mr_bones_ Exp $
...
SRC_URI="mirror://sourceforge/scourge/${P}.tar.gz
	mirror://sourceforge/scourge/${PN}-data-${PV}.tar.gz"
...
DEPEND="|| (
		( x11-libs/libXmu x11-libs/libXi )
		virtual/x11
		)
	sys-libs/zlib
	virtual/glu
...
src_install() {
	...
	doins -r "${WORKDIR}"/scourge_data/* || die "doins failed"
