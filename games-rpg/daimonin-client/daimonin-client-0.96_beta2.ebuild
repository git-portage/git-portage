...
# $Header: /var/cvsroot/gentoo-x86/games-rpg/daimonin-client/Attic/daimonin-client-0.96_beta2.ebuild,v 1.1 2004/06/29 23:35:50 mr_bones_ Exp $
...
SRC_URI="mirror://sourceforge/daimonin/daimonin_client_src-BETA2-${MY_PV}a.zip"
...
src_unpack() {
	unpack ${A}
	cd ${S}
	epatch "${FILESDIR}/0.96a_beta2-gentoo-paths.patch"
	cd make/linux
	chmod a+x ./configure
}
