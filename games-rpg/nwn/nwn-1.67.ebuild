...
# $Header: /var/cvsroot/gentoo-x86/games-rpg/nwn/Attic/nwn-1.67.ebuild,v 1.2 2006/06/20 15:19:06 wolf31o2 Exp $

inherit eutils games

UPDATEVER=${PV//.}
PATCH_URL_BASE=http://files.bioware.com/neverwinternights/updates/linux/${UPDATEVER}/
...
SRC_URI="http://nwdownloads.bioware.com/neverwinternights/linux/129/nwclient129.tar.gz
	...
	linguas_it? (
		...
		http://nwdownloads.bioware.com/neverwinternights/linux/129/nwitalian129.tar.gz )
	linguas_es? (
		${PATCH_URL_BASE}Spanish${PACKAGE_NAME}
		${DIALOG_URL_BASE}/spanish/NWNSpanish${PV}dialog.zip
		http://nwdownloads.bioware.com/neverwinternights/linux/129/nwspanish129.tar.gz )
	linguas_de? (
	${PATCH_URL_BASE}German${PACKAGE_NAME}
	${DIALOG_URL_BASE}/german/NWNGerman${PV}dialog.zip
	http://xfer06.fileplanet.com/%5E389272944/082003/nwgerman129.tar.gz )
