...
# $Header: /var/cvsroot/gentoo-x86/games-simulation/flightgear/Attic/flightgear-0.9.4.ebuild,v 1.11 2005/08/23 19:07:03 wolf31o2 Exp $
...
src_install() {
	...
	cp -dpR data/* "${D}/${GAMES_LIBDIR}/${MY_PN}" || die "cp failed"
