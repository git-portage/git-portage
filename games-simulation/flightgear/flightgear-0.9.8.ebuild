...
# $Header: /var/cvsroot/gentoo-x86/games-simulation/flightgear/Attic/flightgear-0.9.8.ebuild,v 1.6 2005/08/23 19:07:03 wolf31o2 Exp $
...
src_install() {
	...
	cp -dpR data/* "${D}/${GAMES_DATADIR}/${MY_PN}" || die "cp failed"
