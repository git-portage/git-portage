...
# $Header: /var/cvsroot/gentoo-x86/games-simulation/openttd/Attic/openttd-0.3.6-r1.ebuild,v 1.3 2005/05/16 15:09:34 dholm Exp $
...
src_install() {
	...
	doins scripts/* || die "doins failed (scripts)"
