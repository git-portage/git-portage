...
# $Header: /var/cvsroot/gentoo-x86/games-sports/ultimatestunts/Attic/ultimatestunts-0.7.5.ebuild,v 1.2 2008/11/20 05:18:00 mr_bones_ Exp $
...
pkg_setup() {
	...
	if ! built_with_use media-libs/openal --missing true vorbis ; then
