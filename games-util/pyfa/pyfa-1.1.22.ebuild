...
# $Header: /var/cvsroot/gentoo-x86/games-util/pyfa/Attic/pyfa-1.1.22.ebuild,v 1.1 2014/03/17 01:08:46 tetromino Exp $
...
if [[ ${PV} = 9999 ]]; then
	...
	SRC_URI="https://github.com/DarkFenX/Pyfa/releases/download/v${PV}/${P}-rubicon-1.3-src.zip"
