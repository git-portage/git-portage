...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-core/Attic/gnome-core-1.3.1.ebuild,v 1.2 2001/03/06 06:05:34 achim Exp $
...
DEPEND="gtkhtml? ( >=gnome-base/gtkhtml-0.7 )
...
src_unpack() {
  unpack ${A}
  cd ${S}
  patch -p0 < ${FILESDIR}/${P}-help-browser-Makefile.in-gentoo.diff
}
