...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-panel/Attic/gnome-panel-2.4.0.ebuild,v 1.1 2003/09/11 03:38:38 spider Exp $
...
pkg_postinst() {
	...
	GCONF_CONFIG_SOURCE=`${ROOT}/usr/bin/gconftool-2 --get-default-source` ${ROOT}/usr/bin/gconftool-2 --direct --load=${S}/gnome-panel/panel-default-setup.entries
}
