...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-settings-daemon/Attic/gnome-settings-daemon-2.28.2.ebuild,v 1.1 2010/03/18 16:43:01 nirbheek Exp $
...
SRC_URI="${SRC_URI}
mirror://gentoo/${P}-gst-vol-control-support.patch.lzma"
