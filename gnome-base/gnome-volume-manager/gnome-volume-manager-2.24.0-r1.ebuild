...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-volume-manager/Attic/gnome-volume-manager-2.24.0-r1.ebuild,v 1.2 2009/01/31 09:04:29 aballier Exp $
...
src_unpack() {
	...
	# Fix consolekit DBus API use, bug #248471
