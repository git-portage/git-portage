...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/Attic/gnome-2.20.2.ebuild,v 1.2 2008/01/29 16:25:16 dang Exp $
EAPI="1"
...
RDEPEND="
	...
	>=x11-libs/libwnck-2.20.2
	>=x11-wm/metacity-2.20.1

	>=gnome-base/gnome-keyring-2.20.2
	...
	>=gnome-extra/gtkhtml-3.16.2
	>=mail-client/evolution-2.12.2
	>=gnome-extra/evolution-data-server-1.12.2
