...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/Attic/gnome-2.22.2.ebuild,v 1.5 2008/08/12 14:17:18 armin76 Exp $
EAPI="1"
...
RDEPEND="
	...
	>=gnome-extra/gnome-games-2.22.2
	>=gnome-base/librsvg-2.22.2

	>=gnome-extra/gnome-system-monitor-2.22.2
	...
	>=gnome-extra/gtkhtml-3.18.2
	>=mail-client/evolution-2.22.2
	>=gnome-extra/evolution-data-server-2.22.2
	...
	accessibility? (
		...
		>=app-accessibility/gnome-speech-0.4.19
		>=app-accessibility/gok-1.3.7
		>=app-accessibility/orca-2.22.2
		>=gnome-extra/mousetweaks-2.22.2 )
