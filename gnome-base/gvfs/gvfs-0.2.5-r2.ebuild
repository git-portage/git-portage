...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gvfs/Attic/gvfs-0.2.5-r2.ebuild,v 1.1 2008/08/20 13:03:40 remi Exp $
...
pkg_setup() {
	G2CONF="${G2CONF}
			--enable-http
			--with-bash-completion-dir=${ROOT}usr/share/bash-completion
...
src_install() {
	gnome2_src_install
	use bash-completion && \
		mv "${D}/usr/share/bash-completion/gvfs-bash-completion.sh" \
		"${D}/usr/share/bash-completion/gvfs"
}
