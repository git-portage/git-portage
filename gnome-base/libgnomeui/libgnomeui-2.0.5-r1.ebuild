...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/libgnomeui/Attic/libgnomeui-2.0.5-r1.ebuild,v 1.5 2003/03/11 21:11:45 seemant Exp $
...
src_unpack() {
	...
	cd ${S}; epatch ${FILESDIR}/${P}-GTK_TYPE_INVISIBLE.patch
}
