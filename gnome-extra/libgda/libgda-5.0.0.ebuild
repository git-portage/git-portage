...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/libgda/Attic/libgda-5.0.0.ebuild,v 1.1 2011/10/30 05:58:42 tetromino Exp $
...
pkg_setup() {
	...
	# XXX: vala bindings have build problems: https://bugzilla.gnome.org/show_bug.cgi?id=663009
	G2CONF="${G2CONF}
