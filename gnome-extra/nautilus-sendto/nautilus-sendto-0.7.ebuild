...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/nautilus-sendto/Attic/nautilus-sendto-0.7.ebuild,v 1.1 2006/07/19 04:05:02 compnerd Exp $
...
src_unpack() {
	...
	if has_version '=net-im/gaim-2*' ; then
		epatch ${FILESDIR}/${PN}-0.7-gaim-2.0-plugin.patch
	fi
