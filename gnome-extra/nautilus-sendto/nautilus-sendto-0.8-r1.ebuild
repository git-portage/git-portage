...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/nautilus-sendto/Attic/nautilus-sendto-0.8-r1.ebuild,v 1.5 2007/08/02 05:46:10 mr_bones_ Exp $
...
src_unpack() {
	...
	# Fix claws-mail support
	epatch ${FILESDIR}/${PN}-0.8-claws-mail-plugin.patch
