...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/sensors-applet/Attic/sensors-applet-1.7.1.ebuild,v 1.1 2006/07/04 01:29:41 dang Exp $
...
pkg_postinst() {
	ewarn "Config for 1.7.x is not compatible with previous versions."
	ewarn "You must remove and re-add the applet."
}
