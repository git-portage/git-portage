...
# $Header: /var/cvsroot/gentoo-x86/gnustep-base/gnustep-gui/Attic/gnustep-gui-0.9.5_pre20041116.ebuild,v 1.1 2004/11/16 23:14:30 fafhrd Exp $
...
DEPEND="${GNUSTEP_BASE_DEPEND}
	>=gnustep-base/gnustep-base-1.10.2_pre*
	virtual/x11
	>=media-libs/tiff-3*
