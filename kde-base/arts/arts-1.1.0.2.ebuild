...
# $Header: /var/cvsroot/gentoo-x86/kde-base/arts/Attic/arts-1.1.0.2.ebuild,v 1.3 2002/11/09 21:40:36 danarmak Exp $
inherit kde-base flag-o-matic

# this is the arts 1.1.0 rfom kde 3.1 rc2, as opposed to the arta 1.1.0 rfom kde 3.1 beta2

S=$WORKDIR/$PN-1.1.0
SRC_URI="http://user.cs.tu-berlin.de/~mehnert/arts-1.1.0-kde31rc2.tar.bz2"
KEYWORDS="x86"
