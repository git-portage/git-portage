...
# $Header: /var/cvsroot/gentoo-x86/kde-base/arts/Attic/arts-1.2.1.ebuild,v 1.8 2004/04/07 18:10:37 eradicator Exp $
...
SRC_URI="mirror://kde/stable/${PV/1.2.1/3.2.1}/src/${PN}-${PV}.tar.bz2"
...
LDPATH=${PREFIX}/lib
CONFIG_PROTECT=${PREFIX}/share/config" > ${D}/etc/env.d/48kdepaths-3.2.1 # number goes down with version upgrade

	echo "KDEDIR=$PREFIX" > ${D}/etc/env.d/57kdedir-3.2.1 # number goes up with version upgrade
