...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kbattleship/Attic/kbattleship-4.3.5.ebuild,v 1.2 2010/01/28 12:44:21 abcd Exp $
...
src_install() {
	...
	newins "${PN}"/src/module.dsc /usr/share/ggz/modules/"${P}".dsc
}
