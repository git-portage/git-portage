...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kde-i18n/Attic/kde-i18n-3.5.4-r1.ebuild,v 1.2 2006/11/07 23:54:36 flameeyes Exp $
...
src_unpack() {
	...
	for dir in `ls "${WORKDIR}"`; do
		...
		# work around bug 142819
		if [[ "${lang}" == "et" ]] ; then
			sed -i -e "s:kvoctrain::" ${WORKDIR}/${dir}/docs/kdeedu/Makefile.in
		fi
