...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kde-qt-addon/Attic/kde-qt-addon-1.92-r1.ebuild,v 1.3 2000/09/15 20:08:59 drobbins Exp $

P=kde-qt-addon-1.92
A=${P}.tar.bz2
S=${WORKDIR}/${P}
DESCRIPTION="KDE 2Beta - qt-addon"
