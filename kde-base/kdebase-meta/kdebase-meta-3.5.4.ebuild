...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-meta/Attic/kdebase-meta-3.5.4.ebuild,v 1.3 2006/08/01 11:05:42 flameeyes Exp $
MAXKDEVER=$PV
...
$(deprange 3.5.3 $MAXKDEVER kde-base/kmenuedit)
...
$(deprange 3.5.3 $MAXKDEVER kde-base/nsplugins)
