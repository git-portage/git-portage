...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-startkde/Attic/kdebase-startkde-3.4.0_beta1.ebuild,v 1.1 2005/01/15 02:24:30 danarmak Exp $
...
RDEPEND="$RDEPEND
$(deprange-dual $PV $MAXKDEVER kde-base/kdesktop)
$(deprange-dual $PV $MAXKDEVER kde-base/kcminit)
$(deprange-dual $PV $MAXKDEVER kde-base/ksmserver)
$(deprange-dual $PV $MAXKDEVER kde-base/kwin)
$(deprange-dual $PV $MAXKDEVER kde-base/kpersonalizer)
$(deprange-dual $PV $MAXKDEVER kde-base/kreadconfig)
$(deprange-dual $PV $MAXKDEVER kde-base/ksplashml)"
