...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase/Attic/kdebase-3.5.3-r3.ebuild,v 1.2 2006/07/09 06:01:34 flameeyes Exp $
...
PATCHES="${FILESDIR}/kdebase-startkde-3.5.3-xinitrcd.patch
	${FILESDIR}/kdesktop-3.5.3-screensaver.patch"
