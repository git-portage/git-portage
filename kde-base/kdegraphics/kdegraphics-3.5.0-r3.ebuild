...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdegraphics/Attic/kdegraphics-3.5.0-r3.ebuild,v 1.2 2005/12/17 20:41:33 corsair Exp $
...
PATCHES="${PATCHES} ${FILESDIR}/kdegraphics-3.5.0-kpovmodeler.patch"
