...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/Attic/kdelibs-2.1.ebuild,v 1.2 2001/02/28 02:00:32 drobbins Exp $

V=2.1
S=${WORKDIR}/${PN}-${V}
DESCRIPTION="KDE 2.1 - libs"
SRC_PATH="kde/stable/${V}/distribution/tar/generic/src/${PN}-${V}.tar.bz2"
