...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/Attic/kdelibs-2.2.2a.ebuild,v 1.9 2003/01/30 19:40:19 danarmak Exp $
...
# kde 2.2.2 is no longer on kde mirrors, but we still have it
SRC_URI="mirror://gentoo/kdelibs-2.2.2.tar.bz2"
...
PATCHES="$FILESDIR/$P-crosside.diff"
