...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/Attic/kdelibs-3.3.0_beta2.ebuild,v 1.1 2004/07/23 11:56:26 caleb Exp $
...
LDPATH=${PREFIX}/lib
CONFIG_PROTECT=${PREFIX}/share/config" > ${D}/etc/env.d/47kdepaths-3.3.0 # number goes down with version upgra$
