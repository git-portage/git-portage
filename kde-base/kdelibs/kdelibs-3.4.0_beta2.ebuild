...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/Attic/kdelibs-3.4.0_beta2.ebuild,v 1.3 2005/02/09 20:21:52 danarmak Exp $
...
PATCHES="$FILESDIR/$P-export-symbols-for-bindings.diff" # in upstream cvs, remove after beta2
