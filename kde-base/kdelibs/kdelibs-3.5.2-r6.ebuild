...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/Attic/kdelibs-3.5.2-r6.ebuild,v 1.17 2006/11/18 22:20:58 flameeyes Exp $
...
RDEPEND="$(qt_min_version 3.3.3)
	...
	spell? ( || (  ( app-text/aspell app-dicts/aspell-en )
	              app-text/ispell ) )
	zeroconf? (	net-misc/mDNSResponder !kde-base/kdnssd )
	virtual/fam
	virtual/ghostscript
	~kde-base/kde-env-3"
