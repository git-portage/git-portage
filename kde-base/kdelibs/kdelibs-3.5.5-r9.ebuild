...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/Attic/kdelibs-3.5.5-r9.ebuild,v 1.1 2007/03/05 22:13:45 deathwing00 Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-vulnerability-20070305.diff"
}
