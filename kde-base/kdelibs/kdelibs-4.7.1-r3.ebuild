...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/Attic/kdelibs-4.7.1-r3.ebuild,v 1.1 2011/10/03 13:29:21 dilfridge Exp $
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-4.7.1-qlabel-1.patch"
	"${FILESDIR}/${PN}-4.7.1-qlabel-2.patch"
)
