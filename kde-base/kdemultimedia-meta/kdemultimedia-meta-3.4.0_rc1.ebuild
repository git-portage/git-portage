...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdemultimedia-meta/Attic/kdemultimedia-meta-3.4.0_rc1.ebuild,v 1.1 2005/02/27 20:21:34 danarmak Exp $
MAXKDEVER=$PV
...
RDEPEND="arts? ( $(deprange 3.4.0_beta2 $MAXKDEVER kde-base/artsplugin-audiofile)
