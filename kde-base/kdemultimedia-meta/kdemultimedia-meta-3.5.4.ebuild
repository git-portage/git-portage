...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdemultimedia-meta/Attic/kdemultimedia-meta-3.5.4.ebuild,v 1.1 2006/07/25 04:47:43 flameeyes Exp $
MAXKDEVER=$PV
...
#$(deprange 3.5.3 $MAXKDEVER kde-base/artsplugin-mpg123)
#$(deprange 3.5.3 $MAXKDEVER kde-base/mpeglib)
