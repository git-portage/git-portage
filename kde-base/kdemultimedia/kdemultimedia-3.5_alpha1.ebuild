...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdemultimedia/Attic/kdemultimedia-3.5_alpha1.ebuild,v 1.2 2005/08/26 10:32:13 greg_g Exp $
...
src_unpack() {
	...
	# See kde bug 111545.
	epatch "${FILESDIR}/${P}-compile-kscd.patch"
