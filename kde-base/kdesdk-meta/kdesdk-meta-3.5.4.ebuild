...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdesdk-meta/Attic/kdesdk-meta-3.5.4.ebuild,v 1.1 2006/07/25 05:08:40 flameeyes Exp $
MAXKDEVER=$PV
...
RDEPEND="
	...
	$(deprange 3.5.3 $MAXKDEVER kde-base/kapptemplate)
	...
	$(deprange 3.5.3 $MAXKDEVER kde-base/kdesdk-misc)
	...
	$(deprange 3.5.3 $MAXKDEVER kde-base/kspy)
