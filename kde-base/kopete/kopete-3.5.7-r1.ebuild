...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kopete/Attic/kopete-3.5.7-r1.ebuild,v 1.1 2007/08/11 12:10:15 philantrop Exp $
...
src_unpack() {
	...
	# Fixes bug 187400, pwc-driven webcams broken.
	epatch "${FILESDIR}/${PN}-3.5.7-videodevice.patch"
