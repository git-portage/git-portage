...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kpdf/Attic/kpdf-3.5.3.ebuild,v 1.3 2006/06/02 00:47:15 flameeyes Exp $
...
SRC_URI="${SRC_URI}
	mirror://gentoo/${P}-poppler-bis.patch.bz2"

PATCHES="${DISTDIR}/${P}-poppler-bis.patch.bz2"
