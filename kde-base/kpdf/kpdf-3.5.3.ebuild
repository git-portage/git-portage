...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kpdf/Attic/kpdf-3.5.3.ebuild,v 1.1 2006/06/01 19:32:59 flameeyes Exp $
...
SRC_URI="${SRC_URI}
	mirror://gentoo/${PN}-3.5.2-poppler.patch.bz2"

PATCHES="${DISTDIR}/${PN}-3.5.2-poppler.patch.bz2"
