...
# $Header: /var/cvsroot/gentoo-x86/kde-base/ksysguard/Attic/ksysguard-4.0.1.ebuild,v 1.1 2008/02/07 00:11:20 philantrop Exp $
...
src_test() {
	# one out of two tests are broken. we just disable it. last tested on 4.0.1.
