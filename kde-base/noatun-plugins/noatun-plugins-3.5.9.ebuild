...
# $Header: /var/cvsroot/gentoo-x86/kde-base/noatun-plugins/Attic/noatun-plugins-3.5.9.ebuild,v 1.1 2008/02/20 23:34:11 philantrop Exp $
KMNAME=kdeaddons
EAPI="1"
...
DEPEND=">=kde-base/noatun-${PV}:${SLOT}
