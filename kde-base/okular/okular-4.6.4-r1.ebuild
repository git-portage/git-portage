...
# $Header: /var/cvsroot/gentoo-x86/kde-base/okular/Attic/okular-4.6.4-r1.ebuild,v 1.1 2011/06/15 18:35:34 dilfridge Exp $
...
SRC_URI+=" http://dev.gentoo.org/~dilfridge/distfiles/${P}-update.patch.bz2"
...
PATCHES=( "${DISTDIR}/${P}-update.patch.bz2" )
