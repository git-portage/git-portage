...
# $Header: /var/cvsroot/gentoo-x86/kde-base/system-config-printer-kde/Attic/system-config-printer-kde-4.7.3.ebuild,v 1.2 2011/12/07 12:10:16 phajdan.jr Exp $
