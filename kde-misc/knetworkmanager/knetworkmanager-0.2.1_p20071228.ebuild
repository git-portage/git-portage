...
# $Header: /var/cvsroot/gentoo-x86/kde-misc/knetworkmanager/Attic/knetworkmanager-0.2.1_p20071228.ebuild,v 1.1 2008/02/17 15:58:33 rbu Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-0.2.1-autostart.patch"
}
