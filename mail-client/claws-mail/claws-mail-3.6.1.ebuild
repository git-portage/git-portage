...
# $Header: /var/cvsroot/gentoo-x86/mail-client/claws-mail/Attic/claws-mail-3.6.1.ebuild,v 1.5 2008/11/29 18:29:25 dertobi123 Exp $
...
src_compile() {
	...
	myconf="${myconf} $(use_enable spell enchant)"
	myconf="${myconf} $(use_enable gnutls)"
	myconf="${myconf} $(use_enable ssl gnutls)"
