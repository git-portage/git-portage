...
# $Header: /var/cvsroot/gentoo-x86/mail-client/evolution/Attic/evolution-1.5.92.1.ebuild,v 1.2 2004/08/13 22:32:32 mr_bones_ Exp $
...
RDEPEND=">=gnome-extra/libgtkhtml-3.1.19
	>=gnome-extra/gal-2.1.13
	>=gnome-extra/evolution-data-server-0.0.97
