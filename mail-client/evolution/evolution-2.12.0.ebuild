...
# $Header: /var/cvsroot/gentoo-x86/mail-client/evolution/Attic/evolution-2.12.0.ebuild,v 1.2 2007/10/13 01:04:36 mr_bones_ Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${PN}-2.11.90-mail-remote-broken.patch
}
