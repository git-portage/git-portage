...
# $Header: /var/cvsroot/gentoo-x86/mail-client/evolution/Attic/evolution-2.8.0-r1.ebuild,v 1.2 2006/10/03 23:12:51 agriffis Exp $
...
src_unpack() {
	...
	# Fix non-selection after delete
	epatch ${FILESDIR}/${P}-fix-message-deletion.patch
