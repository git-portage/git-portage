...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mail-notification/Attic/mail-notification-0.6.2.ebuild,v 1.1 2004/09/09 11:21:46 ticho Exp $

inherit gnome2

DESCRIPTION="A GNOME trayicon which checks for mail supporting mbox, MH, Maildir
, IMAP, Sylpheed, POP3. Athenticates via apop, ssl, sasl."
