...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mail-notification/Attic/mail-notification-4.1-r1.ebuild,v 1.5 2007/12/05 17:37:32 armin76 Exp $
...
src_unpack() {
	...
	if [ "${EVO_VERSION}" == "2.12" ]; then
		epatch "${FILESDIR}/${P}-evo-2.12-api-change.patch"
	fi

	epatch "${FILESDIR}/${P}-find-evo-2.12.patch"
	eautoconf
}
