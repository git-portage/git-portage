...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mozilla-thunderbird-bin/Attic/mozilla-thunderbird-bin-0.7.ebuild,v 1.5 2004/07/01 19:49:11 eradicator Exp $
...
src_install() {
	...
	tar xjpf ${FILESDIR}/thunderbird-bin-${PV}-init.tar.bz2 \
		-C ${D}/opt/thunderbird
}
