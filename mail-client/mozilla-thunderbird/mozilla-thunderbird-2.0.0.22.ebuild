...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mozilla-thunderbird/Attic/mozilla-thunderbird-2.0.0.22.ebuild,v 1.1 2009/06/24 15:45:06 armin76 Exp $

WANT_AUTOCONF="2.1"

inherit flag-o-matic toolchain-funcs eutils mozconfig-2 mozilla-launcher makeedit multilib mozextension autotools

PATCH="${PN}-2.0.0.22-patches-0.1"
