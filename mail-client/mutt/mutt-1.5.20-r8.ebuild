...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mutt/Attic/mutt-1.5.20-r8.ebuild,v 1.5 2009/11/06 14:03:23 jer Exp $
...
SLOT="0"
LICENSE="GPL-2"
KEYWORDS="~alpha ~amd64 ~hppa ~ppc ~x86 ~x86-fbsd ~x64-freebsd ~x86-freebsd ~x86-interix ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-solaris"
