...
# $Header: /var/cvsroot/gentoo-x86/mail-client/thunderbird/Attic/thunderbird-24.6.0.ebuild,v 1.1 2014/06/11 21:03:50 axs Exp $
...
SRC_URI="${SRC_URI}
	...
	lightning? (
		...
		${MOZ_HTTP_URI/${PN}/calendar/lightning}/${MOZ_LIGHTNING_VER}/linux/gdata-provider.xpi -> gdata-provider-${MOZ_LIGHTNING_GDATA_VER}.xpi
	)
