...
# $Header: /var/cvsroot/gentoo-x86/mail-filter/dk-milter/Attic/dk-milter-0.4.1.ebuild,v 1.1 2006/07/15 21:54:34 langthang Exp $
...
src_install() {
	...
	newinitd "${FILESDIR}/${PN}.init" dk-filter \
		|| die "newinitd failed"
	newconfd "${FILESDIR}/${PN}.conf" dk-filter \
		|| die "newconfd failed"
}
