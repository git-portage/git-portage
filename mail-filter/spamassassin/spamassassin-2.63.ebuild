...
# $Header: /var/cvsroot/gentoo-x86/mail-filter/spamassassin/Attic/spamassassin-2.63.ebuild,v 1.2 2004/06/07 04:23:31 rac Exp $
...
DEPEND="|| ( >=dev-lang/perl-5.8.2-r1 ( >=dev-perl/ExtUtils-MakeMaker-6.11-r1 >=dev-perl/File-Spec-0.8 ) )
	dev-perl/Time-Local
