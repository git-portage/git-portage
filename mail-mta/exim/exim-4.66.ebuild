...
# $Header: /var/cvsroot/gentoo-x86/mail-mta/exim/Attic/exim-4.66.ebuild,v 1.3 2007/07/15 07:06:33 mr_bones_ Exp $

inherit eutils

IUSE="tcpd ssl postgres mysql ldap pam exiscan-acl mailwrapper lmtp ipv6 sasl dnsdb perl mbx mbox X exiscan nis syslog spf srs gnutls sqlite dovecot-sasl"
...
src_unpack() {
	...
	if use ssl; then
		epatch ${FILESDIR}/exim-4.66-openssl.patch
	fi
