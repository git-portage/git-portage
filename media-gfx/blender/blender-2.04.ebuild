...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/blender/Attic/blender-2.04.ebuild,v 1.1 2000/10/09 16:02:49 achim Exp $

A=" manual_1.5.zip"
S=${WORKDIR}/blender${PV}-linux-glibc2.1.2-i386
DESCRIPTION="Etremly fast and versatile 3D rendering package"
SRC_URI="ftp://ftp.blender.nl/pub/blender${PV}-linux-glibc2.1.2-i386.tar.gz
