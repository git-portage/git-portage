...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/blender/Attic/blender-2.32.ebuild,v 1.6 2004/04/27 21:40:49 agriffis Exp $
...
DEPEND="virtual/x11
	!amd64? ( blender-game? ( dev-games/ode ) )
...
src_unpack() {
	unpack ${A}
	epatch ${FILESDIR}/blender-2.32.patch
