...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/bootsplash/Attic/bootsplash-0.6-r7.ebuild,v 1.2 2004/02/17 23:49:19 spock Exp $
...
pkg_config() {
	...
	if [ "${KB}" == "2.4" ]; then
		...
		if [ ${KV_MINOR} -ge 3 ]; then
			bzip2 -dc ${ROOT}/usr/share/${PN}/bootsplash-3.1.3-2.6.3-r1.patch.bz2 | patch -p1 || die
		else
