...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/digikam/Attic/digikam-0.7.4.ebuild,v 1.2 2005/10/02 00:37:08 cryos Exp $
...
PATCHES="${FILESDIR}/${PN}-0.8.0_beta2-configure-fix.patch"
