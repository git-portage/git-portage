...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/digikam/Attic/digikam-0.9.0_beta1-r2.ebuild,v 1.1 2006/09/02 11:54:01 deathwing00 Exp $
...
src_unpack(){
	...
	epatch ${FILESDIR}/${P}-rate-pictures-fix.diff
}
