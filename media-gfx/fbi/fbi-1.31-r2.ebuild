...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/fbi/Attic/fbi-1.31-r2.ebuild,v 1.10 2006/02/07 20:02:32 agriffis Exp $
...
pkg_postinst() {
	einfo
	einfo "Please note that this package is DEPRECATED."
	einfo "If possible, use media-gfx/fbida instead."
	einfo
}
