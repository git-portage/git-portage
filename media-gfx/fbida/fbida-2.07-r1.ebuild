...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/fbida/Attic/fbida-2.07-r1.ebuild,v 1.2 2009/09/30 11:10:19 ssuominen Exp $
...
SRC_URI="http://dl.bytesex.org/releases/${PN}/${P}.tar.gz
	mirror://gentoo/fbida-2.07-jpeg-7.patch.bz2"
...
src_unpack() {
	...
	epatch "${WORKDIR}/fbida-2.07-jpeg-7.patch"
}
