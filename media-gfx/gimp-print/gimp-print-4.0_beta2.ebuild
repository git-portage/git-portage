...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gimp-print/Attic/gimp-print-4.0_beta2.ebuild,v 1.1 2000/10/14 11:43:23 achim Exp $

A=print-4.0b2.tar.gz
S=${WORKDIR}/print-4.0b2
