...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/imagemagick/Attic/imagemagick-5.2.4.ebuild,v 1.3 2000/11/05 11:19:34 achim Exp $
...
src_install () {
    ...
    cd ${S}
    make prefix=${D}/usr/X11R6 PREFIX=${D}/usr install
