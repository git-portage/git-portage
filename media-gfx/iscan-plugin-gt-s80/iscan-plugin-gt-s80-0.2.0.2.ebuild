...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/iscan-plugin-gt-s80/Attic/iscan-plugin-gt-s80-0.2.0.2.ebuild,v 1.1 2012/06/04 21:13:45 flameeyes Exp $
...
SRC_URI="
	x86? ( http://linux.avasys.jp/drivers/iscan-plugins/${MY_PN}/${MY_PV}/${MY_PN}-${MY_PVR}.i386.rpm )
	amd64? ( http://linux.avasys.jp/drivers/iscan-plugins/${MY_PN}/${MY_PV}/${MY_PN}-${MY_PVR}.x86_64.rpm )
"
