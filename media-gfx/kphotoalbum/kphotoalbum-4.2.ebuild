...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/kphotoalbum/Attic/kphotoalbum-4.2.ebuild,v 1.3 2013/02/09 23:42:18 dilfridge Exp $
...
DEPEND="
	...
	kipi? ( $(add_kdebase_dep libkipi) <kde-base/libkipi-4.9.50 )
	raw? ( $(add_kdebase_dep libkdcraw) <kde-base/libkdcraw-4.9.50 )
"
RDEPEND="${DEPEND}
