...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/sane-backends/Attic/sane-backends-1.0.13_pre2.ebuild,v 1.1 2003/11/11 08:48:29 phosphan Exp $
...
SRC_URI="ftp://ftp.mostang.com/pub/sane/${MY_P}.tar.gz
	ftp://ftp.mostang.com/pub/sane/old-versions/${MY_P}/${MY_P}.tar.gz"
S=${WORKDIR}/${MY_P}
SLOT="0"
