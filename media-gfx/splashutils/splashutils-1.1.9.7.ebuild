...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/splashutils/Attic/splashutils-1.1.9.7.ebuild,v 1.3 2005/07/11 14:46:21 swegener Exp $

inherit multilib linux-mod

MISCSPLASH="miscsplashutils-0.1.3"
GENTOOSPLASH="splashutils-gentoo-0.1.11"
V_KLIBC="1.0.8"
V_JPEG="6b"
V_PNG="1.2.8"
V_ZLIB="1.2.1"
