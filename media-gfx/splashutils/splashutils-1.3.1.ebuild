...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/splashutils/Attic/splashutils-1.3.1.ebuild,v 1.6 2007/04/30 22:45:13 genone Exp $

inherit eutils multilib toolchain-funcs

MISCSPLASH="miscsplashutils-0.1.5"
GENTOOSPLASH="splashutils-gentoo-0.5.4"
V_JPEG="6b"
V_PNG="1.2.8"
V_ZLIB="1.2.3"
V_FT="2.1.9"
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/${P}-boot_message-fix.patch
