...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/xv/Attic/xv-3.10a-r11.ebuild,v 1.7 2005/04/17 17:20:21 taviso Exp $
...
SRC_URI="mirror://gentoo/${P}-jumbo-patches-${JUMBOV}.tar.bz2
