...
# $Header: /var/cvsroot/gentoo-x86/media-libs/alsa-lib/Attic/alsa-lib-0.9.0_rc8-r1.ebuild,v 1.2 2003/09/06 23:59:48 msterret Exp $
...
# Hardcoding the letter "a" for now.
SRC_URI="ftp://ftp.alsa-project.org/pub/lib/${P/_rc/rc}a.tar.bz2"
