...
# $Header: /var/cvsroot/gentoo-x86/media-libs/fontconfig/Attic/fontconfig-2.1.94-r1.ebuild,v 1.2 2003/04/19 14:03:22 foser Exp $
...
src_unpack() {
	...
	epatch ${PPREFIX}-2.2-local_fontdir.patch
