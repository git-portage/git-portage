...
# $Header: /var/cvsroot/gentoo-x86/media-libs/freeverb3/Attic/freeverb3-2.5.0.ebuild,v 1.1 2010/03/20 12:33:24 sping Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/${P}-pow-ambiguity.patch
}
