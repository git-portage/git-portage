...
# $Header: /var/cvsroot/gentoo-x86/media-libs/gst-plugins/Attic/gst-plugins-0.6.1.ebuild,v 1.11 2004/03/19 07:56:03 mr_bones_ Exp $
...
RDEPEND="=media-libs/gstreamer-${PV}*
	...
	jpeg? ( x86? ( mmx? ( media-video/mjpegtools ) ) )
