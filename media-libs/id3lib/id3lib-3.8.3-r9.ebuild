...
# $Header: /var/cvsroot/gentoo-x86/media-libs/id3lib/Attic/id3lib-3.8.3-r9.ebuild,v 1.1 2013/05/03 17:33:56 jlec Exp $
...
src_prepare() {
	sed -i 's/AM_CONFIG_HEADER/AC_CONFIG_HEADERS/g' {,zlib/}configure.in || die
	AT_M4DIR="${S}/m4" autotools-utils_src_prepare
}
