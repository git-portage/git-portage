...
# $Header: /var/cvsroot/gentoo-x86/media-libs/imlib2/Attic/imlib2-1.1.0-r2.ebuild,v 1.1 2003/11/02 15:24:39 azarah Exp $

inherit enlightenment flag-o-matic gcc libtool
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/${P}-no-xfree.patch
}
