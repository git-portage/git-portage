...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libexif/Attic/libexif-0.6.12.ebuild,v 1.1 2005/03/22 19:24:23 eradicator Exp $
...
src_compile() {
	...
	LIBEXIF_AGE=2 econf $(use_enable nls) || die
	emake || die
}
