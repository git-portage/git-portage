...
# $Header: /var/cvsroot/gentoo-x86/media-libs/mesa/Attic/mesa-6.5.2_pre20061102.ebuild,v 1.3 2006/11/03 15:15:36 joshuabaergen Exp $
...
SRC_URI="http://dev.gentoo.org/~joshuabaergen/distfiles/${MY_SRC_P}.tar.bz2"
LICENSE="LGPL-2"
SLOT="0"
...
src_unpack() {
	...
	# Doesn't apply against 6.5.2 - is this still needed?
