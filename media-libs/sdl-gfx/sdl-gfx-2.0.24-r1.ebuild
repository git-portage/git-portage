...
# $Header: /var/cvsroot/gentoo-x86/media-libs/sdl-gfx/Attic/sdl-gfx-2.0.24-r1.ebuild,v 1.1 2014/04/18 21:05:20 hasufell Exp $
...
RDEPEND="media-libs/libsdl[video,${MULTILIB_USEDEP}]"
DEPEND="${RDEPEND}"
