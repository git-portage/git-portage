...
# $Header: /var/cvsroot/gentoo-x86/media-libs/xine-lib/Attic/xine-lib-1.0-r4.ebuild,v 1.1 2005/04/24 19:42:30 flameeyes Exp $
...
src_unpack() {
	...
	# Add support for WMA lossless files.
	epatch ${FILESDIR}/${P}-wma.patch
