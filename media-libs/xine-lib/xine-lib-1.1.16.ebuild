...
# $Header: /var/cvsroot/gentoo-x86/media-libs/xine-lib/Attic/xine-lib-1.1.16.ebuild,v 1.1 2009/01/08 18:47:32 aballier Exp $
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "$FILESDIR"/${PN}-1.1.15-libmpeg2-vis.patch
}
