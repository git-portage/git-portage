...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/audacious-plugins/Attic/audacious-plugins-2.3_beta1.ebuild,v 1.1 2010/02/28 15:20:02 chainsaw Exp $
...
RDEPEND="app-arch/unzip
	...
	dev-libs/libxml2
	>=media-sound/audacious-2.3_beta1
...
pkg_postinst() {
	mp3_warning
	if use alsa ; then
		ewarn "You may want to enable the hang-up workaround in the ALSA plugin if the player stops responding when you hit Stop"
		einfo "The bug is in ALSA, not Audacious: https://bugtrack.alsa-project.org/alsa-bug/bug_view_advanced_page.php?bug_id=4914"
	fi
