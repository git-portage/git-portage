...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gimp-gmic/Attic/gimp-gmic-1.5.1.0.ebuild,v 1.1 2012/03/01 22:23:11 radhermit Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/gmic-1.5.0.9-makefile.patch
}
