...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/Attic/gst-plugins-meta-0.10-r3.ebuild,v 1.5 2010/01/10 18:33:21 fauli Exp $
...
LICENSE="GPL-2"
SLOT="0.10"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ppc ~ppc64 ~sh ~sparc ~x86 ~x86-fbsd ~x86-freebsd ~amd64-linux ~x86-linux ~x86-solaris"
