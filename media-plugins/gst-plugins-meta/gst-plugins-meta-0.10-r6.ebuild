...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/Attic/gst-plugins-meta-0.10-r6.ebuild,v 1.1 2011/06/30 19:37:17 pacho Exp $
...
IUSE="aac a52 alsa dv dvb dvd esd ffmpeg flac lame mp3 mpeg musepack mythtv ogg oss pulseaudio taglib theora v4l2 vcd vorbis vpx wavpack X xv"
