...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/kipi-plugins/Attic/kipi-plugins-2.6.0_rc.ebuild,v 1.1 2012/05/13 15:07:29 dilfridge Exp $
...
DEPEND="
	...
	ipod?		(
			  media-libs/libgpod
			  x11-libs/gtk+:2
	mediawiki?	( >=media-libs/libmediawiki-2.6.0_rc )
			)
