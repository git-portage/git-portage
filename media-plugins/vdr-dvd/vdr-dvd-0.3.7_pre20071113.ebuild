...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/vdr-dvd/Attic/vdr-dvd-0.3.7_pre20071113.ebuild,v 1.1 2007/11/14 04:38:32 hd_brummy Exp $
...
PATCHES="${FILESDIR}/dvd-a52drc-pre20071113.diff
		${FILESDIR}/dvdspeed-cvs-20071113.diff
