...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/vdr-osdteletext/Attic/vdr-osdteletext-0.5.1.ebuild,v 1.3 2006/07/04 14:14:52 hd_brummy Exp ${VDRPLUGIN}/vdr-${VDRPLUGIN}-0.3.1.ebuild,v 1.1 2003/05/13 09:39:19 fow0ryl Exp $
...
PATCHES="${FILESDIR}/i18n-german-fix.diff"
