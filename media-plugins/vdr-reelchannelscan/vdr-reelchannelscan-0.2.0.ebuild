...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/vdr-reelchannelscan/Attic/vdr-reelchannelscan-0.2.0.ebuild,v 1.1 2006/05/02 20:39:39 hd_brummy Exp $
...
src_unpack() {
	...
	sed -e "s:PLUGIN = channelscan:PLUGIN = reelchannelscan:" -i Makefile
	mv channelscan.c reelchannelscan.c
}
