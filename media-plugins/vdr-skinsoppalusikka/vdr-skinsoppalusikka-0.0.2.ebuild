...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/vdr-skinsoppalusikka/Attic/vdr-skinsoppalusikka-0.0.2.ebuild,v 1.1 2006/03/07 16:28:47 hd_brummy Exp $
...
src_unpack() {
	...
	has_version "<media-video/vdr-1.3.44" && epatch "${FILESDIR}/${P}.diff"
