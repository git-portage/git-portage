...
# $Header: /var/cvsroot/gentoo-x86/media-sound/alsa-utils/Attic/alsa-utils-1.0.25.ebuild,v 1.1 2012/02/03 12:31:38 chainsaw Exp $
...
pkg_postinst() {
	...
	echo
	elog "The use of a modular configuration is not recommended. Please build "
