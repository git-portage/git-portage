...
# $Header: /var/cvsroot/gentoo-x86/media-sound/audacious/Attic/audacious-1.1.0_beta2-r1.ebuild,v 1.2 2006/06/25 01:07:27 chainsaw Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/util-filesize.diff
}
