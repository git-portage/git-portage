...
# $Header: /var/cvsroot/gentoo-x86/media-sound/banshee/Attic/banshee-0.10.10-r4.ebuild,v 1.2 2006/07/03 02:21:42 metalgod Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${P}-mp4-mimetype.patch
	eautoreconf
}
