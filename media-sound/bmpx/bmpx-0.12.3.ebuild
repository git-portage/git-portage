...
# $Header: /var/cvsroot/gentoo-x86/media-sound/bmpx/Attic/bmpx-0.12.3.ebuild,v 1.1 2005/11/08 19:07:23 azarah Exp $
...
SRC_URI="http://download.berlios.de/${PN}/${MY_P}.tar.bz2
	http://bmpx.kicks-ass.net/downloads/0.12/${MY_P}.tar.bz2
