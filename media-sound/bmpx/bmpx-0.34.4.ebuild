...
# $Header: /var/cvsroot/gentoo-x86/media-sound/bmpx/Attic/bmpx-0.34.4.ebuild,v 1.1 2006/11/15 18:48:10 chutzpah Exp $
...
IUSE="aac alsa cdparanoia debug flac ffmpeg gaim hal mad musepack nls ofa ogg
	oss p2p python raptor sid theora vorbis"
...
pkg_setup() {
	...
	elif has_version '>dev-cpp/gtkmm-2.10' &&! built_with_use dev-cpp/gtkmm	accessibility; then
...
pkg_postinst() {
	...
	elog
	elog "If you selected USE flag hal make sure it is really running."
}
