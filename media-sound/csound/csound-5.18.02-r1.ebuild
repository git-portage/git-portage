...
# $Header: /var/cvsroot/gentoo-x86/media-sound/csound/Attic/csound-5.18.02-r1.ebuild,v 1.1 2012/09/15 06:11:30 radhermit Exp $
...
src_install() {
	...
	mv "${D}"/usr/bin/{extract,csound_extract}
}
