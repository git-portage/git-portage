...
# $Header: /var/cvsroot/gentoo-x86/media-sound/festival/Attic/festival-1.4.2-r1.ebuild,v 1.7 2004/01/26 08:33:09 carpaski Exp $
...
src_compile() {
	...
	if [ ${GCCPV} != "2.95.3" ] ; then
		echo "COMPILERLIBS=/usr/lib/gcc-lib/i686-pc-linux-gnu/${GCCPV}/libstdc++.a /usr/lib/gcc-lib/i686-pc-linux-gnu/${GCCPV}/libgcc_s.so.1" >> ${TOOLSDIR}/config/config
	fi
