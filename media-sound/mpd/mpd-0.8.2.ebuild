...
# $Header: /var/cvsroot/gentoo-x86/media-sound/mpd/Attic/mpd-0.8.2.ebuild,v 1.1 2003/07/31 15:44:19 tigger Exp $
...
src_compile() {
	...
	use oggvorbis \
		|| myconf="${myconf} --disable-ogg  --disable-oggtest \
			--disable-vorbistest"
	use mad \
		|| myconf="${myconf} --enable-mpd-mad --enable-mpd-id3tag"
