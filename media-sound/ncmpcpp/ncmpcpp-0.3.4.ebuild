...
# $Header: /var/cvsroot/gentoo-x86/media-sound/ncmpcpp/Attic/ncmpcpp-0.3.4.ebuild,v 1.1 2009/05/19 22:07:06 yngwin Exp $
...
pkg_postinst() {
	...
	echo
	elog "This version of ncmpcpp uses features from mpd-0.14, and optionally"
	elog "from 0.15, so we recommend you use this with >=mpd-0.14."
	echo
}
