...
# $Header: /var/cvsroot/gentoo-x86/media-sound/ncmpcpp/Attic/ncmpcpp-0.5-r1.ebuild,v 1.1 2010/01/05 02:50:48 yngwin Exp $
...
src_prepare() {
	# upstream patch for bug 299463
	epatch "${FILESDIR}"/${P}-fix-toggle-command.patch
}
