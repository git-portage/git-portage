...
# $Header: /var/cvsroot/gentoo-x86/media-sound/pianobar/Attic/pianobar-2011.11.11.ebuild,v 1.1 2011/11/12 07:28:39 radhermit Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-2011.11.09_p1-tests.patch
}
