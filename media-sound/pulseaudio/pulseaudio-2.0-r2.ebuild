...
# $Header: /var/cvsroot/gentoo-x86/media-sound/pulseaudio/Attic/pulseaudio-2.0-r2.ebuild,v 1.1 2012/07/05 14:22:12 ford_prefect Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${P}-udev-symbols.patch"
}
