...
# $Header: /var/cvsroot/gentoo-x86/media-sound/qmmp/Attic/qmmp-0.3.2-r1.ebuild,v 1.1 2010/01/18 17:19:38 hwoarang Exp $
...
RDEPEND="x11-libs/qt-gui:4
	...
	projectm? ( >=media-libs/libprojectm-2.0.1 )
...
PATCHES=(
	"${FILESDIR}"/${P}-kio-file-path-fix.patch
)
