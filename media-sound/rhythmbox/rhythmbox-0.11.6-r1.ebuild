...
# $Header: /var/cvsroot/gentoo-x86/media-sound/rhythmbox/Attic/rhythmbox-0.11.6-r1.ebuild,v 1.9 2009/05/22 09:14:25 ssuominen Exp $
...
RDEPEND=">=x11-libs/gtk+-2.8
	...
	taglib? ( >=media-plugins/gst-plugins-taglib-0.10.6 )
	python? (
