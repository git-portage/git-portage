...
# $Header: /var/cvsroot/gentoo-x86/media-sound/rhythmbox/Attic/rhythmbox-0.4.0-r1.ebuild,v 1.2 2003/02/13 13:18:09 vapier Exp $
...
src_unpack() {
	...
	# Fix crash if LANG not set .. bug #10946.
	cd ${S}; epatch ${FILESDIR}/${P}-locale-crash.patch
}
