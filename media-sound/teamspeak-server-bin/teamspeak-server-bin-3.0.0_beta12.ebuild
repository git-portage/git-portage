...
# $Header: /var/cvsroot/gentoo-x86/media-sound/teamspeak-server-bin/Attic/teamspeak-server-bin-3.0.0_beta12.ebuild,v 1.1 2010/01/03 16:11:27 trapni Exp $
...
SRC_URI="
	amd64? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-12/teamspeak3-server_linux-amd64-${PV/_/-}.tar.gz )
	x86? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-12/teamspeak3-server_linux-x86-${PV/_/-}.tar.gz )
"
