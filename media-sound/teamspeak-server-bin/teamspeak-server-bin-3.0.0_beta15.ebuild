...
# $Header: /var/cvsroot/gentoo-x86/media-sound/teamspeak-server-bin/Attic/teamspeak-server-bin-3.0.0_beta15.ebuild,v 1.1 2010/01/20 08:02:57 trapni Exp $
...
SRC_URI="
	amd64? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-15/teamspeak3-server_linux-amd64-${PV/_/-}.tar.gz )
	x86? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-15/teamspeak3-server_linux-x86-${PV/_/-}.tar.gz )
"
