...
# $Header: /var/cvsroot/gentoo-x86/media-sound/yammi/Attic/yammi-1.0-r1.ebuild,v 1.6 2005/05/28 18:47:01 luckyduck Exp $
...
DEPEND=">=x11-libs/qt-3.1.0-r1
	...
	ogg? ( >=media-libs/libvorbis-1.0-r1 >=media-sound/vorbis-tools-1.0-r1 )
...
src_compile() {
	...
	then
		...
		use ogg || myconf="--disable-oggvorbis ${myconf}"
	fi
