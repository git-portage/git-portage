...
# $Header: /var/cvsroot/gentoo-x86/media-tv/gentoo-vdr-scripts/Attic/gentoo-vdr-scripts-0.3.10.ebuild,v 1.2 2007/07/13 05:03:57 mr_bones_ Exp $
...
pkg_preinst() {
	...
	if [[ ${PLUGINS_NEW} > 0 ]]; then
		...
		einfo "Smart updating /etc/conf.d/vdr.plugins from /etc/conf.d/vdr"
		local PLUGIN
