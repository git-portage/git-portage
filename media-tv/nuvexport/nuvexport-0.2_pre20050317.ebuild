...
# $Header: /var/cvsroot/gentoo-x86/media-tv/nuvexport/Attic/nuvexport-0.2_pre20050317.ebuild,v 1.2 2005/03/26 08:50:21 cardoe Exp $

S=${WORKDIR}/nuvexport-0.2
DESCRIPTION="Export from mythtv recorded NuppelVideo files"
HOMEPAGE="http://www.forevermore.net/mythtv/"
SRC_URI="http://www.forevermore.net/files/nuvexport/nuvexport-0.2-0.20050317.cvs.tar.bz2
	http://www.forevermore.net/files/nuvexport/archive/nuvexport-0.2-0.20050317.cvs.tar.bz2"
LICENSE="as-is"
SLOT="0"
