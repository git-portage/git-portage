...
# $Header: /var/cvsroot/gentoo-x86/media-video/avifile/Attic/avifile-0.6.0.20010503-r1.ebuild,v 1.2 2001/10/07 08:05:06 danarmak Exp $
...
DEPEND="virtual/glibc qt? ( >=x11-libs/qt-x11-2.3.1-r1 ) >=media-libs/libsdl-1.1.5  app-arch/unzip"
