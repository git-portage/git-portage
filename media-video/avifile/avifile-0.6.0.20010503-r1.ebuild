...
# $Header: /var/cvsroot/gentoo-x86/media-video/avifile/Attic/avifile-0.6.0.20010503-r1.ebuild,v 1.3 2001/12/29 17:41:37 danarmak Exp $
...
DEPEND="virtual/glibc qt? ( >=x11-libs/qt-2.3.1-r1 ) >=media-libs/libsdl-1.1.5  app-arch/unzip"
