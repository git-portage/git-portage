...
# $Header: /var/cvsroot/gentoo-x86/media-video/dvdstyler/Attic/dvdstyler-1.3_beta.ebuild,v 1.1 2004/11/21 10:26:16 dragonheart Exp $
...
src_unpack() {
	unpack ${A}
	epatch ${FILESDIR}/${PV}-code.patch || die "patch failed"
}
