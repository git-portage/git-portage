...
# $Header: /var/cvsroot/gentoo-x86/media-video/em8300-libraries/Attic/em8300-libraries-0.15.2.ebuild,v 1.1 2005/11/24 23:48:55 arj Exp $
...
src_install () {
	...
	make DESTDIR=${D} em8300incdir=${D}/usr/include/linux/ \
		prefix=${D}/usr \
		datadir=${D}/usr/share \
		sysconfdir=/etc \
