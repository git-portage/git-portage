...
# $Header: /var/cvsroot/gentoo-x86/media-video/em8300-modules/Attic/em8300-modules-0.16.2.ebuild,v 1.4 2007/11/27 12:25:13 zzam Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-kernel-2.6.23.patch"
}
