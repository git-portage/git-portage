...
# $Header: /var/cvsroot/gentoo-x86/media-video/em84xx-modules/Attic/em84xx-modules-0.2.1-r1.ebuild,v 1.2 2007/11/27 12:18:27 zzam Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-kernel-2.6.22.diff"
}
