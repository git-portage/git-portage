...
# $Header: /var/cvsroot/gentoo-x86/media-video/gpac/Attic/gpac-0.4.5.ebuild,v 1.1 2009/01/31 15:32:32 aballier Exp $
...
src_install() {
	emake OPTFLAGS="${CFLAGS}" DESTDIR="${D}" install || die
	emake OPTFLAGS="${CFLAGS}" DESTDIR="${D}" install-lib || die
