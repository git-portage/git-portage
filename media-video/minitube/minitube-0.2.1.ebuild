...
# $Header: /var/cvsroot/gentoo-x86/media-video/minitube/Attic/minitube-0.2.1.ebuild,v 1.3 2009/06/15 14:28:00 hwoarang Exp $
...
DEPEND="x11-libs/qt-gui:4[accessibility] || ( media-sound/phonon[gstreamer] x11-libs/qt-phonon:4 )"
RDEPEND="${DEPEND}"
PATCHES=(
