...
# $Header: /var/cvsroot/gentoo-x86/media-video/mjpegtools/Attic/mjpegtools-1.5.20011611-r2.ebuild,v 1.2 2002/05/23 06:50:14 seemant Exp $
...
DEPEND="${RDEPEND}
	quicktime? ( >=media-libs/libpng-1.2.1 )
