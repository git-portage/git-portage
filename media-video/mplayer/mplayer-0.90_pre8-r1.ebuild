...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/Attic/mplayer-0.90_pre8-r1.ebuild,v 1.1 2002/10/12 19:38:42 azarah Exp $
...
src_unpack() {
	...
	# Fix linking bug when USE="-oss" (and "TV" enabled by configure)
	# Bug #8604.
	cd ${S}; patch -p1 < ${FILESDIR}/${P}-no-oss.patch || die
}
