...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/Attic/mplayer-1.0_pre5-r3.ebuild,v 1.10 2004/10/17 00:21:47 chriswhite Exp $
...
RDEPEND="xvid? ( >=media-libs/xvid-0.9.0 )
	...
	!mips? ( !hppa? ( !ia64? ( !alpha? ( jack? ( >=media-libs/bio2jack-0.3-r1 ) ) ) ) )
...
src_unpack() {
	...
	#Fix for the altivec softscaler issues
