...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/Attic/mplayer-1.0_pre5-r3.ebuild,v 1.16 2005/01/05 23:24:19 chriswhite Exp $
...
RDEPEND="xvid? ( >=media-libs/xvid-0.9.0 )
	...
	!mips? ( !hppa? ( jack? ( >=media-libs/bio2jack-0.3-r1 ) ) )
