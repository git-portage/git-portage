...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/Attic/mplayer-1.0_pre5-r3.ebuild,v 1.13 2004/11/09 15:07:49 chriswhite Exp $
...
RDEPEND="xvid? ( >=media-libs/xvid-0.9.0 )
	...
	!mips? ( !hppa? ( !ia64? ( jack? ( >=media-libs/bio2jack-0.3-r1 ) ) ) )
