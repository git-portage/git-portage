...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/Attic/mplayer-1.0_rc2_p20090731.ebuild,v 1.19 2009/10/26 23:54:15 ssuominen Exp $
...
mmxext mng +mp2 +mp3 nas +network openal +opengl +osdmenu
...
src_configure() {
	...
	use lirc || myconf="${myconf} --disable-lirc --disable-lircc \
		--disable-apple-ir"
	# Enabled in -r1 for keywording issues
	myconf="${myconf} --disable-libnut"
