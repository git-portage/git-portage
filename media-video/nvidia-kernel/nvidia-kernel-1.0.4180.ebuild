...
# $Header: /var/cvsroot/gentoo-x86/media-video/nvidia-kernel/Attic/nvidia-kernel-1.0.4180.ebuild,v 1.1 2003/07/18 21:43:03 tester Exp $
...
LICENSE="NVIDIA"
SLOT="${KV}"
KEYWORDS="amd64 -x86 -ppc -sparc -alpha -hppa -mips -arm"
