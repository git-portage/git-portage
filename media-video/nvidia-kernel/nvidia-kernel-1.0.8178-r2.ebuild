...
# $Header: /var/cvsroot/gentoo-x86/media-video/nvidia-kernel/Attic/nvidia-kernel-1.0.8178-r2.ebuild,v 1.1 2006/01/12 14:24:24 augustus Exp $
...
src_unpack() {
	...
	epatch ${NV_PATCH_PREFIX}-U011106.diff
