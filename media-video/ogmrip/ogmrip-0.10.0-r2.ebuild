...
# $Header: /var/cvsroot/gentoo-x86/media-video/ogmrip/Attic/ogmrip-0.10.0-r2.ebuild,v 1.1 2006/12/19 14:12:23 beandog Exp $

inherit gnome2 eutils autotools gnome2-utils
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-mp3-quality.patch"
	epatch "${FILESDIR}/${P}-x264-suboptions.patch"
	eautoreconf
}
