...
# $Header: /var/cvsroot/gentoo-x86/media-video/totem/Attic/totem-1.0.ebuild,v 1.3 2005/05/02 20:24:01 gustavoz Exp $
...
RDEPEND=">=dev-libs/glib-2.6.3
	...
	lirc? ( app-misc/lirc )
	!sparc? ( xine? ( >=media-libs/xine-lib-1_rc7
			>=gnome-base/gconf-2 ) )
	!xine? ( >=media-libs/gstreamer-0.8.9
