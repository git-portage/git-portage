...
# $Header: /var/cvsroot/gentoo-x86/media-video/vcdimager/Attic/vcdimager-0.7.17.ebuild,v 1.5 2005/01/09 00:50:12 luckyduck Exp $

IUSE="xml2"

DESCRIPTION="GNU VCDimager"
S=${WORKDIR}/${PN}-${PV}-cdio
SRC_URI="http://savannah.nongnu.org/download/libcdio/libcdio.pkg/0.62/${PN}-${PV}-cdio.tar.gz"
