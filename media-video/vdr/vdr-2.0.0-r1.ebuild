...
# $Header: /var/cvsroot/gentoo-x86/media-video/vdr/Attic/vdr-2.0.0-r1.ebuild,v 1.1 2013/04/06 15:13:39 hd_brummy Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-fixkeeptracksinit.diff"
