...
# $Header: /var/cvsroot/gentoo-x86/media-video/x264-encoder/Attic/x264-encoder-0.0.20100118.ebuild,v 1.1 2010/01/19 11:39:50 aballier Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-nostrip.patch \
		"${FILESDIR}"/${PN}-nolib-20100118.patch
}
