...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/argus/Attic/argus-3.0.3.8.ebuild,v 1.4 2010/10/10 11:03:39 hwoarang Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/argus-3.0.3.8-autoconf-2.65.patch"
	eautoreconf
}
