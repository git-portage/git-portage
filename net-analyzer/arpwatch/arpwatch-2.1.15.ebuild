...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/arpwatch/Attic/arpwatch-2.1.15.ebuild,v 1.1 2006/09/11 13:53:03 pva Exp $
...
SRC_URI="ftp://ftp.ee.lbl.gov/${MY_P}.tar.gz
	mirror://gentoo/${P}-debian-and-redhat-patchset.diff.bz2"
...
#	gzip -dc "${DISTDIR}"/${P}.diff.gz | patch -s
	...
	epatch "${WORKDIR}"/${P}-debian-and-redhat-patchset.diff
}
...
src_install () {
	...
	doexe arp2ethers arpfetch bihourly.sh massagevendor massagevendor-old
