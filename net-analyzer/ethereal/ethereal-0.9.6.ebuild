...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/ethereal/Attic/ethereal-0.9.6.ebuild,v 1.6 2002/12/10 21:19:30 mholzer Exp $

IUSE="X ipv6 snmp ssl"

S=${WORKDIR}/${P}
DESCRIPTION="A commercial-quality network protocol analyzer"
SRC_URI="http://www.ethereal.com/distribution/old-versions/${P}.tar.gz"
