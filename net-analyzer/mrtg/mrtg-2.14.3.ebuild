...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/mrtg/Attic/mrtg-2.14.3.ebuild,v 1.1 2006/05/11 12:48:18 dragonheart Exp $

DESCRIPTION="A tool to monitor the traffic load on network-links"
HOMEPAGE="http://http://oss.oetiker.ch/mrtg/"
