...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/netcat6/Attic/netcat6-1.0-r1.ebuild,v 1.3 2009/03/01 09:43:11 dev-zero Exp $
...
DEPEND="bluetooth? ( || ( net-wireless/bluez-libs net-wireless/bluez ) )"
RDEPEND="${DEPEND}"
