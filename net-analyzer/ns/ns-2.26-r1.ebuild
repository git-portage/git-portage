...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/ns/Attic/ns-2.26-r1.ebuild,v 1.2 2004/05/17 16:09:49 usata Exp $
...
DEPEND="doc? ( virtual/tetex app-text/ghostscript dev-tex/latex2html ) ${DEPEND_COMMON}"
# for later
