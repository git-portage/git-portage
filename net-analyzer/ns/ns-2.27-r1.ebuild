...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/ns/Attic/ns-2.27-r1.ebuild,v 1.9 2006/01/29 20:24:16 cryos Exp $
...
DEPEND_COMMON=">=dev-lang/tcl-8.4.4
		...
		virtual/libpcap
		debug? ( =dev-lang/perl-5* >=sci-visualization/xgraph-12.1 >=dev-libs/dmalloc-4.8.2 >=dev-tcltk/tcl-debug-2.0 )"
