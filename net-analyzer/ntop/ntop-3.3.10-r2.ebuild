...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/ntop/Attic/ntop-3.3.10-r2.ebuild,v 1.5 2010/01/22 18:37:17 armin76 Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-CVE-2009-2732.patch
}
