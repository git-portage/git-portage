...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/rrdtool/Attic/rrdtool-1.2.28-r2.ebuild,v 1.1 2008/11/08 07:57:13 pva Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-fix-empty-font.patch"
}
