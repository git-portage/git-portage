...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/snort/Attic/snort-2.4.4-r1.ebuild,v 1.2 2006/06/06 15:58:32 jokey Exp $
...
src_unpack() {
	...
	# security bug #135112
	epatch ${FILESDIR}/snort-2.4.4-demarc-patch.diff
