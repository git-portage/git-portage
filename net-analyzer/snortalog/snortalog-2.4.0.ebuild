...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/snortalog/Attic/snortalog-2.4.0.ebuild,v 1.12 2014/07/17 12:56:43 jer Exp $
...
SRC_URI="
	${HOMEPAGE}${MY_P}.tgz
	tk? ( https://dev.gentoo.org/~jer/${P}-fix-gui.diff.bz2 )
"
LICENSE="GPL-2"
SLOT="0"
...
src_prepare() {
	...
	if use tk ; then
		epatch "${DISTDIR}"/${P}-fix-gui.diff.bz2
	else
