...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/wireshark/Attic/wireshark-1.6.6.ebuild,v 1.5 2012/04/10 20:07:18 nativemad Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/${P}-gtk-pcap.patch
}
