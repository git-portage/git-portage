...
# $Header: /var/cvsroot/gentoo-x86/net-dialup/freeradius/Attic/freeradius-0.9.3.ebuild,v 1.2 2003/11/22 03:47:56 mr_bones_ Exp $
...
src_install() {
	...
	dodir /etc/init.d
	cp ${FILESDIR}/radiusd.init ${D}/etc/init.d/radiusd

	dodir /etc/conf.d
	cp ${FILESDIR}/radiusd.conf ${D}/etc/conf.d/radiusd
