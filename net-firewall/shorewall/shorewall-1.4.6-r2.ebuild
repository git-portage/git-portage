...
# $Header: /var/cvsroot/gentoo-x86/net-firewall/shorewall/Attic/shorewall-1.4.6-r2.ebuild,v 1.1 2003/08/06 17:53:34 mholzer Exp $

S=${WORKDIR}/${P}b
DESCRIPTION="Full state iptables firewall"
SRC_URI="mirror://sourceforge/${PN}/${P}b.tgz"
