...
# $Header: /var/cvsroot/gentoo-x86/net-firewall/shorewall6-lite/Attic/shorewall6-lite-4.2.4.1.ebuild,v 1.1 2009/01/22 08:44:06 pva Exp $
...
DEPEND=">=net-firewall/iptables-1.2.0
	sys-apps/iproute2"
RDEPEND="${DEPEND}"
