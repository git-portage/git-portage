...
# $Header: /var/cvsroot/gentoo-x86/net-fs/davfs2/Attic/davfs2-1.0.2_p20060820-r1.ebuild,v 1.1 2006/09/22 19:48:47 genstef Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/davfs2-cvs1.0.2-badpointer.patch
}
...
pkg_postinst() {
	...
	ewarn "This is a cvs version - please report bugs upstream"
}
