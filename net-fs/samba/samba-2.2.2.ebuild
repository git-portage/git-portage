...
# $Header: /var/cvsroot/gentoo-x86/net-fs/samba/Attic/samba-2.2.2.ebuild,v 1.1 2001/10/17 06:02:52 woodchip Exp $
...
src_install() { 
	...
	exeinto /etc/rc.d/init.d ; newexe ${FILESDIR}/samba.rc5 samba
}
