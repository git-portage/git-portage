...
# $Header: /var/cvsroot/gentoo-x86/net-fs/samba/Attic/samba-3.0.7-r1.ebuild,v 1.2 2004/09/23 04:24:35 vapier Exp $
...
RESTRICT="nomirror" # 2004-09: smbldap-tools changed md5 (stale mirrors)
#---------------------------------------------------------------------------
