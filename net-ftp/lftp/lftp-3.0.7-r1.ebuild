...
# $Header: /var/cvsroot/gentoo-x86/net-ftp/lftp/Attic/lftp-3.0.7-r1.ebuild,v 1.1 2004/08/26 21:15:09 dragonheart Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/lftp-3.0.7-memleak.patch
}
