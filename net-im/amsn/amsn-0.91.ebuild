...
# $Header: /var/cvsroot/gentoo-x86/net-im/amsn/Attic/amsn-0.91.ebuild,v 1.1 2004/04/30 18:34:01 tester Exp $
...
src_install() {
	...
	cp -a ${S}/plugins/BWidget*  ${D}/usr/share/amsn/plugins/
	cp -a ${S}/plugins/tclzlib*  ${D}/usr/share/amsn/plugins/
