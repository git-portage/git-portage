...
# $Header: /var/cvsroot/gentoo-x86/net-im/gaim/Attic/gaim-0.71-r2.ebuild,v 1.3 2003/11/01 08:08:08 lostlogic Exp $
...
src_unpack() {
	unpack ${A} || die
	cd ${S}
	epatch ${FILESDIR}/gaim-0.71-jabber-strip.patch
	epatch ${FILESDIR}/gaim-0.71-ipv6.patch
	epatch ${FILESDIR}/gaim-0.71-icq-crash-hack.patch
	use ssl && {
		cd ${S}/plugins
