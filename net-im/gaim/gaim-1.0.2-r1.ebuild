...
# $Header: /var/cvsroot/gentoo-x86/net-im/gaim/Attic/gaim-1.0.2-r1.ebuild,v 1.2 2004/11/13 02:29:22 rizzo Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/gaim-1.0.3cvs-ircbuddylist.patch
}
