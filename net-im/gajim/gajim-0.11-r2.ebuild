...
# $Header: /var/cvsroot/gentoo-x86/net-im/gajim/Attic/gajim-0.11-r2.ebuild,v 1.1 2007/01/05 23:26:14 welp Exp $
...
pkg_setup() {
	...
	if use avahi; then
		if !built_with_use net-dns/avahi dbus gtk python; then
			...
			die "Please enable the correct USE flags for avahi"
		fi
	fi
}
