...
# $Header: /var/cvsroot/gentoo-x86/net-im/jabber-server/Attic/jabber-server-1.4.2-r2.ebuild,v 1.15 2002/11/16 15:20:40 verwilst Exp $
...
src_install() {
	...
	mkdir -p ${D}/var/run
	if [ "${COMPILER}" = "gcc3" ]; then
                cp ${S}/icqv7-t-${ICQv7}/jabberd/icqv7t.so ${D}/usr/lib/jabber/
        fi
