...
# $Header: /var/cvsroot/gentoo-x86/net-im/jabberd/Attic/jabberd-2.0_p20050119.ebuild,v 1.2 2005/03/12 11:26:45 wschlich Exp $

inherit eutils flag-o-matic

DESCRIPTION="Open Source Jabber Server"
HOMEPAGE="http://www.jabber.org"
SRC_URI="http://www.marquard.net/jabber/files/${P/_p/cvs}.tar.gz"
MY_P="${PN}-2.0cvs"
S="${WORKDIR}/${MY_P}"
...
#	exeinto /etc/init.d; newexe ${FILESDIR}/jabber.init.gentoo jabber
	exeinto /etc/jabberd; doexe ${FILESDIR}/self-cert.sh
	# directories
