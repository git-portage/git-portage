...
# $Header: /var/cvsroot/gentoo-x86/net-im/kadu/Attic/kadu-0.6.5.1.ebuild,v 1.4 2009/05/23 10:45:21 gentoofan23 Exp $
...
SLOT="0"
IUSE="alsa amarok amarok2 ao audacious bmpx config_wizard dragonplayer oss sms spell +ssl vlc voice"
...
PATCHES=(
	...
	"${FILESDIR}/${P}-fix-qt4.5-encoding.patch"
)
