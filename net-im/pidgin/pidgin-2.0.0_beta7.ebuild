...
# $Header: /var/cvsroot/gentoo-x86/net-im/pidgin/Attic/pidgin-2.0.0_beta7.ebuild,v 1.4 2007/05/04 08:53:40 drizzt Exp $
...
print_pidgin_warning() {
	ewarn
	ewarn "While previous betas in the 2.0.0 series have been extremely"
	ewarn "stable, and we recommended their use, this release is actually"
	ewarn "of beta quality. This is our first release to reflect the name"
	ewarn "change from Gaim to Pidgin, and so there are a lot of fairly "
	ewarn "significant changes here, which we'd like to see have broader "
	ewarn "testing before declaring it ready for release."
	ewarn
