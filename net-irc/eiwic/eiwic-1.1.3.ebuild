...
# $Header: /var/cvsroot/gentoo-x86/net-irc/eiwic/Attic/eiwic-1.1.3.ebuild,v 1.1 2007/05/31 21:44:39 angelos Exp $
...
src_unpack() {
	...
	sed -i "/^set MODULE_PATH/s:modules:/usr/$(get_libdir)/modules:" sample.conf
