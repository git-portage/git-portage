...
# $Header: /var/cvsroot/gentoo-x86/net-irc/xchat/Attic/xchat-1.8.2.ebuild,v 1.1 2001/07/30 23:45:09 hallski Exp $
...
src_compile() {
  ...
  then
	...
	myopts="--enable-gtkfe --disable-gnome --prefix=/usr/X11R6 --disable-gdk-pixbuf --disable-zvt"
  fi
  if [ "`use ssl`" ] ; then
