...
# $Header: /var/cvsroot/gentoo-x86/net-irc/xchat/Attic/xchat-2.6.4.ebuild,v 1.3 2006/07/13 17:02:10 agriffis Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-fix-cursor.patch
	epatch "${FILESDIR}"/${P}-fix-proxy.patch
