...
# $Header: /var/cvsroot/gentoo-x86/net-libs/clinkcc/Attic/clinkcc-1.7.1.ebuild,v 1.2 2009/07/20 14:02:34 volkmar Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-glibc-2.10.patch # bug 277735
