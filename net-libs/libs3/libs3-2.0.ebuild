...
# $Header: /var/cvsroot/gentoo-x86/net-libs/libs3/Attic/libs3-2.0.ebuild,v 1.1 2011/10/31 02:36:11 weaver Exp $
...
src_prepare() {
	sed -i -e 's/CFLAGS :=/CFLAGS +=/' -e 's/-Werror//' *makefile || diea
}
