...
# $Header: /var/cvsroot/gentoo-x86/net-mail/courier-imap/Attic/courier-imap-3.0.4-r1.ebuild,v 1.2 2004/06/10 20:52:55 agriffis Exp $
...
src_install() {
	...
	doins ${FILESDIR}/authdaemond.conf-3.0.4-r1
