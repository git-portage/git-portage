...
# $Header: /var/cvsroot/gentoo-x86/net-mail/dovecot/Attic/dovecot-2.2.8.ebuild,v 1.1 2013/11/21 16:07:40 eras Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${P}-sieve.patch"
	epatch "${FILESDIR}/${P}-mail-headers.patch"
}
