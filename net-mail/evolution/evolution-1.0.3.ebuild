...
# $Header: /var/cvsroot/gentoo-x86/net-mail/evolution/Attic/evolution-1.0.3.ebuild,v 1.1 2002/03/29 10:11:57 spider Exp $
...
src_compile() {
	...
	use perl && myconf="${myconf} --enable-gtk-doc" || myconf="${myconf} --disable-gtk-doc"
...
src_install() {
	...
	dodoc AUTHORS COPYING* ChangeLog HACKING INSTALL MAINTAINERS
	dodoc NEWS README
}
