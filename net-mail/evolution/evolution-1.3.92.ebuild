...
# $Header: /var/cvsroot/gentoo-x86/net-mail/evolution/Attic/evolution-1.3.92.ebuild,v 1.2 2003/06/06 23:58:22 rphillips Exp $
...
# NOTE: Release notes specify these can't be parallel installed with 1.2,
#       but in fact that can.
SLOT="2" 
...
RDEPEND=">=gnome-extra/libgtkhtml-3.0.4
    >=gnome-extra/gal-1.99.6
    >=net-libs/libsoup-1.99.22
...
pkg_setup() {
    ...
    ewarn "http://developer.ximian.com/projects/evolution/release_notes/1.3.92.html"
	sleep 5
...
src_install() {
	...
	# remove symlink to allow parallel installations
