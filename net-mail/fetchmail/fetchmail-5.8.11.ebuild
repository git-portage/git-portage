...
# $Header: /var/cvsroot/gentoo-x86/net-mail/fetchmail/Attic/fetchmail-5.8.11.ebuild,v 1.3 2001/08/31 19:02:09 g2boojum Exp $
...
# need inet6-apps, which we don't yet have
#    if [ "`use ipv6`" ] ; then
