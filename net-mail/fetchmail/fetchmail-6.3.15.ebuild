...
# $Header: /var/cvsroot/gentoo-x86/net-mail/fetchmail/Attic/fetchmail-6.3.15.ebuild,v 1.2 2010/03/29 09:18:36 tove Exp $
...
pkg_postinst() {
	python_mod_optimize "$(python_get_sitedir)/fetchmailconf.py"
	...
	ewarn ""
	ewarn "Gentoo's previous fetchmail versions accepted messages with bad"
...
pkg_postrm() {
	python_mod_cleanup "$(python_get_sitedir)/fetchmailconf.py"
}
