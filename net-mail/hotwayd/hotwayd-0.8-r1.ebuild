...
# $Header: /var/cvsroot/gentoo-x86/net-mail/hotwayd/Attic/hotwayd-0.8-r1.ebuild,v 1.6 2005/01/13 15:14:51 ticho Exp $
...
src_compile() {
	...
	epatch ${FILESDIR}/${P}-headerfix.patch || die "epatch ${P}-headerfix.patch failed"
