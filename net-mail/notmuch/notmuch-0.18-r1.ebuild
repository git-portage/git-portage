...
# $Header: /var/cvsroot/gentoo-x86/net-mail/notmuch/Attic/notmuch-0.18-r1.ebuild,v 1.1 2014/05/14 13:12:03 aidecoe Exp $
...
MY_PATCHES=(
	"${FILESDIR}/${PV}-0001-emacs-install-make-sure-all-components.patch"
	"${FILESDIR}/${PV}-0002-doc-conf.py-Remove-_static-from-html_s.patch"
	"${FILESDIR}/${PV}-0003-Unset-html_static_path-in-Python-bindi.patch"
)
