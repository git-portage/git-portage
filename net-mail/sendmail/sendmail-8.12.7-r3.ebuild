...
# $Header: /var/cvsroot/gentoo-x86/net-mail/sendmail/Attic/sendmail-8.12.7-r3.ebuild,v 1.2 2003/02/13 14:39:50 vapier Exp $
...
KILL_OPTS="" # add -9 or your favorite evil SIG level

EOF
	exeinto /etc/init.d
	newexe ${FILESDIR}/sendmail-r3 sendmail
}
