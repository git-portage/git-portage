...
# $Header: /var/cvsroot/gentoo-x86/net-mail/sendmail/Attic/sendmail-8.12.7-r4.ebuild,v 1.2 2003/02/13 14:39:56 vapier Exp $
...
EOF
	exeinto /etc/init.d
	newexe ${FILESDIR}/sendmail-r4 sendmail
}
