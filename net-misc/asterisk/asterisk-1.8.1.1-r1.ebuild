...
# $Header: /var/cvsroot/gentoo-x86/net-misc/asterisk/Attic/asterisk-1.8.1.1-r1.ebuild,v 1.1 2011/01/04 17:31:53 chainsaw Exp $
...
src_install() {
	...
	mkdir -p "${D}"usr/$(get_libdir)/asterisk/modules
