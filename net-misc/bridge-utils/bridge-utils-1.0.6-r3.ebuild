...
# $Header: /var/cvsroot/gentoo-x86/net-misc/bridge-utils/Attic/bridge-utils-1.0.6-r3.ebuild,v 1.10 2008/03/30 15:24:02 vapier Exp $
...
RDEPEND="sysfs? ( >=sys-fs/sysfsutils-1.0 )"
DEPEND="${RDEPEND}
	virtual/os-headers
...
src_unpack() {
	...
	cd ${S} && WANT_AUTOCONF=2.5 eautoconf || die "Failed to run autoconf"
}
