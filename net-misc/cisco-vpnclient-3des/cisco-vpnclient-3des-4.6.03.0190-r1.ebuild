...
# $Header: /var/cvsroot/gentoo-x86/net-misc/cisco-vpnclient-3des/Attic/cisco-vpnclient-3des-4.6.03.0190-r1.ebuild,v 1.5 2005/11/14 16:29:57 wolf31o2 Exp $
...
src_unpack () {
	...
	if kernel_is 2 6 && [ ${KV_MINOR} -ge 14 ]
	then
