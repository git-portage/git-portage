...
# $Header: /var/cvsroot/gentoo-x86/net-misc/dhcpcd/Attic/dhcpcd-5.1.0.ebuild,v 1.1 2009/09/05 01:12:54 darkside Exp $
...
src_compile() {
	...
	econf --prefix= --libexecdir=/lib/dhcpcd --dbdir=/var/lib/dhcpcd ${hooks}
	emake || die
}
