...
# $Header: /var/cvsroot/gentoo-x86/net-misc/dropbox/Attic/dropbox-1.4.23.ebuild,v 1.1 2012/12/03 22:39:36 naota Exp $
...
src_unpack() {
	...
	cd "${S}"/src
	rm -vf libstdc++.so.6 libz* libssl* libbz2* libpopt.so.0 \
		libcrypto.so.0.9.8 libpng12.so.0 || die
