...
# $Header: /var/cvsroot/gentoo-x86/net-misc/hogwash/Attic/hogwash-0.1d-r2.ebuild,v 1.2 2001/10/18 19:19:33 woodchip Exp $

DESCRIPTION="An invisible, layer2 network packet scrubber based on snort"
HOMEPAGE="http://hogwash.sourceforge.net"

S=${WORKDIR}/devel
SRC_URI="http://prdownloads.sourceforge.net/hogwash/hogwash-0.1.d.tgz
