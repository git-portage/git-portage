...
# $Header: /var/cvsroot/gentoo-x86/net-misc/hogwash/Attic/hogwash-0.1d-r2.ebuild,v 1.1 2001/09/12 04:07:00 lamer Exp $
...
src_install () {
	...
	dosbin hogwash
	insinto /etc/hogwash
	doins stock.rules ${DISTDIR}/rules.2
	dodoc COPYRIGHT README ${FILESDIR}/Documentation.txt
	dodir /var/log/snort
	into /etc/init.d
	doexe ${FILESDIR}/hogwash
