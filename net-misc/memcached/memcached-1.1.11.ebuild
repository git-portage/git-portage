...
# $Header: /var/cvsroot/gentoo-x86/net-misc/memcached/Attic/memcached-1.1.11.ebuild,v 1.10 2007/11/18 15:03:03 robbat2 Exp $
...
src_install() {
	...
	newconfd "${FILESDIR}/conf" memcached

	newinitd "${FILESDIR}/init" memcached
}
