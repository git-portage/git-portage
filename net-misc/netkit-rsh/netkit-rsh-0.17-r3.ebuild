...
# $Header: /var/cvsroot/gentoo-x86/net-misc/netkit-rsh/Attic/netkit-rsh-0.17-r3.ebuild,v 1.1 2002/10/25 14:00:18 woodchip Exp $
...
DEPEND=">=sys-libs/ncurses-5.2 >=sys-libs/pam-0.72"

src_unpack() {
	unpack ${A} ; cd ${S}
	patch -p0 <${FILESDIR}/rlogind-auth.diff || die
}
