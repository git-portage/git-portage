...
# $Header: /var/cvsroot/gentoo-x86/net-misc/openntpd/Attic/openntpd-20080406-r3.ebuild,v 1.1 2013/08/25 22:01:45 ottxor Exp $
...
src_install() {
	...
	newconfd "${FILESDIR}/${PN}.conf.d-${PVR}" ntpd
