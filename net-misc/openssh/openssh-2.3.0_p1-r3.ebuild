...
# $Header: /var/cvsroot/gentoo-x86/net-misc/openssh/Attic/openssh-2.3.0_p1-r3.ebuild,v 1.3 2000/12/24 05:26:02 drobbins Exp $
...
src_install() {                               
    ...
    doexe ${FILESDIR}/sshd
	exeinto /var/supervise/sshd
	newexe ${FILESDIR}/sshd-run run
	dodir /etc/supervise
	dosym /var/supervise/sshd /etc/supervise/sshd
}
