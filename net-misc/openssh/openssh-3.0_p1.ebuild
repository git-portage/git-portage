...
# $Header: /var/cvsroot/gentoo-x86/net-misc/openssh/Attic/openssh-3.0_p1.ebuild,v 1.1 2001/11/09 04:10:42 woodchip Exp $
...
src_install() {                               
	...
	exeinto /etc/rc.d/init.d ; newexe ${FILESDIR}/sshd.rc5 sshd
}
