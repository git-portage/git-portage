...
# $Header: /var/cvsroot/gentoo-x86/net-misc/openssh/Attic/openssh-6.1_p1-r1.ebuild,v 1.2 2013/01/18 12:40:16 flameeyes Exp $
...
DEPEND="${RDEPEND}
	static? ( ${LIB_DEPEND}
		ldns? ( net-libs/ldns[ssl,static-libs(+)] )
	)
	virtual/pkgconfig
	virtual/os-headers
	sys-devel/autoconf"
