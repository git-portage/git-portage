...
# $Header: /var/cvsroot/gentoo-x86/net-misc/openvpn/Attic/openvpn-2.1_rc4-r1.ebuild,v 1.1 2007/06/29 09:17:36 uberlord Exp $

inherit autotools eutils multilib

DESCRIPTION="OpenVPN is a robust and highly flexible tunneling application compatible with many OSes."
SRC_URI="http://openvpn.net/release/${P}.tar.gz
		mirror://gentoo/${PN}-2.1-udp6.patch.bz2"
...
src_unpack() {
	...
	epatch "${WORKDIR}/${PN}"-2.1-udp6.patch
