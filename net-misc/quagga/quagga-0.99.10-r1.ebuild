...
# $Header: /var/cvsroot/gentoo-x86/net-misc/quagga/Attic/quagga-0.99.10-r1.ebuild,v 1.1 2008/06/19 22:10:17 mrness Exp $
...
src_unpack() {
	...
	if use tcpmd5 ; then
		if kernel_is lt 2 6 20 ; then
			...
			epatch "${WORKDIR}/patch/${P}-linux-2.6.20_md5sig_adapted.patch"
		fi
	fi
