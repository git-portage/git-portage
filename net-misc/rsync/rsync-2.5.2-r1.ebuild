...
# $Header: /var/cvsroot/gentoo-x86/net-misc/rsync/Attic/rsync-2.5.2-r1.ebuild,v 1.3 2002/07/11 06:30:48 drobbins Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	#This next patch fixes a remote DoS:
	#http://bugs.debian.org/128632
	cat ${FILESDIR}/rsync-gentoo-${PV}.patch | patch -p1 -l || die
