...
# $Header: /var/cvsroot/gentoo-x86/net-misc/tor/Attic/tor-0.0.9.4-r1.ebuild,v 1.1 2005/02/10 21:12:02 humpback Exp $
...
pkg_postinst() {
	...
	einfo "You must create /etc/tor/torrc, you can use the sample but must add"
	einfo "User tor, Group tor, DataDirectory   /var/lib/tor/data and"
	einfo "Log notice file /var/log/tor/tor.log"
	einfo "If you use privoxy probably it is a good idea to add:"
