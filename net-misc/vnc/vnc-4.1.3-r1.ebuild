...
# $Header: /var/cvsroot/gentoo-x86/net-misc/vnc/Attic/vnc-4.1.3-r1.ebuild,v 1.2 2009/01/18 02:15:29 mr_bones_ Exp $
...
PATCH="${PN}-4.1.2-r5-patches-0.1"

MY_P="vnc-4_1_3-unixsrc"
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${PN}-4.1.2-freebsd.patch
