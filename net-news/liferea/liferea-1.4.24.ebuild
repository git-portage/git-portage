...
# $Header: /var/cvsroot/gentoo-x86/net-news/liferea/Attic/liferea-1.4.24.ebuild,v 1.2 2009/02/14 14:41:37 dang Exp $
...
pkg_setup() {
	...
	if use xulrunner ; then
		if ! built_with_use xulrunner gnome ; then
			die "You must build xulrunner with the gnome USE flag"
		fi
