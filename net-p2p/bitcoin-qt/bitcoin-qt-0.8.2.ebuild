...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/bitcoin-qt/Attic/bitcoin-qt-0.8.2.ebuild,v 1.5 2013/09/19 17:38:57 blueness Exp $
...
src_prepare() {
	...
	# fix leveldb memenv location
	sed -i -e 's~memenv/memenv.h~memenv.h~' src/leveldb.cpp || die
