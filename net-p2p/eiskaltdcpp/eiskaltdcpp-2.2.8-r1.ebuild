...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/eiskaltdcpp/Attic/eiskaltdcpp-2.2.8-r1.ebuild,v 1.5 2013/09/04 18:53:49 pinkbyte Exp $
...
PATCHES=( "${FILESDIR}"/${P}-sr-latin.patch )
