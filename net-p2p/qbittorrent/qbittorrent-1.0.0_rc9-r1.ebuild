...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/qbittorrent/Attic/qbittorrent-1.0.0_rc9-r1.ebuild,v 1.1 2007/12/04 19:07:39 armin76 Exp $
...
DEPEND=">=net-libs/rb_libtorrent-0.13_pre1791
	$(qt4_min_version 4.2)
	>=dev-lang/python-2.3
	dev-libs/boost
	net-misc/curl
