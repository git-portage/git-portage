...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/transmission/Attic/transmission-2.50.ebuild,v 1.2 2012/03/01 23:42:33 ssuominen Exp $
...
# net-libs/libnatpmp, see src_configure() switch for temporary build problem
RDEPEND="
