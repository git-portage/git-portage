...
# $Header: /var/cvsroot/gentoo-x86/net-print/foo2zjs/Attic/foo2zjs-20061130.ebuild,v 1.1 2006/12/03 15:25:36 genstef Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/foo2zjs-Makefile-20061130.diff
	epatch ${FILESDIR}/foo2zjs-udevfwld-20061130.diff
}
