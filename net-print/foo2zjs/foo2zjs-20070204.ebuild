...
# $Header: /var/cvsroot/gentoo-x86/net-print/foo2zjs/Attic/foo2zjs-20070204.ebuild,v 1.1 2007/02/11 10:30:33 genstef Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/foo2zjs-Makefile-20070204.diff
	epatch ${FILESDIR}/foo2zjs-udevfwld-20070204.diff
}
