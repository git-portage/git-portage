...
# $Header: /var/cvsroot/gentoo-x86/net-print/hplip/Attic/hplip-3.12.9-r2.ebuild,v 1.1 2012/10/03 17:55:40 billie Exp $
...
SRC_URI="mirror://sourceforge/hplip/${P}.tar.gz
		http://dev.gentoo.org/~billie/distfiles/${P}-patches-3.tar.xz"
