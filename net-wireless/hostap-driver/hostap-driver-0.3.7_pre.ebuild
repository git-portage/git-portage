...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/hostap-driver/Attic/hostap-driver-0.3.7_pre.ebuild,v 1.1 2005/02/07 10:58:16 brix Exp $
...
SRC_URI="${SRC_URI} http://hostap.epitest.fi/releases/testing/${MY_P}.tar.gz"
LICENSE="GPL-2"
