...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/hostapd/Attic/hostapd-0.6.0.ebuild,v 1.1 2007/06/06 20:03:36 gurligebis Exp $
...
pkg_postinst() {
	...
	if use madwifi; then
		...
		einfo "the madwifi driver. You should re-emerge ${PN} after"
