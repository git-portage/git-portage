...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ipw2200/Attic/ipw2200-0.19.ebuild,v 1.1 2004/12/23 04:17:18 jbms Exp $
...
src_install() {
	...
	doins ${WORKDIR}/ipw-${FW_VERSION}-bss_ucode.fw
	doins ${WORKDIR}/ipw-${FW_VERSION}-ibss.fw
	doins ${WORKDIR}/ipw-${FW_VERSION}-ibss_ucode.fw
	...
	dosym /lib/firmware/ipw-${FW_VERSION}-bss_ucode.fw /usr/lib/hotplug/firmware/ipw-${FW_VERSION}-bss_ucode.fw
	dosym /lib/firmware/ipw-${FW_VERSION}-ibss.fw /usr/lib/hotplug/firmware/ipw-${FW_VERSION}-ibss.fw
	dosym /lib/firmware/ipw-${FW_VERSION}-ibss_ucode.fw /usr/lib/hotplug/firmware/ipw-${FW_VERSION}-ibss_ucode.fw
}
