...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ipw3945/Attic/ipw3945-0.0.74.ebuild,v 1.1 2006/04/13 21:33:19 brix Exp $
...
src_unpack() {
	...
	sed -i -e "s:^#\(CONFIG_IPW3945_MONITOR\)=.*:\1=y:" ${S}/Makefile || die
