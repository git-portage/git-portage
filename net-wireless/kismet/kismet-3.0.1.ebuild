...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/kismet/Attic/kismet-3.0.1.ebuild,v 1.6 2003/10/13 00:27:31 robbat2 Exp $
...
src_compile() {
	...
	cd ${S}/libpcap-0.7.2
	WANT_AUTOCONF_2_5=1 \
	autoconf || die "Failed to run autoconf-2.57"
