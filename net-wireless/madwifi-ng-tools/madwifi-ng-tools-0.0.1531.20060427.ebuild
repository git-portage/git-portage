...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/madwifi-ng-tools/Attic/madwifi-ng-tools-0.0.1531.20060427.ebuild,v 1.2 2006/08/05 14:09:22 dertobi123 Exp $

inherit toolchain-funcs

MY_P=${PN/-tools/}-r${PV:4:4}-${PV:9:10}
S=${WORKDIR}/${MY_P}
