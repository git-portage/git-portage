...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ndiswrapper/Attic/ndiswrapper-1.0_rc4.ebuild,v 1.1 2005/01/23 10:31:10 cardoe Exp $

inherit linux-mod eutils

DESCRIPTION="Wrapper for using Windows drivers for some wireless cards"
HOMEPAGE="http://ndiswrapper.sourceforge.net/"
SRC_URI="mirror://sourceforge/${PN}/${PN}-1.0rc4.tar.gz"
...
pkg_postinst() {
	...
	einfo "information."
	echo
	einfo "You MUST re-install your Windows drivers."
	einfo "Best way to do this is to run the following commands"
	einfo "mv /etc/ndiswrapper/{driver} /tmp"
	einfo "ndiswrapper -i /tmp/{driver}/{driver}.inf"
	ebeep
	ebeep
	ebeep
}
