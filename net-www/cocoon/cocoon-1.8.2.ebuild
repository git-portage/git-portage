...
# $Header: /var/cvsroot/gentoo-x86/net-www/cocoon/Attic/cocoon-1.8.2.ebuild,v 1.1 2001/07/10 08:32:00 achim Exp $
...
src_install() {                               
  cd ${S}
  insinto /opt/jakarta/cocoon/lib
  for i in xerces_1_2 xalan_1_2_D02 fop_0_15_0 \
	   servlet_2_2 turbine-pool
  do
     doins  lib/$i.jar
  done
  doins build/cocoon.jar
  dodir /opt/jakarta/tomcat/webapps/cocoon/repository
  insinto /opt/jakarta/tomcat/webapps/cocoon/WEB-INF
  cp -a samples ${D}/opt/jakarta/tomcat/webapps/cocoon
