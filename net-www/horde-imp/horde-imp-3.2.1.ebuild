...
# $Header: /var/cvsroot/gentoo-x86/net-www/horde-imp/Attic/horde-imp-3.2.1.ebuild,v 1.2 2003/09/06 01:54:08 msterret Exp $

DESCRIPTION="IMP ${PV} provides webmail access"
HOMEPAGE="http://www.horde.org"
P=imp-3.2.1
SRC_URI="ftp://ftp.horde.org/pub/imp/tarballs/imp-3.2.1.tar.gz"
LICENSE="GPL-2"
SLOT="1"
