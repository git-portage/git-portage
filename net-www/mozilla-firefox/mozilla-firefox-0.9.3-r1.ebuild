...
# $Header: /var/cvsroot/gentoo-x86/net-www/mozilla-firefox/Attic/mozilla-firefox-0.9.3-r1.ebuild,v 1.2 2004/08/12 20:02:26 pvdabeel Exp $
...
src_compile() {
	...
	# 0.9.3 attempts to build irc and help, neither of which works at run-time.
	myconf="${myconf} \
