...
# $Header: /var/cvsroot/gentoo-x86/net-www/mozilla-firefox/Attic/mozilla-firefox-1.0_pre-r2.ebuild,v 1.2 2004/10/02 07:06:12 brad Exp $
...
MY_PV=${PV/_pre/PR.1}
SRC_URI="http://dev.gentoo.org/~brad/firefox-${MY_PV}-source.tar.bz2"
