...
# $Header: /var/cvsroot/gentoo-x86/net-www/mozilla/Attic/mozilla-1.0_rc1-r1.ebuild,v 1.2 2002/05/01 21:15:33 azarah Exp $
...
SRC_URI="ftp://ftp.mozilla.org/pub/mozilla/releases/${PN}${MY_PV1}/src/${PN}-source-${MY_PV2}.tar.bz2"
