...
# $Header: /var/cvsroot/gentoo-x86/net-www/mozilla/Attic/mozilla-1.7_beta-r1.ebuild,v 1.1 2004/03/28 16:43:34 agriffis Exp $
...
src_install() {
	...
	cd ${S}
	dosym mozilla-launcher ${D}/usr/bin/mozilla
	insinto /etc/env.d
