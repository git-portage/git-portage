...
# $Header: /var/cvsroot/gentoo-x86/net-www/viewcvs/Attic/viewcvs-0.9.2_p20030430-r1.ebuild,v 1.1 2004/01/27 23:55:54 g2boojum Exp $
...
SRC_URI="mirror://gentoo/${PN}-${PDATE}.tar.bz2
		 mirror://gentoo/${PN}.02.metacvs.patch"
...
src_unpack() {
	unpack ${PN}-${PDATE}.tar.bz2
	patch -d ${S} -p1 < ${DISTDIR}/${PN}.02.metacvs.patch || die "patch failed"
}
