...
# $Header: /var/cvsroot/gentoo-x86/net-www/webapp-config/Attic/webapp-config-1.0.ebuild,v 1.2 2004/03/03 01:01:40 stuart Exp $
...
src_install () {
	...
	dodoc examples/phpmyadmin-2.5.4-r1.ebuild AUTHORS.txt README.txt TODO.txt
}
