...
# $Header: /var/cvsroot/gentoo-x86/rox-extra/downloadmanager/Attic/downloadmanager-0.1.2-r1.ebuild,v 1.3 2006/11/20 18:23:13 opfer Exp $
...
RDEPEND=">=rox-extra/fetch-0.1.0
	|| ( >=dev-python/dbus-python-0.71 >=sys-apps/dbus-0.3 )"
