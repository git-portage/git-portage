...
# $Header: /var/cvsroot/gentoo-x86/sci-astronomy/gasgano/Attic/gasgano-2.4.3-r1.ebuild,v 1.1 2012/12/06 22:14:57 bicatali Exp $
...
src_install() {
	...
	newdoc "${DISTDIR}"/${PDOC}.pdf user-manual.pdf
}
