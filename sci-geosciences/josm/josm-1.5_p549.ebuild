...
# $Header: /var/cvsroot/gentoo-x86/sci-geosciences/josm/Attic/josm-1.5_p549.ebuild,v 1.1 2008/02/20 00:25:16 hanno Exp $
...
SRC_URI="http://josm.openstreetmap.de/download/${MY_P}.jar
	linguas_de? ( mirror://gentoo/lang-de-20080207.jar )
...
src_install() {
	...
	use linguas_de && newins "${DISTDIR}/lang-de-20080207.jar" lang-de.jar
