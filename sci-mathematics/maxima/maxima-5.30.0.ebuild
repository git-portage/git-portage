...
# $Header: /var/cvsroot/gentoo-x86/sci-mathematics/maxima/Attic/maxima-5.30.0.ebuild,v 1.1 2013/04/20 14:50:53 grozin Exp $
...
src_install() {
	...
	# does not work with the current asdf
	#if use ecls; then
	#	cd src
	#	mkdir ./lisp-cache
	#	ecl \
