...
# $Header: /var/cvsroot/gentoo-x86/sci-mathematics/scilab/Attic/scilab-3.1.1-r1.ebuild,v 1.1 2005/09/05 07:47:23 pbienst Exp $
...
src_unpack() {
	...
	sed -i \
		-e '/^ATLAS_LAPACKBLAS\>/s,=.*,= $(ATLASDIR)/libblas.so $(ATLASDIR)/liblapack.so,' \
