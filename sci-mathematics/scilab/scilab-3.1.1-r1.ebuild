...
# $Header: /var/cvsroot/gentoo-x86/sci-mathematics/scilab/Attic/scilab-3.1.1-r1.ebuild,v 1.2 2005/09/07 11:13:01 pbienst Exp $
...
src_unpack() {
	...
	sed -i \
		-e '/^ATLAS_LAPACKBLAS\>/s,=.*,= $(ATLASDIR)/liblapack.so $(ATLASDIR)/libblas.so,' \
