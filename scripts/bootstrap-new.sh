...
# $Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.1 2005/01/26 12:33:43 wolf31o2 Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.1 2005/01/26 12:33:43 wolf31o2 Exp $"
			cvsver=${cvsver##*,v }
