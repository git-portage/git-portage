...
# $Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.6 2005/03/02 23:44:57 azarah Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.6 2005/03/02 23:44:57 azarah Exp $"
			cvsver=${cvsver##*,v }
