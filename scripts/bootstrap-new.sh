...
# $Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.2 2005/02/04 16:22:46 wolf31o2 Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.2 2005/02/04 16:22:46 wolf31o2 Exp $"
			cvsver=${cvsver##*,v }
