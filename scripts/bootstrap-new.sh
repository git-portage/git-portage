...
# $Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.4 2005/02/04 18:28:47 wolf31o2 Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.4 2005/02/04 18:28:47 wolf31o2 Exp $"
			cvsver=${cvsver##*,v }
