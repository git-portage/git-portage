...
# $Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.7 2005/03/07 19:42:54 wolf31o2 Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.7 2005/03/07 19:42:54 wolf31o2 Exp $"
			cvsver=${cvsver##*,v }
