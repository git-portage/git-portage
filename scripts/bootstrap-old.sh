...
# $Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-old.sh,v 1.1 2005/03/28 01:03:31 wolf31o2 Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /var/cvsroot/gentoo-x86/scripts/Attic/bootstrap-old.sh,v 1.1 2005/03/28 01:03:31 wolf31o2 Exp $"
			cvsver=${cvsver##*,v }
