...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/Attic/baselayout-1.11.12-r4.ebuild,v 1.10 2005/07/10 18:19:06 dostrow Exp $
...
src_unpack() {
	...
	# Ensure runscript.sh reports the net.* script when used in boot runlevel
	# fixes #91534
	epatch "${FILESDIR}"/${P}-runscript-boot.patch
	# Fix is_net_fs to work with what has been mounted, not what will be
