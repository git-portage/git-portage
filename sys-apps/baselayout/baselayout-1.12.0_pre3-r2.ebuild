...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/Attic/baselayout-1.12.0_pre3-r2.ebuild,v 1.1 2005/07/30 19:10:14 uberlord Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-${PV}-dhclient.patch"

	# Fixed iwconfig associate_order "forcepreferred" option #100799
	epatch "${FILESDIR}/${PN}-${PV}-iwconfig.patch"
