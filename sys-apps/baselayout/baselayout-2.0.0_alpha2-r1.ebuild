...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/Attic/baselayout-2.0.0_alpha2-r1.ebuild,v 1.1 2007/05/08 08:57:03 uberlord Exp $
...
src_unpack() {
	...
	# Work with different styles of kernel versions.
	epatch "${FILESDIR}/${P}"-kver.patch
