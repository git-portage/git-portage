...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/busybox/Attic/busybox-1.3.1.ebuild,v 1.7 2007/01/15 20:34:50 solar Exp $
...
src_unpack() {
	...
	for opt in LOCALE_SUPPORT TFTP FTP{GET,PUT} IPCALC TFTP HUSH \
		...
		DEBUG_CROND_OPTION FEATURE_UDHCP_DEBUG READAHEAD TASKSET
	do
