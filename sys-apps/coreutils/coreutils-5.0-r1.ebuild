...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/coreutils/Attic/coreutils-5.0-r1.ebuild,v 1.11 2003/10/29 03:14:07 pebenito Exp $
...
src_unpack() {
	...
	epatch ${WORKDIR}/${PN}-gentoo-patches/${PN}-remove-su-info.patch
