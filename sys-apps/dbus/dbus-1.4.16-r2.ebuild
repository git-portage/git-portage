...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/dbus/Attic/dbus-1.4.16-r2.ebuild,v 1.2 2011/11/11 17:37:43 ssuominen Exp $
...
src_install() {
	# initscript
	newinitd "${FILESDIR}"/dbus.initd dbus || die
