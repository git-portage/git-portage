...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/dcron/Attic/dcron-2.9-r1.ebuild,v 1.1 2003/11/19 06:41:09 prez Exp $
...
src_install() {
	...
	dodir /etc
	install -o root -g root -m 0644 ${FILESDIR}/crontab-2.9-r1 ${D}/etc/crontab
}
