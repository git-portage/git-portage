...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/i2c/Attic/i2c-2.9.2.ebuild,v 1.5 2010/01/10 01:18:04 robbat2 Exp $

inherit eutils toolchain-funcs linux-mod

DESCRIPTION="I2C Bus kernel modules for linux-2.4.x"
HOMEPAGE="http://www.lm-sensors.org/"
SRC_URI="http://dl.lm-sensors.org/i2c/releases/${P}.tar.gz"
