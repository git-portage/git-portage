...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/ibm-powerpc-utils-papr/Attic/ibm-powerpc-utils-papr-1.0.3.ebuild,v 1.2 2007/07/12 05:10:21 mr_bones_ Exp $
...
src_unpack() {
	unpack ${A}
	epatch ${FILESDIR}/ibm-powerpc-utils-papr-1.0.3-remove-doc.patch
	epatch ${FILESDIR}/ibm-powerpc-utils-papr-1.0.3-removeinitandvscsis.patch
}
