...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/isapnptools/Attic/isapnptools-1.22-r1.ebuild,v 1.2 2000/08/16 04:38:27 drobbins Exp $
...
src_install() {                               
    ...
    dodir /usr/man/man5 
    dodir /usr/man/man8
    make installprefix=${D}/ install
    make installprefix=${D}/ install.man
    prepman
