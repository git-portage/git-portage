...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/lsparisc/Attic/lsparisc-0.2.ebuild,v 1.7 2007/01/22 20:33:33 jer Exp $

DESCRIPTION="Like lspci but for PARISC devices"
HOMEPAGE="http://packages.debian.org/unstable/utils/lsparisc"
SRC_URI="mirror://debian/pool/unstable/l/${PN}/${P/-/_}.tar.gz"
