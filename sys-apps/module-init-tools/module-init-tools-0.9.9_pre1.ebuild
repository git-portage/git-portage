...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/module-init-tools/Attic/module-init-tools-0.9.9_pre1.ebuild,v 1.3 2003/02/10 03:58:12 lostlogic Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PN}-0.9.7-fix-generate-modprobe.conf-two-param.patch
	...
	# <azarah@gentoo.org> (28 Dec 2002).
	epatch ${FILESDIR}/${PN}-0.9.7-generate-modprobe.conf-add-missing-semicolons.patch
}
