...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/moreutils/Attic/moreutils-0.47.ebuild,v 1.7 2013/03/06 05:22:49 radhermit Exp $
...
src_prepare() {
	# bug 454854, applied upstream
	epatch "${FILESDIR}"/${PN}-doc-build.patch
