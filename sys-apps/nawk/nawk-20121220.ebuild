...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/nawk/Attic/nawk-20121220.ebuild,v 1.1 2013/02/06 03:19:35 ottxor Exp $
...
src_compile() {
	emake CC="$(tc-getCC)" CFLAGS="${CFLAGS}" ALLOC="${LDFLAGS}" YACC=$(type -p yacc) YFLAGS="-d"
}
