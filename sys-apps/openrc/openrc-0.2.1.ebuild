...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/openrc/Attic/openrc-0.2.1.ebuild,v 1.4 2008/04/03 19:39:36 armin76 Exp $
...
LICENSE="BSD-2"
SLOT="0"
KEYWORDS="~amd64 ~arm ~hppa ~ppc ~ppc64 ~sparc ~sparc-fbsd ~x86" #"~alpha ~amd64 ~arm ~hppa ~ia64 ~ppc ~ppc64 ~sh ~sparc ~sparc-fbsd ~x86 ~x86-fbsd"
