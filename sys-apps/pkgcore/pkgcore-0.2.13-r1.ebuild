...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/pkgcore/Attic/pkgcore-0.2.13-r1.ebuild,v 1.2 2007/04/05 00:19:07 robbat2 Exp $
...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~hppa ~ppc64 ~ppc ~sparc ~x86"
IUSE="doc"
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-tweak_intercepts.patch"
}
