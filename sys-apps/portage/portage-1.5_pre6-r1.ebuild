...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-1.5_pre6-r1.ebuild,v 1.1 2001/02/27 19:40:56 achim Exp $
...
src_install() {
	...
	cd ${FILESDIR}/${PPV}/cnf
	insinto /etc
	newins make.defaults make.defaults.eg
