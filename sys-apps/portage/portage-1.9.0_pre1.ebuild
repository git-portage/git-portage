...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-1.9.0_pre1.ebuild,v 1.1 2001/12/23 22:39:57 chouser Exp $

# NOTE: portage-1.9* are still experimental versions and should only be used by
# gentoo developers
...
src_compile() {                           
	...
	gcc ${CFLAGS} -shared intercept.c -o intercept.so
}
