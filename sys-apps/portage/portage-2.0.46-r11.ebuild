...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.0.46-r11.ebuild,v 1.2 2003/02/04 22:19:49 carpaski Exp $
...
src_unpack() {
	...
	cp ${PF}/bin/ebuild.sh ${PF}/bin/ebuild.sh.orig
	sed 's:-n "$ECLASS":-z "$ECLASS":' < ${PF}/bin/ebuild.sh.orig > ${PF}/bin/ebuild.sh
