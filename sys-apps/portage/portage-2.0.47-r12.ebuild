...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.0.47-r12.ebuild,v 1.4 2003/03/30 01:06:56 carpaski Exp $
...
src_compile() {
	...
	cd ${S}/bin
	patch < ${FILESDIR}/repoman-headers.diff &>/dev/null
}
