...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.0.51.22-r3.ebuild,v 1.8 2006/11/02 23:59:06 zmedico Exp $
...
RDEPEND="!build? ( >=sys-apps/sed-4.0.5 dev-python/python-fchksum >=dev-lang/python-2.2.1 sys-apps/debianutils >=app-shells/bash-2.05a ) !x86-fbsd? ( !ppc-macos? ( !mips? ( >=sys-apps/sandbox-1.2.17 ) ) ) selinux? ( >=dev-python/python-selinux-2.15 )"
