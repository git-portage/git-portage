...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.0.51_rc1.ebuild,v 1.3 2004/09/16 02:21:45 pvdabeel Exp $
...
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~macos ~mips ~ppc ~ppc64 ~s390 ~sparc ~x86 ~ppc-macos"
