...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.0.54-r2.ebuild,v 1.10 2006/05/25 10:59:10 betelgeuse Exp $
...
RDEPEND="!build? ( >=sys-apps/sed-4.0.5 dev-python/python-fchksum >=dev-lang/python-2.3 userland_GNU? ( sys-apps/debianutils ) >=app-shells/bash-3.0 ) !userland_Darwin? ( >=app-misc/pax-utils-0.1.11 sys-apps/sandbox ) selinux? ( >=dev-python/python-selinux-2.15 ) doc? ( app-portage/portage-manpages )"
