...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.0.54-r2.ebuild,v 1.14 2006/08/23 17:55:13 zmedico Exp $
...
RDEPEND="!build? ( >=sys-apps/sed-4.0.5 dev-python/python-fchksum >=dev-lang/python-2.3 userland_GNU? ( sys-apps/debianutils ) !userland_Darwin? ( >=app-shells/bash-3.0 ) userland_Darwin? ( >=app-shells/bash-2.05a ) ) !userland_Darwin? ( >=app-misc/pax-utils-0.1.11 sys-apps/sandbox ) selinux? ( >=dev-python/python-selinux-2.15 ) doc? ( app-portage/portage-manpages )"
