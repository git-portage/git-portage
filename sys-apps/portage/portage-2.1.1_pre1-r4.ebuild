...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.1.1_pre1-r4.ebuild,v 1.1 2006/06/27 10:00:41 zmedico Exp $
...
src_unpack() {
	...
	if [ "${PR}" != "r0" ]; then
		...
		epatch "${FILESDIR}/bug_138131.patch"
		use linguas_pl && \
