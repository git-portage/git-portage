...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.1.1_pre1-r5.ebuild,v 1.1 2006/06/27 20:44:16 zmedico Exp $
...
src_unpack() {
	...
	if [ "${PR}" != "r0" ]; then
		...
		epatch "${FILESDIR}/bugs_138246_138259.patch"
		use linguas_pl && \
