...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.1.1_pre2-r1.ebuild,v 1.1 2006/07/02 01:33:56 zmedico Exp $
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${FILESDIR}/bug_138793.patch"
	if [ -n "${PATCHVER}" ]; then
		cd "${S}"
