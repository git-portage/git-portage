...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.1.1_pre2-r6.ebuild,v 1.1 2006/07/08 00:53:14 zmedico Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/depend_phase_category.patch"
}
