...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.1.1_rc1-r5.ebuild,v 1.1 2006/09/06 07:54:37 zmedico Exp $
...
src_unpack() {
	...
	if [ -n "${PATCHVER}" ]; then
		...
		epatch "${FILESDIR}/2.1.1_rc1-r5-repoman.patch"
	fi
	if [ "${PR}" != "r0" ]; then
