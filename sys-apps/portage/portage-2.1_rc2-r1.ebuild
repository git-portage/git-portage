...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/Attic/portage-2.1_rc2-r1.ebuild,v 1.1 2006/05/23 19:01:12 zmedico Exp $
...
src_unpack() {
	...
	if [ "${PR}" != "r0" ]; then
		...
		epatch "${FILESDIR}/bug_134135.patch"
		epatch "${FILESDIR}/use_expand_hidden_kernel.patch"
