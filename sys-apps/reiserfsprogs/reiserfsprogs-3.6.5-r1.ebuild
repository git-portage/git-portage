...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/reiserfsprogs/Attic/reiserfsprogs-3.6.5-r1.ebuild,v 1.1 2003/04/01 18:13:05 lostlogic Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/reiserfsprogs-3.6.5-flush_buffers-bug.patch || die

	# Looks like this is in 3.6.5... check.
...
#	if [ "${ARCH}" = "ppc" ]; then
#		epatch ${FILESDIR}/reiserfsprogs-3.6.4-bitops.patch || die
#	fi
}
