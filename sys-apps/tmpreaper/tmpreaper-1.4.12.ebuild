...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/tmpreaper/Attic/tmpreaper-1.4.12.ebuild,v 1.22 2004/08/24 03:53:27 swegener Exp $

MYP="tmpreaper_1.4.12"
DESCRIPTION="A utility for removing files based on when they were last accessed"
SRC_URI="mirror://debian/dists/potato/main/source/admin/${MYP}.tar.gz"
