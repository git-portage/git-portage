...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/tpctl/Attic/tpctl-4.2.ebuild,v 1.3 2003/06/21 21:19:41 drobbins Exp $
...
DEPEND="$DEPEND >=sys-apps/thinkpad-4.1 ncurses? ( sys-libs/ncurses )"
