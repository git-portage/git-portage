...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/usb_modeswitch/Attic/usb_modeswitch-1.1.4.ebuild,v 1.3 2010/10/10 10:22:58 phajdan.jr Exp $
...
src_install() {
	...
	emake DESTDIR="${D}" RULESDIR="${udevdir}/rules.d" files-install db-install || die
}
