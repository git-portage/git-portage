...
# $Header: /var/cvsroot/gentoo-x86/sys-auth/pam_mount/Attic/pam_mount-1.26.ebuild,v 1.1 2009/06/30 10:47:44 hanno Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${PN}-1.25-nullsetenv.patch
}
