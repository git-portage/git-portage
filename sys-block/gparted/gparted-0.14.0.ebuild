...
# $Header: /var/cvsroot/gentoo-x86/sys-block/gparted/Attic/gparted-0.14.0.ebuild,v 1.2 2012/12/02 22:24:40 ssuominen Exp $
...
src_install() {
	...
	if use policykit; then
		sed -i -e 's:Exec=:Exec=pkexec :' "${_ddir}"/gparted.desktop
	else
		if use kde; then
