...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/drbd/Attic/drbd-8.0.8.ebuild,v 1.4 2008/02/25 14:37:30 xmerlin Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-missing-include.patch || die
}
