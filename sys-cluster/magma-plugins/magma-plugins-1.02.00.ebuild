...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/magma-plugins/Attic/magma-plugins-1.02.00.ebuild,v 1.1 2006/04/30 13:16:43 xmerlin Exp $
...
DEPEND=">=sys-cluster/magma-1.02.00
	>=sys-cluster/dlm-1.02.00
	>=sys-cluster/cman-1.02.00
	"

#	!nogulm? ( >=sys-cluster/gulm-1.02.00 )"
