...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/util-vserver/Attic/util-vserver-0.30.209.ebuild,v 1.5 2005/12/12 10:08:58 phreak Exp $
...
SRC_URI="http://www.13thfloor.at/~ensc/util-vserver/files/alpha/${P}.tar.bz2
	http://dev.gentoo.org/~hollow/distfiles/${P}-gentoo.tar.bz2
	http://dev.gentoo.org/~phreak/distfiles/${P}-gentoo.tar.bz2"
