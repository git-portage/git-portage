...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/autoconf/Attic/autoconf-2.59-r3.ebuild,v 1.10 2004/09/03 19:37:35 pvdabeel Exp $
...
src_install() {
	...
	# to use.
	exeinto /usr/lib/${PN}
	newexe ${FILESDIR}/ac-wrapper-3.pl ac-wrapper.pl
