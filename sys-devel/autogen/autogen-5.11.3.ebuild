...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/autogen/Attic/autogen-5.11.3.ebuild,v 1.1 2010/12/08 02:31:06 vapier Exp $
...
src_install() {
	...
	rm "${ED}"/usr/share/aclocal/{liboptschk,snprintfv,unlocked-io,extensions,libopts}.m4 || die #347095
}
