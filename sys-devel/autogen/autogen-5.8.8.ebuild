...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/autogen/Attic/autogen-5.8.8.ebuild,v 1.3 2007/01/27 16:45:13 vapier Exp $
...
pkg_setup() {
	if ! built_with_use --missing false dev-scheme/guile deprecated ; then
