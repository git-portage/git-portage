...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/binutils/Attic/binutils-2.11.92.0.12.3-r1.ebuild,v 1.1 2001/12/24 18:20:59 drobbins Exp $

S=${WORKDIR}/${P}
DESCRIPTION="Tools necessary to build programs"
SRC_URI="http://ftp.kernel.org/pub/linux/devel/binutils/${P}.tar.bz2 http://www.ibiblio.org/${PN}-manpages-${PV}.tar.bz2"
