...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/binutils/Attic/binutils-2.12.90.0.7.ebuild,v 1.10 2002/08/14 03:43:01 murphy Exp $
...
if [ -z "`use build`" ] && [ -z "`use bootstrap`" ]
then
	DEPEND="${DEPEND}
		sys-devel/perl"
fi
