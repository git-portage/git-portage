...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/binutils/Attic/binutils-2.14.90.0.6-r6.ebuild,v 1.10 2004/07/02 09:31:17 eradicator Exp $
...
#	epatch ${FILESDIR}/2.14/${PN}-2.14.90.0.6-bfd-elf-interp.patch
	...
	epatch ${FILESDIR}/2.14/${PN}-2.14.90.0.6-bfd-elf-interp-3.patch
