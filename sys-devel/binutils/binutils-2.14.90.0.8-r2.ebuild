...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/binutils/Attic/binutils-2.14.90.0.8-r2.ebuild,v 1.3 2004/06/16 06:50:25 lv Exp $
...
src_unpack() {
	...
	use uclibc && mv ${WORKDIR}/patch/{38,63,64,92}* ${WORKDIR}/patch/skip/
