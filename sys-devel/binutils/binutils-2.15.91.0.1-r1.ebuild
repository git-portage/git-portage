...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/binutils/Attic/binutils-2.15.91.0.1-r1.ebuild,v 1.10 2004/11/07 09:14:33 mr_bones_ Exp $
...
SLOT="0"
KEYWORDS="-* -ppc"
IUSE="bootstrap build hardened multitarget nls pic"
...
src_unpack() {
	...
	(use pic || use hardened) && epatch ${FILESDIR}/libiberty-pic.patch
