...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/distcc/Attic/distcc-2.10-r2.ebuild,v 1.1 2003/08/15 23:06:33 seemant Exp $
...
pkg_postinst() {
	...
	if [ "${ROOT}" = "/" ]; then
		...
		/usr/bin/distcc-config --set-env DISTCC_DIR /tmp
	else
