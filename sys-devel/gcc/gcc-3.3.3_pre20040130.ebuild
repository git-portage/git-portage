...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/Attic/gcc-3.3.3_pre20040130.ebuild,v 1.5 2004/07/02 09:32:03 eradicator Exp $
...
then
	...
	SRC_URI="ftp://ftp.linuxppc64.org/pub/people/tgall/gcc/${PN}-20040130.tar.bz2"
fi
if [ -n "${PP_VER}" ]
then
	SRC_URI="${SRC_URI}
