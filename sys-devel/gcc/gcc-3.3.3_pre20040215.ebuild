...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/Attic/gcc-3.3.3_pre20040215.ebuild,v 1.7 2004/07/02 09:32:03 eradicator Exp $
...
src_unpack() {
	...
	then
		# Make gcc's version info specific to Gentoo
	 	version_patch ${FILESDIR}/3.3.3/gcc333_pre20040215-gentoo-branding.patch \
