...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/Attic/gcc-3.3.5.ebuild,v 1.1 2004/11/17 15:26:34 vapier Exp $

inherit eutils flag-o-matic libtool gnuconfig toolchain

DESCRIPTION="The GNU Compiler Collection.  Includes C/C++, java compilers, pie+ssp extensions, Haj Ten Brugge runtime bounds checking"

KEYWORDS="~amd64 ~arm -hppa ~mips ~sh ~sparc ~x86"
...
PATCH_VER="1.0"
#PIE_VER="8.7.6"
#PIE_CORE="gcc-3.3.4-piepatches-v${PIE_VER}.tar.bz2"
PP_VER="3_3_2"
PP_FVER="${PP_VER//_/.}-3"
