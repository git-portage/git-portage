...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/Attic/gcc-3.4.6.ebuild,v 1.8 2006/04/11 03:04:49 kumba Exp $
...
KEYWORDS="-* ~amd64 ~arm ~mips ~ppc ~ppc64 ~sh ~sparc ~x86 ~x86-fbsd"
