...
# $Header: /var/cvsroot/gentoo-x86/sys-freebsd/freebsd-sources/Attic/freebsd-sources-6.2_beta1.ebuild,v 1.2 2006/09/21 21:04:49 flameeyes Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-6.2-devfs-deadlock.patch"
