...
# $Header: /var/cvsroot/gentoo-x86/sys-freebsd/freebsd-ubin/Attic/freebsd-ubin-6.1.ebuild,v 1.8 2006/09/14 02:49:07 flameeyes Exp $
...
src_install() {
	...
	dodir /bin
	for bin in awk sed mkfifo uname true false; do
