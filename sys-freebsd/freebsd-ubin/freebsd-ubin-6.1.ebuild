...
# $Header: /var/cvsroot/gentoo-x86/sys-freebsd/freebsd-ubin/Attic/freebsd-ubin-6.1.ebuild,v 1.9 2006/09/16 21:50:39 the_paya Exp $
...
src_install() {
	...
	dodir /bin
	for bin in awk sed mkfifo uname true false touch; do
