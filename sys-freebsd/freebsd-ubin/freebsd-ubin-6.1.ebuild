...
# $Header: /var/cvsroot/gentoo-x86/sys-freebsd/freebsd-ubin/Attic/freebsd-ubin-6.1.ebuild,v 1.3 2006/09/10 14:59:34 flameeyes Exp $
...
src_install() {
	...
	dodir /bin
	mv "${D}"/usr/bin/{awk,sed} "${D}"/bin/ || die "mv failed"
