...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/aufs-util/Attic/aufs-util-3.10_p20130722.ebuild,v 1.1 2013/07/22 06:42:41 jlec Exp $
...
# git archive -v --prefix=${P}/ --remote=git://git.code.sf.net/p/aufs/aufs-util aufs3.10 -o ${P}.tar
# xz -ve9 *.tar
