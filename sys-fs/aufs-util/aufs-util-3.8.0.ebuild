...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/aufs-util/Attic/aufs-util-3.8.0.ebuild,v 1.1 2013/03/10 10:47:28 jlec Exp $
...
# git archive -v --prefix=aufs-util-3.8.2/ \
# --remote=git://aufs.git.sourceforge.net/gitroot/aufs/aufs-util.git aufs3.0 \
# -o aufs-util-3.8.2.tar && xz -ve9 aufs-util-3.8.2.tar
