...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/cryptsetup/Attic/cryptsetup-1.4.1.ebuild,v 1.1 2011/11/13 04:18:38 vapier Exp $
...
src_install() {
	...
	newinitd "${FILESDIR}"/dmcrypt.initd dmcrypt || die
}
