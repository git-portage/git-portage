...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/e2fsprogs/Attic/e2fsprogs-1.40.5.ebuild,v 1.1 2008/01/28 06:43:46 vapier Exp $
...
src_unpack() {
	...
	echo 'GROUP ( /usr/lib/libcom_err.a )' > lib/libcom_err.a
	echo 'GROUP ( /usr/lib/libcom_err.so )' > lib/libcom_err.so
	echo 'GROUP ( /usr/lib/libss.a )' > lib/libss.a
	echo 'GROUP ( /usr/lib/libss.so )' > lib/libss.so
