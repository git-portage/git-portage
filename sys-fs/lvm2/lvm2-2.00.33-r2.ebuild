...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/lvm2/Attic/lvm2-2.00.33-r2.ebuild,v 1.1 2005/03/08 05:30:33 rocket Exp $
...
src_compile() {
	econf $(use_enable readline) --enable-static_link
