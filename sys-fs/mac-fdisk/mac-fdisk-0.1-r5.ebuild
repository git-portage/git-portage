...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/mac-fdisk/Attic/mac-fdisk-0.1-r5.ebuild,v 1.1 2006/07/19 20:33:50 vapier Exp $
...
src_install() {
	into /
	newsbin fdisk mac-fdisk || die
	newsbin pdisk pmac-fdisk || die
