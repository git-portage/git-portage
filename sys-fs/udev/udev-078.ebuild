...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/Attic/udev-078.ebuild,v 1.1 2005/12/19 21:18:10 gregkh Exp $
...
src_install() {
	...
	newins ${FILESDIR}/05-udev-early.rules-078 05-udev-early.rules
