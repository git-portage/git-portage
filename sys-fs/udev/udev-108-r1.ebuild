...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/Attic/udev-108-r1.ebuild,v 1.1 2007/04/23 20:18:22 zzam Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PN}-108-cleanup-early-rules.diff
	epatch ${FILESDIR}/${PN}-108-persistent-joystick.diff

	cd "${S}/etc/udev/gentoo"
	mv udev.rules 50-udev.rules
	cd "${S}"
