...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/Attic/udev-115.ebuild,v 1.2 2007/08/26 13:40:57 mr_bones_ Exp $
...
src_unpack() {
	...
	MD5=${MD5/  -/}
	if [ "${MD5}" != "423964bc802105edc672e170f733ef28" ]
	then
		echo
...
src_install() {
	...
	# Our rules files
	mv gentoo/80-hotplug.rules gentoo/80-drivers.rules
	doins gentoo/??-*.rules
