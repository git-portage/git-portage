...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/Attic/udev-118-r2.ebuild,v 1.2 2008/06/15 05:54:32 zmedico Exp $
...
src_install() {
	...
	newexe "${FILESDIR}"/shell-compat-118-r2.sh shell-compat.sh \
