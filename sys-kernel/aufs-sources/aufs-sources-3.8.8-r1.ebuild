...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/aufs-sources/Attic/aufs-sources-3.8.8-r1.ebuild,v 1.1 2013/04/22 06:48:49 jlec Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-CONFIG_USER_NS.patch
}
