...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/ck-sources/Attic/ck-sources-2.6.18_p1-r2.ebuild,v 1.1 2006/11/15 01:01:39 marineam Exp $
...
CKPATCH="patch-${KV_CK}-for-gentoo.bz2"
...
SRC_URI="${KERNEL_URI} ${GENPATCHES_URI}
	ck-server?  ( mirror://gentoo/${CKPATCH/ck/cks} )
	!ck-server? ( mirror://gentoo/${CKPATCH} )"
