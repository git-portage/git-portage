...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/gaming-sources/Attic/gaming-sources-2.4.20-r7.ebuild,v 1.1 2004/01/06 18:57:32 plasmaroo Exp $
...
SRC_URI="http://www.kernel.org/pub/linux/kernel/v2.4/linux-${OKV}.tar.bz2 mirror://gentoo/patches-${KV/7/5}.tar.bz2 http://members.optusnet.com.au/ckolivas/kernel/ck${CKV}.patch.bz2"
...
src_unpack() {
	...
	cd ${KV/7/5} || die #enter the patch directory and go!
	kernel_src_unpack
