...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/Attic/genkernel-3.4.22.ebuild,v 1.2 2012/01/08 02:17:36 sping Exp $
...
then
	...
	KEYWORDS="" # emergency mask  ~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc ~ppc64 ~s390 ~sparc ~x86"
fi
