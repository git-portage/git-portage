...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/gs-sources/Attic/gs-sources-2.4.21_pre3-r3.ebuild,v 1.1 2003/01/24 19:02:04 livewire Exp $
...
inherit kernel || die
OKV=2.4.20
EXTRAVERSION=-pre3-gss-r3
KV=2.4.21_pre3-gss-r3
S=${WORKDIR}/linux-${KV}
