...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/gs-sources/Attic/gs-sources-2.4.21_pre5-r1.ebuild,v 1.3 2003/03/27 23:28:12 livewire Exp $
...
inherit kernel || die
OKV=2.4.20
EXTRAVERSION=_pre5-gss-r1
KV=2.4.21_pre5-gss-r1
S=${WORKDIR}/linux-${KV}
