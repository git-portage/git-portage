...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/gs-sources/Attic/gs-sources-2.4.21_rc1-r1.ebuild,v 1.1 2003/05/02 00:18:48 livewire Exp $
...
inherit kernel || die
OKV=2.4.20
EXTRAVERSION=_rc1-gss-r1
KV=2.4.21_rc1-gss-r1
S=${WORKDIR}/linux-${KV}
