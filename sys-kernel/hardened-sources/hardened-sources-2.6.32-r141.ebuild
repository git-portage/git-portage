...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hardened-sources/Attic/hardened-sources-2.6.32-r141.ebuild,v 1.1 2012/11/27 12:54:27 blueness Exp $
...
HGPV="${KV_MAJOR}.${KV_MINOR}.${KV_PATCH}-145"
