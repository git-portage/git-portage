...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hardened-sources/Attic/hardened-sources-2.6.32-r143.ebuild,v 1.2 2012/12/26 12:41:54 blueness Exp $
...
HGPV="${KV_MAJOR}.${KV_MINOR}.${KV_PATCH}-147"
