...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hardened-sources/Attic/hardened-sources-2.6.32-r53.ebuild,v 1.1 2011/06/24 12:30:19 blueness Exp $
...
HGPV="${KV_MAJOR}.${KV_MINOR}.${KV_PATCH}-56"
