...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hppa-dev-sources/Attic/hppa-dev-sources-2.6.0_beta11-r6.ebuild,v 1.1 2004/01/08 23:57:03 gmsoft Exp $
...
EXTRAVERSION="${PV/*_beta/-test}-pa${PATCH_LEVEL}"
S=${WORKDIR}/linux-${KV}

PATCH_SET="`seq 1 3` `seq 5 ${PATCH_LEVEL}`"
