...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hppa-sources/Attic/hppa-sources-2.4.21_p13.ebuild,v 1.4 2004/01/06 19:58:13 plasmaroo Exp $
...
SRC_URI="mirror://kernel/linux/kernel/v2.4/linux-${OKV}.tar.bz2 http://ftp.parisc-linux.org/cvs/linux-2.4/patch-${OKV}-pa`echo ${PATCH_SET} | awk '{ print $1 }'`.diff.gz
