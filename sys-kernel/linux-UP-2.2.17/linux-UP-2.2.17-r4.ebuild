...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux-UP-2.2.17/Attic/linux-UP-2.2.17-r4.ebuild,v 1.2 2000/11/20 08:07:05 achim Exp $
...
##    sed -e 's:-O2:${CFLAGS}:g' Makefile.orig > Makefile
    ...
    try make symlinks
    cp ${O}/files/${P}-r4.config .config
    cp ${O}/files/${P}-r4.autoconf include/linux/autoconf.h
