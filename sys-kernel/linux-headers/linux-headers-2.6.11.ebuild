...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux-headers/Attic/linux-headers-2.6.11.ebuild,v 1.4 2005/04/15 03:05:34 vapier Exp $
...
KEYWORDS="-* ~amd64 ~arm ~hppa m68k ~ia64 ~s390 ~sh ~x86" # Not tested to be fully stable, if things break file bugs to plasmaroo please...
