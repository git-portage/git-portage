...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux-sources/Attic/linux-sources-2.4.18_pre3-r1.ebuild,v 1.1 2002/01/19 22:55:30 drobbins Exp $
...
src_unpack() {
	...
	echo "Fixing binutils issue..."
	cat ${FILESDIR}/linux-2.4.16-binutils.patch | patch -p1
