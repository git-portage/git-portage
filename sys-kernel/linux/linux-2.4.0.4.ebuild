...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux/Attic/linux-2.4.0.4.ebuild,v 1.1 2001/01/08 21:42:52 achim Exp $
...
http://www.de.kernel.org/pub/linux/kernel/people/alan/2.4/patch-2.4.0-ac4.bz2
...
src_unpack() {
    ...
    cd ${S}
    echo "Applying ac4 patch..."
    bzip2 -dc ${DISTDIR}/patch-2.4.0-ac4.bz2 | patch -p1
