...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux/Attic/linux-2.4.0.7.ebuild,v 1.1 2001/01/12 16:25:08 achim Exp $
...
http://www.de.kernel.org/pub/linux/kernel/people/alan/2.4/patch-2.4.0-ac7.bz2
...
src_unpack() {
    ...
    bzip2 -dc ${DISTDIR}/patch-2.4.0-ac7.bz2 | patch -p1
