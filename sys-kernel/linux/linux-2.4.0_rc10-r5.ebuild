...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux/Attic/linux-2.4.0_rc10-r5.ebuild,v 1.4 2000/12/08 12:26:16 achim Exp $
...
src_unpack() {
    ...
    gzip -dc ${FILESDIR}/linux-2.4.0-test10-reiserfs-3.6.22-nfs.diff.gz | patch -p1
    mkdir extras
