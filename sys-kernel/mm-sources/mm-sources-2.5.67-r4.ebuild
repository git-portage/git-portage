...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/mm-sources/Attic/mm-sources-2.5.67-r4.ebuild,v 1.1 2003/04/18 13:34:58 dragon Exp $
...
OKV=${PV}
if [ "${PR}" != "r0" ]; then 
	PATCH_URI="http://www.kernel.org/pub/linux/kernel/people/akpm/patches/2.5/${PV}/${PVR/r/mm}/${PVR/r/mm}.bz2"
fi
KV=${PVR/r/mm}
S=${WORKDIR}/linux-${KV}
ETYPE="sources"
