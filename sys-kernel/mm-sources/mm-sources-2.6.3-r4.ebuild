...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/mm-sources/Attic/mm-sources-2.6.3-r4.ebuild,v 1.2 2004/02/26 18:53:29 latexer Exp $

UNIPATCH_LIST="${DISTDIR}/${KV}.bz2 ${FILESDIR}/${PF}-symbol-fixes.diff"
K_PREPATCHED="yes"
