...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openmosix-sources/Attic/openmosix-sources-2.4.17_pre4.ebuild,v 1.8 2002/09/28 17:02:25 tantive Exp $
#OKV=original kernel version, KV=patched kernel version.  They can be the same.

#we use this next variable to avoid duplicating stuff on cvs
GFILESDIR=${PORTDIR}/sys-kernel/linux-sources/files
OKV=2.4.16
KV=2.4.17-pre4-openmosix
S=${WORKDIR}/linux-${KV}
ETYPE="sources"
...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="x86 -pcc -sparc -sparc64 -alpha"
