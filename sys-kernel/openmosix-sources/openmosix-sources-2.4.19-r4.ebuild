...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openmosix-sources/Attic/openmosix-sources-2.4.19-r4.ebuild,v 1.10 2003/03/24 23:34:01 drobbins Exp $
# OKV=original kernel version, KV=patched kernel version.  They can be the same.

# we use this next variable to avoid duplicating stuff on cvs
GFILESDIR=${PORTDIR}/sys-kernel/linux-sources/files
OKV=2.4.19
KV=2.4.19-openmosix-r4
S=${WORKDIR}/linux-${KV}
ETYPE="sources"
