...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openvz-sources/Attic/openvz-sources-2.6.27.6.1-r2.ebuild,v 1.1 2010/09/21 20:17:01 pva Exp $
...
SRC_URI="${KERNEL_URI} ${ARCH_URI}
	...
	mirror://gentoo/openvz-2.6.27-2.6.27.54.patch.bz2"

UNIPATCH_STRICTORDER=1
UNIPATCH_LIST="${DISTDIR}/patch-${OVZ_KV}-combined.gz
${DISTDIR}/openvz-2.6.27-2.6.27.54.patch.bz2"
