...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/ppc-development-sources/Attic/ppc-development-sources-2.6.5_rc2-r1.ebuild,v 1.1 2004/03/27 15:46:55 lu_zero Exp $
...
########  Contains 
########   2.6.5_rc2-ben0 (from bk)
########   pegasos-2.6.4-2004.03.22.diff ( from http://people.debian.org/~luther/pegasos/2.6.4/ )
...
# INCLUDED: 2.6 vanilla + benh bk snapshot + other patches

DESCRIPTION="Full sources for the linux kernel 2.6 based on benh's patchset"
SRC_URI="mirror://kernel/linux/kernel/v2.6/linux-${OKV}.tar.bz2
		mirror://gentoo/patches-${KV}.bz2
		http://dev.gentoo.org/~lu_zero/kernel/patches-${KV}.bz2"
KEYWORDS="~ppc ppc64"
