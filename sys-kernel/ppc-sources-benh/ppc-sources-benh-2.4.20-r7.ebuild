...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/ppc-sources-benh/Attic/ppc-sources-benh-2.4.20-r7.ebuild,v 1.6 2003/11/20 07:43:38 lostlogic Exp $
...
#bad hack for wierd rev number on this patch
MY_R="${MY_R}.1"
