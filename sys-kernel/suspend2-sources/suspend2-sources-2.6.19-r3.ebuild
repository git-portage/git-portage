...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/suspend2-sources/Attic/suspend2-sources-2.6.19-r3.ebuild,v 1.1 2007/02/28 19:10:29 alonbl Exp $
...
UNIPATCH_LIST="${DISTDIR}/${SUSPEND2_SRC}.patch.bz2
	...
	${FILESDIR}/suspend2-${SUSPEND2_VERSION}-fixups.patch"
