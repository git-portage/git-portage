...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/vserver-sources/Attic/vserver-sources-2.0.2-r1.ebuild,v 1.1 2006/09/10 16:00:04 phreak Exp $
...
SRC_URI="${KERNEL_URI} ${GENPATCHES_URI} ${ARCH_URI}
	...
	http://dev.gentoo.org/~phreak/distfiles/${MY_PN}-${CKV}_${PV}.tar.bz2"
