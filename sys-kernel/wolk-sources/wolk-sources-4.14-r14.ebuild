...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/wolk-sources/Attic/wolk-sources-4.14-r14.ebuild,v 1.1 2005/03/26 18:41:50 plasmaroo Exp $
...
UNIPATCH_LIST="
	...
	${FILESDIR}/${PN}.77666.patch
	${FILESDIR}/${PN}.78362.patch
	${FILESDIR}/${PN}.78363.patch
