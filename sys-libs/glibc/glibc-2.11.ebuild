...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/Attic/glibc-2.11.ebuild,v 1.5 2009/11/09 13:02:57 vapier Exp $
...
eblit-src_unpack-post() {
	if use hardened ; then
		...
		gcc-specs-pie && epatch "${FILESDIR}"/2.11/glibc-2.5-hardened-pie.patch
