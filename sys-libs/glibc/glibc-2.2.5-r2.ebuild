...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/Attic/glibc-2.2.5-r2.ebuild,v 1.2 2002/03/18 06:57:46 drobbins Exp $
...
LHV=2.4.18
DEPEND=">=sys-apps/portage-1.8.9 ~sys-kernel/linux-headers-${LHV} nls? ( sys-devel/gettext ) gd? ( media-libs/libgd )"
