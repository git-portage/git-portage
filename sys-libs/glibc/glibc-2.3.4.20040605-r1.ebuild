...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/Attic/glibc-2.3.4.20040605-r1.ebuild,v 1.10 2004/06/28 02:03:43 agriffis Exp $
...
src_unpack() {
	...
	# Extract pre-made man pages.  Otherwise we need perl, which is bad (especially for stage1 bootstrap)
	mkdir -p ${S}/man
	cd ${S}/man
