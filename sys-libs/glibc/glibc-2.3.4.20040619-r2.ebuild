...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/Attic/glibc-2.3.4.20040619-r2.ebuild,v 1.6 2005/01/12 05:17:16 eradicator Exp $
...
DEPEND=">=sys-devel/gcc-3.2.3-r1
	...
	virtual/os-headers
	nptl? ( || ( >=sys-kernel/linux-headers-2.6.0 sys-kernel/linux26-headers ) )
