...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/Attic/glibc-2.3.5.ebuild,v 1.34 2005/07/17 11:16:32 eradicator Exp $
...
glibc_do_configure() {
	...
	if [ "$1" == "linuxthreads" ] ; then
		if want_tls && [[ ${CHOST} != "i586-pc-linux-gnu" ]] ; then
