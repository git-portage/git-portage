...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/gwenhywfar/Attic/gwenhywfar-4.3.1.ebuild,v 1.1 2012/01/06 09:09:21 ssuominen Exp $

EAPI=4

DESCRIPTION="A multi-platform helper library for other libraries"
HOMEPAGE="http://www.aquamaniac.de/aqbanking/"
SRC_URI="http://www.aquamaniac.de/sites/download/download.php?package=01&release=65&file=01&dummy=${P}.tar.gz -> ${P}.tar.gz"
