...
# $Header: /var/cvsroot/gentoo-x86/sys-power/powertop/Attic/powertop-2.1.ebuild,v 1.4 2012/09/07 11:27:23 pinkbyte Exp $
...
src_configure() {
	use unicode || export ac_cv_search_delwin=-lncurses
	default
}
