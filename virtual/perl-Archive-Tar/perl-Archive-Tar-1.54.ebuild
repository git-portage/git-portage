...
# $Header: /var/cvsroot/gentoo-x86/virtual/perl-Archive-Tar/Attic/perl-Archive-Tar-1.54.ebuild,v 1.13 2010/09/07 20:15:59 tove Exp $
...
RDEPEND="|| ( ~dev-lang/perl-5.12.2 ~dev-lang/perl-5.12.1 ~perl-core/Archive-Tar-${PV} )"
