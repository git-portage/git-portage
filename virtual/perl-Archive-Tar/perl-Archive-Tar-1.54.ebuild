...
# $Header: /var/cvsroot/gentoo-x86/virtual/perl-Archive-Tar/Attic/perl-Archive-Tar-1.54.ebuild,v 1.14 2011/01/22 10:07:56 tove Exp $
...
RDEPEND="|| ( ~dev-lang/perl-5.12.3 ~dev-lang/perl-5.12.2 ~perl-core/Archive-Tar-${PV} )"
