...
# $Header: /var/cvsroot/gentoo-x86/virtual/perl-IO-Zlib/Attic/perl-IO-Zlib-1.10.ebuild,v 1.14 2011/05/02 20:06:22 grobian Exp $
...
RDEPEND="|| ( ~dev-lang/perl-5.12.3 ~dev-lang/perl-5.12.2 ~perl-core/IO-Zlib-${PV} )"
