...
# $Header: /var/cvsroot/gentoo-x86/www-apache/mod_dav_svn/Attic/mod_dav_svn-1.1.3-r1.ebuild,v 1.2 2005/07/09 15:42:35 agriffis Exp $
...
src_install() {
	...
	sed -e "s:@SVN_REPOS_LOC@:${SVN_REPOS_LOC}:" \
		"${FILESDIR}/${PVR}/${APACHE2_MOD_CONF}.conf" \
