...
# $Header: /var/cvsroot/gentoo-x86/www-apache/mod_fcgid/Attic/mod_fcgid-1.05-r2.ebuild,v 1.4 2005/05/14 02:55:56 ramereth Exp $
...
DEPEND="<=net-www/apache-2.0.54-r4
	!>net-www/apache-2.0.54-r4
	!=net-www/apache-1*"
RDEPEND="<=net-www/apache-2.0.54-r4
	!>net-www/apache-2.0.54-r4
	!=net-www/apache-1*"
