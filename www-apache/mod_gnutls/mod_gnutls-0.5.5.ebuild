...
# $Header: /var/cvsroot/gentoo-x86/www-apache/mod_gnutls/Attic/mod_gnutls-0.5.5.ebuild,v 1.3 2009/07/27 11:52:37 chainsaw Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${PN}-0.5.4-apache-2.4.patch"
}
