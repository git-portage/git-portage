...
# $Header: /var/cvsroot/gentoo-x86/www-apps/coppermine/Attic/coppermine-1.4.27.ebuild,v 1.1 2011/06/09 06:53:53 pva Exp $
...
S="${WORKDIR}"/cpg$(delete_all_version_separators ${PV})
