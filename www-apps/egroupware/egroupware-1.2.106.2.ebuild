...
# $Header: /var/cvsroot/gentoo-x86/www-apps/egroupware/Attic/egroupware-1.2.106.2.ebuild,v 1.1 2007/05/26 23:09:04 rl03 Exp $

inherit webapp depend.php

MY_PN=eGroupWare
MY_PV=${PV/106.2/106-2}
S=${WORKDIR}/${PN}

DESCRIPTION="Web-based GroupWare suite"
HOMEPAGE="http://www.eGroupWare.org/"
SRC_URI="mirror://sourceforge/${PN}/${MY_PN}-${MY_PV}.tar.bz2
	contrib? ( mirror://sourceforge/${PN}/${MY_PN}-contrib-${MY_PV}.tar.bz2 )"

LICENSE="GPL-2"
KEYWORDS="~alpha ~amd64 ~hppa ~ppc ~sparc ~x86"
IUSE="contrib gd jpgraph ldap mysql postgres"
