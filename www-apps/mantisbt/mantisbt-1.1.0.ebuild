...
# $Header: /var/cvsroot/gentoo-x86/www-apps/mantisbt/Attic/mantisbt-1.1.0.ebuild,v 1.1 2008/01/10 22:01:35 pva Exp $
...
SRC_URI="mirror://sourceforge/${PN}/${MY_P}.tar.gz
		mirror://gentoo/mantisbt-1.1.0-current-svn-fixes.patch.gz"
...
src_unpack() {
	...
	epatch "${WORKDIR}"/${P}-current-svn-fixes.patch
}
