...
# $Header: /var/cvsroot/gentoo-x86/www-client/firefox-bin/Attic/firefox-bin-3.6.24.ebuild,v 1.1 2011/11/14 15:34:36 nirbheek Exp $
...
LANGS="af ar as ast be bg bn-BD bn-IN ca cs cy da de el en en-GB en-US eo \
es-AR es-CL es-ES es-MX et eu fa fi fr fy-NL ga-IE gd gl gu-IN he hi-IN hr hu \
id is it ja ka kk kn ko ku lt lv mk ml mr nb-NO nl nn-NO oc or pa-IN pl pt-BR \
