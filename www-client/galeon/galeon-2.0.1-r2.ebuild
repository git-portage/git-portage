...
# $Header: /var/cvsroot/gentoo-x86/www-client/galeon/Attic/galeon-2.0.1-r2.ebuild,v 1.1 2006/07/12 22:13:34 hanno Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/galeon-2.0.1-findahead.diff
}
