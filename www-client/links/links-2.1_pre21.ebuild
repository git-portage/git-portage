...
# $Header: /var/cvsroot/gentoo-x86/www-client/links/Attic/links-2.1_pre21.ebuild,v 1.1 2006/04/21 23:12:09 vanquirius Exp $
...
#	mirror://gentoo/${PN}-2.1pre21-utf8.diff.bz2"

LICENSE="GPL-2"
SLOT="2"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc ~ppc-macos ~ppc64 ~s390 ~sh ~sparc ~x86 ~x86-fbsd"
IUSE="directfb fbcon gpm javascript jpeg livecd png sdl ssl svga tiff X"
# unicode
...
#	patch needs to be ported

#	if use unicode ; then
#		epatch "${WORKDIR}/${PN}-2.1pre21-utf8.diff"
#		export LANG=C
