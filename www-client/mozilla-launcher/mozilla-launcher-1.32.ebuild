...
# $Header: /var/cvsroot/gentoo-x86/www-client/mozilla-launcher/Attic/mozilla-launcher-1.32.ebuild,v 1.5 2005/06/28 23:30:01 agriffis Exp $
...
src_unpack() {
	...
	use amd64 && epatch ${FILESDIR}/${PN}-1.32-multilib.patch
}
