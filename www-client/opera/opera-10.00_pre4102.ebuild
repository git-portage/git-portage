...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/Attic/opera-10.00_pre4102.ebuild,v 1.3 2008/12/06 16:46:13 jer Exp $
...
O_U="http://snapshot.opera.com/unix/10.0-Alpha-1/"
O_P="${P/_pre/-}"
O_PA="${P/_pre4102/-4103}"
	...
	qt-static? (
		qt3? (
			amd64? (
				...
				!ia32? ( ${O_U}x86_64-linux/${O_PA}.gcc4-shared-qt3.x86_64.tar.bz2 )
			)
...
RDEPEND="media-libs/libexif
	...
	x86? ( !qt-static? ( !qt3? ( =x11-libs/qt-3* ) ) )
	amd64? (
