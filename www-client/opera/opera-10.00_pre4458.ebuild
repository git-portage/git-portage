...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/Attic/opera-10.00_pre4458.ebuild,v 1.2 2009/06/30 17:01:22 mr_bones_ Exp $
	...
	amd64? (
		!ia32? (
			qt-static? (
				...
				!qt3? ( ${O_U}x86_64-linux/${O_P}.gcc4-bundled-qt4.x86_64.tar.bz2 )
			)
			!qt-static? (
				qt3? ( ${O_U}x86_64-linux/${O_P}.gcc4-shared-qt3.x86_64.tar.bz2 )
