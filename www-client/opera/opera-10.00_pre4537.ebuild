...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/Attic/opera-10.00_pre4537.ebuild,v 1.1 2009/08/13 11:21:45 jer Exp $
...
MY_LINGUAS="
be bg cs da de el en-GB es-ES es-LA et fi fr fr-CA fy hi hr hu id it ja ka ko lt
mk nb nl nn pl pt pt-BR ro ru sk sr sv ta te tr uk zh-CN zh-HK zh-TW
"
...
O_U="mirror://opera/" # base URL
O_R="/1000b3/" # beta subdir
O_L="${O_U}linux${O_R}beta3/en/" # linux URL
O_F="${O_U}unix/freebsd/${O_R}en/" # freebsd URL
...
SRC_URI="
	amd64? (
		!ia32? (
			qt-static? ( ${O_L}x86_64/${O_P}.gcc4-bundled-qt4.x86_64.tar.bz2 )
			!qt-static? (
				qt3? ( ${O_L}x86_64/${O_P}.gcc4-shared-qt3.x86_64.tar.bz2 )
				!qt3? ( ${O_L}x86_64/${O_P}.gcc4-qt4.x86_64.tar.bz2 )
			)
		)
		ia32? (
			qt-static? ( ${O_L}i386/${O_P}.gcc4-bundled-qt4.i386.tar.bz2 )
			!qt-static? (
				qt3? ( ${O_L}i386/shared/${O_P}.gcc4-shared-qt3.i386.tar.bz2 )
				!qt3? ( ${O_L}i386/${O_P}.gcc4-qt4.i386.tar.bz2 )
			)
		)
	)
	ppc? ( ${O_L}ppc/shared/${O_P}.gcc4-shared-qt3.ppc.tar.bz2 )
	x86? (
		qt-static? ( ${O_L}i386/${O_P}.gcc4-bundled-qt4.i386.tar.bz2 )
		!qt-static? (
			qt3? ( ${O_L}i386/shared/${O_P}.gcc4-shared-qt3.i386.tar.bz2 )
	...
	x86-fbsd? ( ${O_F}intel/shared/${O_P}-freebsd7-shared-qt3.i386.tar.bz2 )
	"
