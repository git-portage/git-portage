...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/Attic/opera-10.60_pre6368.ebuild,v 1.2 2010/06/16 12:25:34 jer Exp $
...
SRC_URI="
	amd64? ( ${O_U}linux/1060b1/${O_P}.x86_64.linux.tar.bz2 )
	ppc? ( ${O_U}linux/1060b1/${O_P}.ppc.linux.tar.bz2 )
	x86? ( ${O_U}linux/1060b1/${O_P}.i386.linux.tar.bz2 )
	x86-fbsd? ( ${O_U}unix/1060b1/${O_P}.i386.freebsd.tar.bz2 )
"
