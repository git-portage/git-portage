...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/Attic/opera-10.61_pre6422.ebuild,v 1.1 2010/08/02 15:16:42 jer Exp $
...
O_V="${PV/_pre/-}"
O_P="${PN}-${O_V}"
O_U="http://snapshot.opera.com/unix/15204_${O_V}/"
