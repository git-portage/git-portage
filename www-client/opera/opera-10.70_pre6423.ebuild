...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/Attic/opera-10.70_pre6423.ebuild,v 1.1 2010/08/04 14:23:21 jer Exp $
...
O_V="${PV/_pre/-}"
O_P="${PN}-${O_V}"
O_U="http://snapshot.opera.com/unix/30534_${O_V}/"
