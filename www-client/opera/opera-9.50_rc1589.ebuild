...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/Attic/opera-9.50_rc1589.ebuild,v 1.1 2007/09/22 16:13:43 jer Exp $
...
SRC_URI="
	...
	ppc? (
		qt-static? ( ${O_URI}ppc-linux/${PN}-${O_VER}.1-static-qt.ppc${O_LNG}-${O_SUFF}.tar.bz2 )
		!qt-static? ( ${O_URI}ppc-linux/${PN}-${O_VER}.6-shared-qt.ppc${O_LNG}-${O_SUFF}.tar.bz2 ) )
	x86-fbsd? (
