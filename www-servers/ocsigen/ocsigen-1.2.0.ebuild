...
# $Header: /var/cvsroot/gentoo-x86/www-servers/ocsigen/Attic/ocsigen-1.2.0.ebuild,v 1.1 2009/09/19 11:59:41 aballier Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${P}-pcre-ocaml-6.0.0.patch"
}
