...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xfree-drm/Attic/xfree-drm-4.3.0-r3.ebuild,v 1.4 2003/06/27 08:26:12 spyderous Exp $
...
src_unpack() {
	...
	if [ -z "${VIDCARDS}" ] ; then
		die "Please choose at least one video card."
	fi
