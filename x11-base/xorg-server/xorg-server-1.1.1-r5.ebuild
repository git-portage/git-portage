...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/Attic/xorg-server-1.1.1-r5.ebuild,v 1.4 2007/09/09 07:37:23 dberkholz Exp $
...
pkg_setup() {
	...
	PATCHES="${FILESDIR}/xorg-x11-server-1.1.1-mesa-6.5.1.patch
		...
		${FILESDIR}/xorg-xserver-1.2.0-xcmisc.diff
