...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/Attic/xorg-server-1.2.99.903-r1.ebuild,v 1.1 2007/04/05 07:00:19 dberkholz Exp $
...
PATCHES="${FILESDIR}/xorg-xserver-1.2.0-xcmisc.diff"
