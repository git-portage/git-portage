...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/Attic/xorg-server-1.5.3-r4.ebuild,v 1.2 2009/03/12 10:43:24 armin76 Exp $
...
SRC_URI="${SRC_URI}
	...
	mirror://gentoo/${P}-gentoo-patches-06.tar.bz2"
