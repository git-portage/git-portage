...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/Attic/xorg-server-1.6.5.ebuild,v 1.2 2009/10/29 10:50:10 scarabeus Exp $
...
RDEP_XORG_BLOCKERS="!>=x11-apps/xinput-1.5.0
