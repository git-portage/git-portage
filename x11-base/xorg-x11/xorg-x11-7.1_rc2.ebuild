...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-x11/Attic/xorg-x11-7.1_rc2.ebuild,v 1.1 2006/05/13 14:35:22 joshuabaergen Exp $
...
# Server
RDEPEND="${RDEPEND}
	>=x11-base/xorg-server-1.0.99.902"
