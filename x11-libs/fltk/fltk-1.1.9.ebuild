...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/fltk/Attic/fltk-1.1.9.ebuild,v 1.2 2009/01/31 01:38:56 jer Exp $
...
KEYWORDS="~alpha ~amd64 ~hppa ~ia64 ~mips ~ppc ~sh ~sparc ~x86 ~x86-fbsd"
LICENSE="FLTK LGPL-2"
