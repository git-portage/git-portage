...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/openmotif/Attic/openmotif-2.1.30-r7.ebuild,v 1.5 2005/02/14 19:15:12 lanius Exp $
...
src_install() {
	...
	# install profile
	echo "$P" > ${D}/usr/lib/motif/openmotif-2.1
}

pkg_postinst() {
	motif-config openmotif-2.1
}
