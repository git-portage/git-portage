...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/pango/Attic/pango-1.32.5.ebuild,v 1.5 2013/01/01 12:54:20 ago Exp $
...
LICENSE="LGPL-2+ FTL"
SLOT="0"
KEYWORDS="~amd64 ~arm ~hppa ~ia64 ~ppc ~ppc64 ~x86 ~x86-fbsd ~x86-freebsd ~x86-interix ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
