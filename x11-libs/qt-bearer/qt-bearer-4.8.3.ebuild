...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt-bearer/Attic/qt-bearer-4.8.3.ebuild,v 1.1 2012/09/14 07:28:19 yngwin Exp $
...
DEPEND="
	...
	connman? ( ~x11-libs/qt-dbus-${PV}[aqua=,c++0x=,debug=] )
	networkmanager? ( ~x11-libs/qt-dbus-${PV}[aqua=,c++0x=,debug=] )
"
RDEPEND="${DEPEND}
