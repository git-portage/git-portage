...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt-gui/Attic/qt-gui-4.7.4-r1.ebuild,v 1.7 2012/03/23 17:06:36 pesa Exp $
...
src_configure() {
	...
	[[ ${CHOST} == x86_64-apple-darwin* ]] && myconf="${myconf} -no-ssse3" #367045
