...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt-gui/Attic/qt-gui-4.7.4-r1.ebuild,v 1.11 2012/05/21 19:53:24 ssuominen Exp $
...
src_configure() {
	...
	[[ ${CHOST} == *86*-apple-darwin* ]] && myconf="${myconf} -no-ssse3" #367045
