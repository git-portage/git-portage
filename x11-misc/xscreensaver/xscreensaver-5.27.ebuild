...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/xscreensaver/Attic/xscreensaver-5.27.ebuild,v 1.3 2014/06/04 12:22:14 jer Exp $
...
src_prepare() {
	...
	epatch \
		...
		"${FILESDIR}"/${PN}-5.27-comment-style.patch
...
src_compile() {
	...
	intltool-merge po/ -d -u driver/screensaver-properties.desktop.in driver/screensaver-properties.desktop
}
