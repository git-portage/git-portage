...
# $Header: /var/cvsroot/gentoo-x86/x11-plugins/desklet-external/Attic/desklet-external-0.21.ebuild,v 1.2 2003/09/10 12:15:21 obz Exp $
...
DESCRIPTION="An external Sensor for gdesklets for capturing output from external programs such as top, df"
