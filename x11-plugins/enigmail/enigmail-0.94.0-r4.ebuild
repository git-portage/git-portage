...
# $Header: /var/cvsroot/gentoo-x86/x11-plugins/enigmail/Attic/enigmail-0.94.0-r4.ebuild,v 1.5 2006/06/06 17:06:51 gustavoz Exp $
...
DEPEND=">=mail-client/mozilla-thunderbird-1.5.0.4"
RDEPEND="${DEPEND}
	>=app-crypt/gnupg-1.4
