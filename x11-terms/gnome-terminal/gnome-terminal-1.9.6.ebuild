...
# $Header: /var/cvsroot/gentoo-x86/x11-terms/gnome-terminal/Attic/gnome-terminal-1.9.6.ebuild,v 1.1 2002/05/22 23:01:58 spider Exp $
...
pkg_postinst() {
	...
	echo ">>> updating GConf2"
		for SCHEMA in profterm.schemas ; do
			echo $SCHEMA
