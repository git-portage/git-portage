...
# $Header: /var/cvsroot/gentoo-x86/x11-terms/gnome-terminal/Attic/gnome-terminal-2.14.2-r1.ebuild,v 1.3 2007/06/26 03:00:33 mr_bones_ Exp $
...
# ncurses is not a "real" dep, but it has things we need
# since we changed this to report as "gnome" and not "xterm"
# see #91055 and #122566 -AllanonJL
RDEPEND="virtual/xft
	>=x11-libs/gtk+-2.5.4
	>=gnome-base/gconf-2
