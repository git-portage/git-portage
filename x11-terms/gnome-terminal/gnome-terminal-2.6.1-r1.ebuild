...
# $Header: /var/cvsroot/gentoo-x86/x11-terms/gnome-terminal/Attic/gnome-terminal-2.6.1-r1.ebuild,v 1.1 2004/08/18 06:57:04 obz Exp $
...
src_unpack() {
	...
	# patch for text-selection performance, (#52952)
