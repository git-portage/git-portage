...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/gentoo-artwork/Attic/gentoo-artwork-0.1.ebuild,v 1.2 2003/02/13 17:37:39 vapier Exp $

S=${WORKDIR}/${P}

DESCRIPTION="A collection of miscellaneous Gentoo Linux logos and artwork"

SRC_URI="http://gentoo.tkdack.com/downloads/gentoo/gentoo-artwork-${PV}.tar.bz2"
