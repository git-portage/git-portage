...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/mplayer-skins/Attic/mplayer-skins-0.2-r6.ebuild,v 1.1 2007/11/02 03:12:58 beandog Exp $

S="${WORKDIR}"
DESCRIPTION="Collection of mplayer themes"
HOMEPAGE="http://www.mplayerhq.hu/"
THEME_URI="mirror://mplayer/skins/"
SRC_URI="${THEME_URI}Abyss-1.6.tar.bz2
	${THEME_URI}AlienMind-1.2.tar.bz2
	${THEME_URI}Ater-1.2.tar.bz2
	${THEME_URI}Blue-small-1.4.tar.bz2
	...
	${THEME_URI}smoothwebby-1.1.tar.bz2
