...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/ximian-artwork/Attic/ximian-artwork-0.2.26.0.6.1-r1.ebuild,v 1.9 2004/10/04 05:58:26 spyderous Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PN}-0.2.26-corruption_fix.patch
}
