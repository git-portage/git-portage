...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/zukitwo/Attic/zukitwo-0_pre20111023.ebuild,v 1.2 2011/10/28 15:36:48 mr_bones_ Exp $
...
src_prepare() {
	...
	sed -e 's:apps/nautilus-e.rc:apps/nautilus.rc:' -i \
		Zukitwo{,-Dark,-Resonance}/gtk-2.0/gtkrc || die
}
