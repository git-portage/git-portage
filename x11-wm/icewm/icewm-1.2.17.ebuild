...
# $Header: /var/cvsroot/gentoo-x86/x11-wm/icewm/Attic/icewm-1.2.17.ebuild,v 1.1 2004/11/07 20:00:07 morfic Exp $
...
src_unpack() {
	...
	if use silverxp ; then
		epatch ${FILESDIR}/icewm-1.2.17.ybutton.cc.patch
	fi
