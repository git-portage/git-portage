...
# $Header: /var/cvsroot/gentoo-x86/xfce-base/xfce4/Attic/xfce4-4.1.99.3-r1.ebuild,v 1.2 2005/01/10 17:56:29 bcowan Exp $

DESCRIPTION="Xfce 4 base ebuild"
LICENSE="GPL-2 BSD LGPL-2"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc ~ppc64 ~sparc ~x86"

XRDEPEND=">=xfce-base/xfce-mcs-plugins-${PV}-r1
