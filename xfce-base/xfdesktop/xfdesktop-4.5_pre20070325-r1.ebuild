...
# $Header: /var/cvsroot/gentoo-x86/xfce-base/xfdesktop/Attic/xfdesktop-4.5_pre20070325-r1.ebuild,v 1.1 2007/03/26 13:47:33 drac Exp $
...
XFCE_CONFIG="${XFCE_CONFIG} $(use_enable doc xsltproc) --enable-maintainer-mode
--disable-menu-editor"
...
pkg_postinst() {
	...
	elog
	elog "Be noted that menu-editor has been disable because it's not"
	elog "supported in new menu system."
	elog
}
