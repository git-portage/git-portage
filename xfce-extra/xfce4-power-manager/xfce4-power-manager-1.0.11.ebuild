...
# $Header: /var/cvsroot/gentoo-x86/xfce-extra/xfce4-power-manager/Attic/xfce4-power-manager-1.0.11.ebuild,v 1.1 2012/03/30 14:14:48 ssuominen Exp $
...
pkg_setup() {
	...
	PATCHES=( "${FILESDIR}"/${PN}-1.0.10-modifiers.patch )
